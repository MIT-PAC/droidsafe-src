...
public class File extends ValueAnalysisModeledObject {

    private Set<String> path = new ValueAnalysisModelingSet<String>();

    public File(AllocNode allocNode) {
        super(allocNode);
    }


    public void _init_(File dir, Set<String> name) {
        if (dir == null) {
    ...
    public void _init_(Set<String> path) {
    ...
    public void _init_(Set<String> dirPath, Set<String> name) {
        for (String d : dirPath ) {
            for (String f : name) {
                // FIXME: Shouldn't be tied to a particular separator.
                this.path.add(d + '/' + f);
            }
        }
        __ds__invalidate();
...
//    private static String fixSlashes(Set<String> origPath) {
//        return null;
//        /*
...
//    private static String join(Set<String> prefix, Set<String> suffix) {
//        return null;
//        /*
...
//    }
    ...
    public Set<String> getAbsolutePath() {
        return this.path;
        /*
        if (isAbsolute()) {
            return path;
     ...
     */
//    
//    private static native String realpath(Set<String> path) {
//        return null;
//    }

//    
//    private static native String readlink(Set<String> path) {
//        return null;
//    }
...
//    
//    private static native boolean setLastModifiedImpl(Set<String> path, Set<Long> time) {
//        return false;
//    }
...
//    
//    private static native String[] listImpl(Set<String> path) {
//        return null;
//    }
...
//    }
     ...
     */
//    
//    public static File createTempFile(Set<String> prefix, Set<String> suffix) throws IOException {
//        return null;
//        /*
...
//    }
     ...
     */
//    
//    public static File createTempFile(Set<String> prefix, Set<String> suffix, File directory) throws IOException {
//        return null;
//        /*
