...
public class SecuritySpecLabelProvider extends LabelProvider {
  ...
  private static final Image SOURCE_LOCATION_IMAGE_2 = PlatformUI.getWorkbench().getSharedImages()
      .getImage(org.eclipse.jdt.ui.ISharedImages.IMG_OBJS_ANNOTATION);
