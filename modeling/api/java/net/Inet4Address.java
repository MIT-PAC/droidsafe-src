...
@DSGeneratedField(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.683 -0500", hash_original_field = "E1C9BC3253E570C2A2350B8CC8BD0078", hash_generated_field = "BB6AED12F12CCF22F97AD9D972AF3194")

    public static final InetAddress ALL =
            new Inet4Address(new byte[] { (byte) 255, (byte) 255,
                                          (byte) 255, (byte) 255 }, null);
@DSGeneratedField(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.686 -0500", hash_original_field = "E0072382CA2392F40221424F896154BA", hash_generated_field = "3E1BF0CBCF49A9687059940E3F5B88B0")
...
Inet4Address(byte[] ipaddress, String hostName) {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.691 -0500", hash_original_method = "0C1A3E77D90A82A5EF8B4836AA337609", hash_generated_method = "5FBAD234BBFCD9E183250A773C485443")
    
@Override public boolean isAnyLocalAddress() {
        return ipaddress[0] == 0 && ipaddress[1] == 0 && ipaddress[2] == 0 && ipaddress[3] == 0; // 0.0.0.0
    }

    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.694 -0500", hash_original_method = "38D1AA1924F9F7EC1F4EB08BE7254781", hash_generated_method = "E007A5EACDD8781EDCB19C243DA3BDA5")
...
@Override public boolean isLoopbackAddress() {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.700 -0500", hash_original_method = "7EC53D5BF716DEFD994FB15A461002F1", hash_generated_method = "4C58AB6063507274493011388ABF0501")
...
@Override public boolean isMCGlobal() {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.703 -0500", hash_original_method = "CB22C78468AA446CA5A943070CD230A8", hash_generated_method = "927D0FB1529467CD6A13A4AEE2D87039")
    
@Override public boolean isMCLinkLocal() {
        return ((ipaddress[0] & 0xff) == 224) && (ipaddress[1] == 0) && (ipaddress[2] == 0); // 224.0.0/24
    }

    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.705 -0500", hash_original_method = "B0B42DF39D7CC893DB97C3031173A44B", hash_generated_method = "0585AE2BEE997250EF8BE53AC63FCF19")
    
@Override public boolean isMCNodeLocal() {
        return false;
    }

    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.708 -0500", hash_original_method = "77DF4C339990FEF620E26E135CB9F40A", hash_generated_method = "C3A57EADA78345EA515D8856B7105A57")
    
@Override public boolean isMCOrgLocal() {
        return ((ipaddress[0] & 0xff) == 239) && ((ipaddress[1] & 0xfc) == 192); // 239.192/14
    }

    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.711 -0500", hash_original_method = "9C14EBCA764FFF67AE16B4B98A6FB7C0", hash_generated_method = "1778DFA168E7A0C8889E5A199F675B01")
    
@Override public boolean isMCSiteLocal() {
        return ((ipaddress[0] & 0xff) == 239) && ((ipaddress[1] & 0xff) == 255); // 239.255/16
    }

    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.713 -0500", hash_original_method = "D19738A63A8D007E2A9921EAE82BC6DA", hash_generated_method = "582CB6E93105BBEA2E226F4B245AF7FD")
    
@Override public boolean isMulticastAddress() {
        return (ipaddress[0] & 0xf0) == 224; // 224/4
    }

    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 12:58:13.716 -0500", hash_original_method = "ACDDA2FDB8C312E800968083D2342A94", hash_generated_method = "A84FA89B7F076386CF6AEE7C66CA6B52")
