...
private static boolean isLingerSocket(FileDescriptor fd) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:28.986 -0500", hash_original_method = "2D0FCA28E55AE009AE62E6973DC0875A", hash_generated_method = "3C9DDD2D3AAC7A12C9AF9AA33B63816F")
...
private void untagSocket(FileDescriptor fd) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:28.998 -0500", hash_original_method = "635584284C97FD1E7DC4024F591AB4FA", hash_generated_method = "676C520967CA74B0F3F7558A63C9FE22")
...
@Override public FileDescriptor accept(FileDescriptor fd, InetSocketAddress peerAddress) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.001 -0500", hash_original_method = "5D4ED9A04E2D732CC559EB48A60FC49B", hash_generated_method = "55EA3E8A49F6ECF9F1B87036B15BB468")
...
/*        try {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.006 -0500", hash_original_method = "524D1337E9F0426B22674071C6D0693B", hash_generated_method = "7C987822AF28A157E6661C1553C0FD2C")
...
@Override public void connect(FileDescriptor fd, InetAddress address, int port) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.009 -0500", hash_original_method = "651C9D4A8AD9CD60F42C588D20417ED0", hash_generated_method = "E185498FC06724DA273028A54FB5266C")
...
@Override public void fdatasync(FileDescriptor fd) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.011 -0500", hash_original_method = "E0F4576754752430F3173F2FFDEB5F93", hash_generated_method = "B865F9E5C9D65416C939A56BF71DDAA9")
...
@Override public void fsync(FileDescriptor fd) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.014 -0500", hash_original_method = "D97DA02F2520733C349FC66FF2A146AF", hash_generated_method = "060432411DAD8D6D95DC1D88BF614760")
...
@Override public FileDescriptor open(String path, int flags, int mode) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.019 -0500", hash_original_method = "F416944E2BAC8A3A477E3A9DF95661DC", hash_generated_method = "45F20C6B8F3A629ADCA111290D0716A6")
...
@Override public int poll(StructPollfd[] fds, int timeoutMs) throws ErrnoException {
   ...
   /*     if (timeoutMs != 0) {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.021 -0500", hash_original_method = "B4077B073E0F60ADBED6DEE6A699AD14", hash_generated_method = "F576813CC82EEF3036B79C7EF7047350")
...
@Override public int pread(FileDescriptor fd, ByteBuffer buffer, long offset) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.024 -0500", hash_original_method = "51D119A1C60E3F0FF85DFC4F5BCBEBDF", hash_generated_method = "C9142093C6208212ED735257D5F2C6A8")
...
@Override public int pread(FileDescriptor fd, byte[] bytes, int byteOffset, int byteCount, long offset) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.026 -0500", hash_original_method = "0F2134A6426D9EB8374019A9EA67DB6B", hash_generated_method = "D2957F59CC3C136E7952A05DF1285401")
...
@Override public int pwrite(FileDescriptor fd, ByteBuffer buffer, long offset) throws ErrnoException {
    ...
    @DSSink({DSSinkKind.FILE})
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.029 -0500", hash_original_method = "A4033B69E198E86AF41C6F2BD93A7F05", hash_generated_method = "CBD5428DCA16267DA508241B0A51777B")
...
@Override public int pwrite(FileDescriptor fd, byte[] bytes, int byteOffset, int byteCount, long offset) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.032 -0500", hash_original_method = "ED8C50F685094B5680C00B42F9F5F045", hash_generated_method = "927518DCCA32240F31B1BF6C80A42D37")
...
@Override public int read(FileDescriptor fd, ByteBuffer buffer) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.034 -0500", hash_original_method = "2387C0D98FE16C1C4919C1D4A5A4F85D", hash_generated_method = "9B7C0F93A57C641CB2241D6EE2D1BA28")
...
@Override public int read(FileDescriptor fd, byte[] bytes, int byteOffset, int byteCount) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.037 -0500", hash_original_method = "418568873B9A73D38D7FF96ACC4F4219", hash_generated_method = "3E48B201BC21B864201BAAB2827246C4")
...
@Override public int readv(FileDescriptor fd, Object[] buffers, int[] offsets, int[] byteCounts) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.039 -0500", hash_original_method = "E5449C41BDDE69AE1805A14CD8C0DB04", hash_generated_method = "8BF9D4ADBE0CBE7A4F96BCEA870D07CB")
...
@Override public int recvfrom(FileDescriptor fd, ByteBuffer buffer, int flags, InetSocketAddress srcAddress) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.041 -0500", hash_original_method = "F697E31CA82538D4CA19A49211FAEDE8", hash_generated_method = "A75DAE4EB0DACACCC600F176B51C0DD5")
...
@Override public int sendto(FileDescriptor fd, byte[] bytes, int byteOffset, int byteCount, int flags, InetAddress inetAddress, int port) throws ErrnoException {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "2.0", generated_on = "2013-12-30 13:02:29.049 -0500", hash_original_method = "3EA6FC55F29379EA1669AB58FC394717", hash_generated_method = "8ED959D7D4C6CF5A442B91321AAC0A01")
