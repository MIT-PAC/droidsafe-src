...
public class TimeStamp extends SIPHeader implements TimeStampHeader {
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:48:37.515 -0400", hash_original_field = "34BC11BD1D0CE270E57C98CEA00E8D5F", hash_generated_field = "76B8D8E0781BF84AACE2DA76A4001EFB")

    protected long timeStamp = -1;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:48:37.515 -0400", hash_original_field = "0316FC507CBCBB3AD4149CBE7BD6690A", hash_generated_field = "DE842D8221161CACA08CA06721E2F557")

    protected int delay = -1;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:48:37.515 -0400", hash_original_field = "50B1B1B2ABCE021919EBA7EE1A5A2E37", hash_generated_field = "C6AE286F90939B3ECC1A3783181F9CAA")

    protected float delayFloat = -1;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:48:37.515 -0400", hash_original_field = "E436B60B7078C5CB4603A1005F41D95B", hash_generated_field = "496F7FE859855CC3A1459131085C2D33")
    ...
    if(timeStamp == -1 && timeStampFloat == -1)        
        {
String var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1528769422 =         "";
        var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1528769422.addTaint(taint);
        return var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1528769422;
        }
        else
    if(timeStamp != -1)        
        {
String var26CB82EC9A04D975CA5F59CA7FFD2F85_506355453 =         Long.toString(timeStamp);
        var26CB82EC9A04D975CA5F59CA7FFD2F85_506355453.addTaint(taint);
        return var26CB82EC9A04D975CA5F59CA7FFD2F85_506355453;
        }
        else
        {
String var7989E3F135E688AB6BA1B117FE333CA6_1817865769 =         Float.toString(timeStampFloat);
        var7989E3F135E688AB6BA1B117FE333CA6_1817865769.addTaint(taint);
        return var7989E3F135E688AB6BA1B117FE333CA6_1817865769;
        }
        // ---------- Original Method ----------
        //if (timeStamp == -1 && timeStampFloat == -1)
            //return "";
    ...
    if(delay == -1 && delayFloat == -1)        
        {
String var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1970459873 =         "";
        var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1970459873.addTaint(taint);
        return var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1970459873;
        }
        else
    if(delay != -1)        
        {
String var7CC92AADBA289299CA649446AE38826B_1939680779 =         Integer.toString(delay);
        var7CC92AADBA289299CA649446AE38826B_1939680779.addTaint(taint);
        return var7CC92AADBA289299CA649446AE38826B_1939680779;
        }
        else
        {
String varD42ABEA32CCCF01A1859876730865E96_713998981 =         Float.toString(delayFloat);
        varD42ABEA32CCCF01A1859876730865E96_713998981.addTaint(taint);
        return varD42ABEA32CCCF01A1859876730865E96_713998981;
        }
        // ---------- Original Method ----------
        //if (delay == -1 && delayFloat == -1)
            //return "";
    ...
    if(s1.equals("") && s2.equals(""))        
        {
String var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1521418618 =         "";
        var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1521418618.addTaint(taint);
        return var9CB9B6C9951BF8E98E1ABAF5E2CADCAD_1521418618;
        }
    if(!s1.equals(""))        
        retval.append(s1);
    if(!s2.equals(""))        
        retval.append(" ").append(s2);
String var1B324365A764C077A55854483509F4AB_807766155 =         retval.toString();
        var1B324365A764C077A55854483509F4AB_807766155.addTaint(taint);
        return var1B324365A764C077A55854483509F4AB_807766155;
        // ---------- Original Method ----------
        //StringBuffer retval = new StringBuffer();
        //String s1 = getTimeStampAsString();
        //String s2 = getDelayAsString();
    ...
    public boolean hasDelay() {
        boolean var5170D6C26EF26E11B67739BB10040110_155952705 = (delay != -1);
                boolean var84E2C64F38F78BA3EA5C905AB5A2DA27_269321347 = getTaintBoolean();
        return var84E2C64F38F78BA3EA5C905AB5A2DA27_269321347;
        // ---------- Original Method ----------
        //return delay != -1;
    }
    ...
    if(timeStamp < 0)        
        {
        InvalidArgumentException varEE33A8B1F1CA3E8C6B1416BFAEFC6E08_366127684 = new InvalidArgumentException(
                    "JAIN-SIP Exception, TimeStamp, "
                            + "setTimeStamp(), the timeStamp parameter is <0");
        varEE33A8B1F1CA3E8C6B1416BFAEFC6E08_366127684.addTaint(taint);
        throw varEE33A8B1F1CA3E8C6B1416BFAEFC6E08_366127684;
        }
        this.timeStamp = -1;
    ...
    public float getTimeStamp() {
        float varA1D55C2097A168DE135F7BC9CC5E7C55_1273175928 = (this.timeStampFloat == -1 ? Float.valueOf(timeStamp).floatValue()
                : this.timeStampFloat);
                float var546ADE640B6EDFBC8A086EF31347E768_60843135 = getTaintFloat();
        return var546ADE640B6EDFBC8A086EF31347E768_60843135;
        // ---------- Original Method ----------
    ...
    public float getDelay() {
        float varF8E7D13292243AEE217733300B912A7F_772508317 = (delayFloat == -1 ? Float.valueOf(delay).floatValue() : delayFloat);
                float var546ADE640B6EDFBC8A086EF31347E768_1606127849 = getTaintFloat();
        return var546ADE640B6EDFBC8A086EF31347E768_1606127849;
        // ---------- Original Method ----------
    ...
    if(delay < 0 && delay != -1)        
        {
        InvalidArgumentException var2F71C1947B7063DEE9ED3A8FA5FF661D_1044355142 = new InvalidArgumentException(
                    "JAIN-SIP Exception, TimeStamp, "
                            + "setDelay(), the delay parameter is <0");
        var2F71C1947B7063DEE9ED3A8FA5FF661D_1044355142.addTaint(taint);
        throw var2F71C1947B7063DEE9ED3A8FA5FF661D_1044355142;
        }
    ...
    public long getTime() {
        long var53282C9BBBF7B78DB63E8EBD606128BC_329970282 = (this.timeStamp == -1 ? (long) timeStampFloat : timeStamp);
                long var0F5264038205EDFB1AC05FBB0E8C5E94_927116733 = getTaintLong();
        return var0F5264038205EDFB1AC05FBB0E8C5E94_927116733;
        // ---------- Original Method ----------
    ...
    public int getTimeDelay() {
        int varA586C7CA5165EB205CF69A2F0D1397B0_1726006229 = (this.delay == -1 ? (int) delayFloat : delay);
                int varFA7153F7ED1CB6C0FCF2FFB2FAC21748_649230850 = getTaintInt();
        return varFA7153F7ED1CB6C0FCF2FFB2FAC21748_649230850;
        // ---------- Original Method ----------
    ...
    if(timeStamp < -1)        
        {
        InvalidArgumentException varC44C945D430D7EDCAD861D89CC79B6AE_1694944097 = new InvalidArgumentException("Illegal timestamp");
        varC44C945D430D7EDCAD861D89CC79B6AE_1694944097.addTaint(taint);
        throw varC44C945D430D7EDCAD861D89CC79B6AE_1694944097;
        }
    ...
    if(delay < -1)        
        {
        InvalidArgumentException var5080785A38295082BBA52E6C0CBD0C15_1792042737 = new InvalidArgumentException("Value out of range " + delay);
        var5080785A38295082BBA52E6C0CBD0C15_1792042737.addTaint(taint);
        throw var5080785A38295082BBA52E6C0CBD0C15_1792042737;
        }
        this.delay = delay;
        this.delayFloat = -1;
        // ---------- Original Method ----------
    ...
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:48:37.521 -0400", hash_original_field = "F1F76523D309971C49C86D95AD395F1F", hash_generated_field = "5580840BB5EA0CAD9750B3DAADA2FC56")
