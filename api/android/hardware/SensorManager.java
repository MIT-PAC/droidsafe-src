...
import droidsafe.concrete.DroidSafeSensorManager;
...
/*
 * GITI DSModeled
 * DONE - <android.hardware.SensorManager: android.hardware.Sensor getDefaultSensor(int)>	
...
{
    private /* GITI static */ final String TAG = "SensorManager";
    private /* GITI static */ final float[] mTempMatrix = new float[16];
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_ORIENTATION = 1 << 0;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_ACCELEROMETER = 1 << 1;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_TEMPERATURE = 1 << 2;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_MAGNETIC_FIELD = 1 << 3;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_LIGHT = 1 << 4;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_PROXIMITY = 1 << 5;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_TRICORDER = 1 << 6;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_ORIENTATION_RAW = 1 << 7;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_ALL = 0x7F;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_MIN = SENSOR_ORIENTATION;
     ...
     */
    @Deprecated
    public /* GITI static */ final int SENSOR_MAX = ((SENSOR_ALL + 1)>>1);
     ...
     */
    @Deprecated
    public /* GITI static */ final int DATA_X = 0;
     ...
     */
    @Deprecated
    public /* GITI static */ final int DATA_Y = 1;
     ...
     */
    @Deprecated
    public /* GITI static */ final int DATA_Z = 2;
     ...
     */
    @Deprecated
    public /* GITI static */ final int RAW_DATA_INDEX = 3;
     ...
     */
    @Deprecated
    public /* GITI static */ final int RAW_DATA_X = 3;
     ...
     */
    @Deprecated
    public /* GITI static */ final int RAW_DATA_Y = 4;
     ...
     */
    @Deprecated
    public /* GITI static */ final int RAW_DATA_Z = 5;

    /** Standard gravity (g) on Earth. This value is equivalent to 1G */
    public /* GITI static */ final float STANDARD_GRAVITY = 9.80665f;

    /** Sun's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_SUN             = 275.0f;
    /** Mercury's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_MERCURY         = 3.70f;
    /** Venus' gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_VENUS           = 8.87f;
    /** Earth's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_EARTH           = 9.80665f;
    /** The Moon's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_MOON            = 1.6f;
    /** Mars' gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_MARS            = 3.71f;
    /** Jupiter's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_JUPITER         = 23.12f;
    /** Saturn's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_SATURN          = 8.96f;
    /** Uranus' gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_URANUS          = 8.69f;
    /** Neptune's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_NEPTUNE         = 11.0f;
    /** Pluto's gravity in SI units (m/s^2) */
    public /* GITI static */ final float GRAVITY_PLUTO           = 0.6f;
    /** Gravity (estimate) on the first Death Star in Empire units (m/s^2) */
    public /* GITI static */ final float GRAVITY_DEATH_STAR_I    = 0.000000353036145f;
    /** Gravity on the island */
    public /* GITI static */ final float GRAVITY_THE_ISLAND      = 4.815162342f;


    /** Maximum magnetic field on Earth's surface */
    public /* GITI static */ final float MAGNETIC_FIELD_EARTH_MAX = 60.0f;
    /** Minimum magnetic field on Earth's surface */
    public /* GITI static */ final float MAGNETIC_FIELD_EARTH_MIN = 30.0f;


    /** Standard atmosphere, or average sea-level pressure in hPa (millibar) */
    public /* GITI static */ final float PRESSURE_STANDARD_ATMOSPHERE = 1013.25f;


    /** Maximum luminance of sunlight in lux */
    public /* GITI static */ final float LIGHT_SUNLIGHT_MAX = 120000.0f;
    /** luminance of sunlight in lux */
    public /* GITI static */ final float LIGHT_SUNLIGHT     = 110000.0f;
    /** luminance in shade in lux */
    public /* GITI static */ final float LIGHT_SHADE        = 20000.0f;
    /** luminance under an overcast sky in lux */
    public /* GITI static */ final float LIGHT_OVERCAST     = 10000.0f;
    /** luminance at sunrise in lux */
    public /* GITI static */ final float LIGHT_SUNRISE      = 400.0f;
    /** luminance under a cloudy sky in lux */
    public /* GITI static */ final float LIGHT_CLOUDY       = 100.0f;
    /** luminance at night with full moon in lux */
    public /* GITI static */ final float LIGHT_FULLMOON     = 0.25f;
    /** luminance at night with no moon in lux*/
    public /* GITI static */ final float LIGHT_NO_MOON      = 0.001f;


    /** get sensor data as fast as possible */
    public /* GITI static */ final int SENSOR_DELAY_FASTEST = 0;
    /** rate suitable for games */
    public /* GITI static */ final int SENSOR_DELAY_GAME = 1;
    /** rate suitable for the user interface  */
    public /* GITI static */ final int SENSOR_DELAY_UI = 2;
    /** rate (default) suitable for screen orientation changes */
    public /* GITI static */ final int SENSOR_DELAY_NORMAL = 3;
     ...
     */
    public /* GITI static */ final int SENSOR_STATUS_UNRELIABLE = 0;

    /**
     * This sensor is reporting data with low accuracy, calibration with the
     * environment is needed
     */
    public /* GITI static */ final int SENSOR_STATUS_ACCURACY_LOW = 1;

    /**
     * This sensor is reporting data with an average level of accuracy,
     * calibration with the environment may improve the readings
     */
    public /* GITI static */ final int SENSOR_STATUS_ACCURACY_MEDIUM = 2;

    /** This sensor is reporting data with maximum accuracy */
    public /* GITI static */ final int SENSOR_STATUS_ACCURACY_HIGH = 3;

    /** see {@link #remapCoordinateSystem} */
    public /* GITI static */ final int AXIS_X = 1;
    /** see {@link #remapCoordinateSystem} */
    public /* GITI static */ final int AXIS_Y = 2;
    /** see {@link #remapCoordinateSystem} */
    public /* GITI static */ final int AXIS_Z = 3;
    /** see {@link #remapCoordinateSystem} */
    public /* GITI static */ final int AXIS_MINUS_X = AXIS_X | 0x80;
    /** see {@link #remapCoordinateSystem} */
    public /* GITI static */ final int AXIS_MINUS_Y = AXIS_Y | 0x80;
    /** see {@link #remapCoordinateSystem} */
    public /* GITI static */ final int AXIS_MINUS_Z = AXIS_Z | 0x80;
    ...
    private /* GITI static */ final int SENSOR_DISABLE = -1;
    private /* GITI static */ boolean sSensorModuleInitialized = false;
    private /* GITI static */ ArrayList<Sensor> sFullSensorsList = new ArrayList<Sensor>();
    private /* GITI static */ SparseArray<List<Sensor>> sSensorListByType = new SparseArray<List<Sensor>>();
    private /* GITI static */ IWindowManager sWindowManager;
    private /* GITI static */ int sRotation = Surface.ROTATION_0;
    ...
    private /* GITI static */ int sQueue;

    // Used within this module from outside SensorManager, don't make private
    /* GITI static */ SparseArray<Sensor> sHandleToSensor = new SparseArray<Sensor>();
    /* GITI static */ final ArrayList<ListenerDelegate> sListeners =
    ...
    private /* GITI static */ SensorEventPool sPool;
    ...
    */
    ...
    public Sensor getDefaultSensor(int type) {
        ...
        */
        // GITI DSModeled - emulating the return of a sensor, this should be sufficient for
    	// modeling
    	return new Sensor();
    }
    ...
    */
    ...
    public boolean registerListener(SensorEventListener listener, Sensor sensor, int rate,
            Handler handler) {
        DSRegisterListener(listener, sensor);
        /* GITI DSModeled
        boolean result = true;
        int delay = -1;
        switch (rate) {
    ...
    // GITI DSModeled - added private method for handling registration of listeners.
    @DSModeled(DSC.BAN)
	private boolean DSRegisterListener(SensorEventListener listener, Sensor sensor) {
		if (listener == null || sensor == null) {
            return false;
        }
        // GITI DSModeled - make call to the provided listener with all possible
        // sensor statuses.
        listener.onAccuracyChanged(sensor, SENSOR_STATUS_ACCURACY_HIGH);
        listener.onAccuracyChanged(sensor, SENSOR_STATUS_ACCURACY_MEDIUM);
        listener.onAccuracyChanged(sensor, SENSOR_STATUS_ACCURACY_LOW);
        
        // GITI DSModeled - make call to the provided listener with SensorEvent
        // DSFIXME - need to determine if the SensorEvent is created correctly enough 
        // for this modeling exercise.
        SensorEvent event = new SensorEvent(1);
        event.sensor = sensor;
    ...
    */
    ...
    private /* GITI static */ boolean remapCoordinateSystemImpl(float[] inR, int X, int Y,
            float[] outR)
    {
        /*
   ...
   /**
    ...
    private class LegacyListener implements SensorEventListener {
        ...
        private void mapSensorDataToWindow(int sensor,
            ...
            switch (sensor) {
                //GITI DSModeled - case SensorManager.SENSOR_ORIENTATION:
                case SENSOR_ORIENTATION:
                //GITI DSModeled - case SensorManager.SENSOR_ORIENTATION_RAW:
                case SENSOR_ORIENTATION_RAW:
                    z = -z;
                    break;
                //GITI DSModeled - case SensorManager.SENSOR_ACCELEROMETER:
                case SENSOR_ACCELEROMETER:
                    x = -x;
                    y = -y;
                    z = -z;
                    break;
                //GITI DSModeled - case SensorManager.SENSOR_MAGNETIC_FIELD:
    ...
    class LmsFilter {
        private /* GITI static */ final int SENSORS_RATE_MS = 20;
        private /* GITI static */ final int COUNT = 12;
        private /* GITI static */ final float PREDICTION_RATIO = 1.0f/3.0f;
        private /* GITI static */ final float PREDICTION_TIME = (SENSORS_RATE_MS*COUNT/1000.0f)*PREDICTION_RATIO;
    ...
    private /* GITI static */ native void nativeClassInit();

    private /* GITI static */ native int sensors_module_init();
    private /* GITI static */ native int sensors_module_get_next_sensor(Sensor sensor, int next);
