...
public class SyncQueue {
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:47:11.182 -0400", hash_original_field = "45147E3AEB1E4ADCE06A13083E577526", hash_generated_field = "C4D1F4553F2DAB654514F44F7C643ACD")

    private SyncStorageEngine mSyncStorageEngine;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:47:11.182 -0400", hash_original_field = "33E73F7C0E48552B1038F6EFECEC7CF1", hash_generated_field = "3EE45AA38027E40BC3F5CD43429C606C")

    public final HashMap<String, SyncOperation> mOperationsMap = Maps.newHashMap();
    
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:47:11.185 -0400", hash_original_method = "4B46EA3F8AD8CFC1D0053E5D8D79C64A", hash_generated_method = "C4C0547698F0B4A817D4C1F60667CAFF")
...
for(int i=0;i<N;i++)
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:47:11.196 -0400", hash_original_method = "DE2F99F3641547A1BC9E364A4B2B8E2B", hash_generated_method = "08857B8AF1A7093591BFB4430625474F")
    ...
    if(pop == null)            
            {
                IllegalStateException varD66D786C7717C91FDE59B1DD7234185B_1578734763 = new IllegalStateException("error adding pending sync operation "
                        + operation);
...
for(SyncOperation op : mOperationsMap.values())
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:47:11.197 -0400", hash_original_method = "3BDDACB884C02271E516EA5014748603", hash_generated_method = "4F29F8567A5CB52968263D7789AB7A03")
...
(entries.hasNext())        
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:47:11.197 -0400", hash_original_method = "DE0C3912E55B433E68B0CDCDD70A3B83", hash_generated_method = "0C491C4A1C5E3B35BBB0CBFCB601C7B1")
...
for(SyncOperation operation : mOperationsMap.values())
    ...
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:47:11.197 -0400", hash_original_field = "0439F4DA6A334C5ECD9FAAB83A40EC1E", hash_generated_field = "AF31108A14FC5488BDB972C9330ED310")
