...
class ParcelableCompatCreatorHoneycombMR2<T> implements Parcelable.ClassLoaderCreator<T> {
    ...
    public T createFromParcel(Parcel in) {
        T varB4EAC82CA7396A68D541C85D26508E83_1941574311 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1941574311 = mCallbacks.createFromParcel(in, null);
        addTaint(in.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1941574311.addTaint(getTaint()); 
    ...
    public T createFromParcel(Parcel in, ClassLoader loader) {
        T varB4EAC82CA7396A68D541C85D26508E83_487592611 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_487592611 = mCallbacks.createFromParcel(in, loader);
        addTaint(in.getTaint());
        addTaint(loader.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_487592611.addTaint(getTaint()); 
    ...
    public T[] newArray(int size) {
        T[] varB4EAC82CA7396A68D541C85D26508E83_1214041683 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1214041683 = mCallbacks.newArray(size);
        addTaint(size);
        varB4EAC82CA7396A68D541C85D26508E83_1214041683.addTaint(getTaint()); 
