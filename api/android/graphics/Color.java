 ...
 */
public class Color {
	/* Modified to remove the static */
    public final int BLACK       = 0xFF000000;
    public final int DKGRAY      = 0xFF444444;
    public final int GRAY        = 0xFF888888;
    public final int LTGRAY      = 0xFFCCCCCC;
    ...
    public final int CYAN        = 0xFF00FFFF;
    public final int MAGENTA     = 0xFFFF00FF;
    public final int TRANSPARENT = 0;
    
    /*
     * GITI DSModel
     * Added default constructor method to resolve output being
     * generated in api-required-modeling-pta.txt
     * @author sgraf
     */
    @DSModeled
    public Color() {
    	//Shifted from being static to deal with clint missing error
    ...
    */
    ...
    private final HashMap<String, Integer> sColorNameMap; //Changed from static
}
