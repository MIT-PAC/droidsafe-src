...
String var20537B75E409F43099188469A355FDC5_325452225 =         "State=" + getCurrentState().getName() + " create=" + createTime + " lastFail="
                + lastFailTime + " lastFasilCause=" + lastFailCause;
        var20537B75E409F43099188469A355FDC5_325452225.addTaint(taint);
        return var20537B75E409F43099188469A355FDC5_325452225;
        // ---------- Original Method ----------
    ...
    protected boolean isDnsOk(String[] domainNameServers) {
        ...
        {
            boolean var68934A3E9455FA72420237EB05902327_1075850345 = (false);
                        boolean var84E2C64F38F78BA3EA5C905AB5A2DA27_134222523 = getTaintBoolean();
            return var84E2C64F38F78BA3EA5C905AB5A2DA27_134222523;
        } //End block
        else
        {
            boolean varB326B5062B2F0E69046810717534CB09_2123522333 = (true);
                        boolean var84E2C64F38F78BA3EA5C905AB5A2DA27_1265239761 = getTaintBoolean();
            return var84E2C64F38F78BA3EA5C905AB5A2DA27_1265239761;
        } //End block
        // ---------- Original Method ----------
        //if (NULL_IP.equals(domainNameServers[0])
                //&& NULL_IP.equals(domainNameServers[1])
    ...
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:24:22.482 -0400", hash_original_field = "951C150E6D062E6AED2C45BB9B756185", hash_generated_field = "1718F4DE7305211326235C8400C02ED3")
