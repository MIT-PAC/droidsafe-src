...
public static Filter eq(SearchableMetadataField  r0, Object  r1)
    {
        ...
        return new ComparisonFilter(Operator.La, r0, r1);
    }
...
public static Filter lessThan(SearchableOrderedMetadataField  r0, Comparable  r1)
    {
        ...
        return new ComparisonFilter(Operator.Lb, r0, r1);
    }
...
public static Filter greaterThan(SearchableOrderedMetadataField  r0, Comparable  r1)
    {
        ...
        return new ComparisonFilter(Operator.Ld, r0, r1);
    }
...
public static Filter lessThanEquals(SearchableOrderedMetadataField  r0, Comparable  r1)
    {
        ...
        return new ComparisonFilter(Operator.Lc, r0, r1);
    }
...
public static Filter greaterThanEquals(SearchableOrderedMetadataField  r0, Comparable  r1)
    {
        ...
        return new ComparisonFilter(Operator.Le, r0, r1);
    }
...
public static Filter contains(SearchableMetadataField  r0, String  r1)
    {
        ...
        return new ComparisonFilter(Operator.Li, r0, r1);
    }
...
public static transient Filter and(Filter  r0, Filter[]  r1)
    {


        return new LogicalFilter(Operator.Lf, r0, r1);
    }
...
public static Filter and(Iterable  r0)
    {
        ...
        return new LogicalFilter(Operator.Lf, r0);
    }
...
public static transient Filter or(Filter  r0, Filter[]  r1)
    {


        return new LogicalFilter(Operator.Lg, r0, r1);
    }
...
public static Filter or(Iterable  r0)
    {
        ...
        return new LogicalFilter(Operator.Lg, r0);
    }
