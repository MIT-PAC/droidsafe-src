...
for(int i = start;i < start + length;i++)
        ...
        {
String var0F4C03B2E07844EE7381823BFB463F14_602825381 =             pooled;
            var0F4C03B2E07844EE7381823BFB463F14_602825381.addTaint(taint);
            return var0F4C03B2E07844EE7381823BFB463F14_602825381;
        } //End block
        String result = new String(array, start, length);
        pool[index] = result;
String varDC838461EE2FA0CA4C9BBB70A15456B0_1523273202 =         result;
        varDC838461EE2FA0CA4C9BBB70A15456B0_1523273202.addTaint(taint);
        return varDC838461EE2FA0CA4C9BBB70A15456B0_1523273202;
        // ---------- Original Method ----------
        //int hashCode = 0;
        //for (int i = start; i < start + length; i++) {
            //hashCode = (hashCode * 31) + array[i];
