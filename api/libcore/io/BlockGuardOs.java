...
public class BlockGuardOs extends ForwardingOs {
    ...
    private FileDescriptor tagSocket(FileDescriptor fd) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1539005257 = null; 
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1539005257.addTaint(getTaint()); 
    ...
    public FileDescriptor accept(FileDescriptor fd, InetSocketAddress peerAddress) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1131766096 = null; 
        BlockGuard.getThreadPolicy().onNetwork();
        varB4EAC82CA7396A68D541C85D26508E83_1131766096 = tagSocket(os.accept(fd, peerAddress));
        addTaint(fd.getTaint());
        addTaint(peerAddress.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1131766096.addTaint(getTaint()); 
    ...
    public FileDescriptor open(String path, int flags, int mode) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_771398635 = null; 
        ...
        addTaint(flags);
        addTaint(mode);
        varB4EAC82CA7396A68D541C85D26508E83_771398635.addTaint(getTaint()); 
    ...
    public FileDescriptor socket(int domain, int type, int protocol) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1549871025 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1549871025 = tagSocket(os.socket(domain, type, protocol));
        addTaint(domain);
        addTaint(type);
        addTaint(protocol);
        varB4EAC82CA7396A68D541C85D26508E83_1549871025.addTaint(getTaint()); 
