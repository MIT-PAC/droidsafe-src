...
public final class NioBufferIterator extends BufferIterator {
    ...
    private int address;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:24.648 -0400", hash_original_field = "F7BD60B75B29D79B660A2859395C1A24", hash_generated_field = "F06612A05C836674433E69C513561353")

    private int size;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:24.648 -0400", hash_original_field = "F0A1DFDC675B0A14A64099F7AC1CEE83", hash_generated_field = "A6B25CFBA8585537085014684252B717")

    private boolean swap;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:24.648 -0400", hash_original_field = "4757FE07FD492A8BE0EA6A760D683D6E", hash_generated_field = "312206EA2404526B7BBC621459C87A80")
...
@DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:24.649 -0400", hash_original_method = "47AEAAA269BE342FCE4A8C8B269BAED8", hash_generated_method = "A9BB1FBDDC5189AE359EF7B8D647C1B7")
    public byte readByte() {
        ...
        ++position;
        byte varB4A88417B3D0170D754C647C30B7216A_921738702 = (result);
                byte var40EA57D3EE3C07BF1C102B466E1C3091_660762814 = getTaintByte();
        return var40EA57D3EE3C07BF1C102B466E1C3091_660762814;
        // ---------- Original Method ----------
        //byte result = Memory.peekByte(address + position);
        //++position;
        //return result;
...
@DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:24.649 -0400", hash_original_method = "F3BC6F7E073908C181908589CEF0FEA1", hash_generated_method = "2D5FAC74FD3954E9A5D138F7ED27E37A")
    public int readInt() {
        ...
        position += SizeOf.INT;
        int varB4A88417B3D0170D754C647C30B7216A_55887745 = (result);
                int varFA7153F7ED1CB6C0FCF2FFB2FAC21748_1171945041 = getTaintInt();
        return varFA7153F7ED1CB6C0FCF2FFB2FAC21748_1171945041;
        // ---------- Original Method ----------
        //int result = Memory.peekInt(address + position, swap);
        //position += SizeOf.INT;
        //return result;
...
@DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:24.649 -0400", hash_original_method = "34473D83268F7BAA3E1410708A3FD84F", hash_generated_method = "7EC79BDFE26C052B998BB4578D4E87A8")
    public short readShort() {
        ...
        short varB4A88417B3D0170D754C647C30B7216A_1309611453 = (result);
                short var4F09DAA9D95BCB166A302407A0E0BABE_1535689261 = getTaintShort();
        return var4F09DAA9D95BCB166A302407A0E0BABE_1535689261;
        // ---------- Original Method ----------
        //short result = Memory.peekShort(address + position, swap);
        //position += SizeOf.SHORT;
        //return result;
