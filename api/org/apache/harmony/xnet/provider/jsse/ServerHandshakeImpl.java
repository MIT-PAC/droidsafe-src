...
public class ServerHandshakeImpl extends HandshakeProtocol {
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.587 -0400", hash_original_field = "4AA2361BEE79AADD8595859693612743", hash_generated_field = "F778C7A1E11234387361395B9C2BAFEF")

    private PrivateKey privKey;
    
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.587 -0400", hash_original_method = "3AF97CBDFDCCD2B098621E28E1AC9FE5", hash_generated_method = "D5581A48D5BE2E2A9830A403D5C0BA76")
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.587 -0400", hash_original_method = "324CE8CF3B7F222FC5B16C98F36DFFC3", hash_generated_method = "138938AB232AD708365232723004610D")
    @Override
    public void start() {
    if(session == null)        
        {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.594 -0400", hash_original_method = "C84D4DEAC8EBB3DD7197C18B29E2CDCD", hash_generated_method = "932041BF52E924A7364C8CE311DD9E25")
    @Override
...
switch(handshakeType){
    ...
    if(nonBlocking)                
        ...
        @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.590 -0400", hash_original_method = "E7C0517DE997CD5395D0C07C8E102134", hash_generated_method = "BB36F1EA52E00860AED4267A4F6A4F59")
        public void run() {
            processClientHello();
            // ---------- Original Method ----------
            //processClientHello();
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.597 -0400", hash_original_method = "866A772D6B919D9D55F9FB0C6E40CB44", hash_generated_method = "F50E23C746A8F95B0485653F72DDB7D1")
    @Override
    ...
    if(nonBlocking)        
        {
            delegatedTasks.add(new DelegatedTask(new Runnable() {        
        @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.597 -0400", hash_original_method = "E7C0517DE997CD5395D0C07C8E102134", hash_generated_method = "BB36F1EA52E00860AED4267A4F6A4F59")
        public void run() {
            processClientHello();
            // ---------- Original Method ----------
            //processClientHello();
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.611 -0400", hash_original_method = "1EE7C68A79581646D3317E6FF35ECA2F", hash_generated_method = "F5935FEABE582BF33ECAA7928ABD6E72")
...
for(int i = 0;i < clientHello.cipher_suites.length;i++)
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.616 -0400", hash_original_method = "B7CAA5254DC76CE96F66DEC8EF811F93", hash_generated_method = "E6BCB41AF960006D4DD2D74713DDA57E")
    @Override
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.617 -0400", hash_original_method = "1900CB4813DE311B701E9907815D7379", hash_generated_method = "1324083A0FC1D801B15F3FBCD8A10090")
    private SSLSessionImpl findSessionToResume(byte[] session_id) {
        addTaint(session_id[0]);
SSLSessionImpl var17920C4727A1A491ECB429D01D5C0164_441171719 =         (SSLSessionImpl)parameters.getServerSessionContext().getSession(session_id);
        var17920C4727A1A491ECB429D01D5C0164_441171719.addTaint(taint);
        return var17920C4727A1A491ECB429D01D5C0164_441171719;
        // ---------- Original Method ----------
        //return (SSLSessionImpl)parameters.getServerSessionContext().getSession(session_id);
    }

    
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.617 -0400", hash_original_method = "CED7C9E9124D8D76ECA389CBA359AC39", hash_generated_method = "6CB82EF08CA09247B4E3AEFDA4AA7833")
...
for(CipherSuite enabledCipherSuite : parameters.getEnabledCipherSuitesMember())
    ...
    if(clientSuite.equals(enabledCipherSuite))                
                {
CipherSuite varF085B62D70EBB2C6974C2BAD4FDA9BC8_136315581 =                     clientSuite;
                    varF085B62D70EBB2C6974C2BAD4FDA9BC8_136315581.addTaint(taint);
                    return varF085B62D70EBB2C6974C2BAD4FDA9BC8_136315581;
                } //End block
            } //End block
        } //End block
CipherSuite var540C13E9E156B687226421B24F2DF178_738569552 =         null;
        var540C13E9E156B687226421B24F2DF178_738569552.addTaint(taint);
        return var540C13E9E156B687226421B24F2DF178_738569552;
        // ---------- Original Method ----------
        //for (CipherSuite clientSuite : clientSuites) {
            //if (!clientSuite.supported) {
                //continue;
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-12 09:49:33.618 -0400", hash_original_method = "C3331D73871F50BD7C19021D99D59A46", hash_generated_method = "4395F563433F3BABFCA019BF725CE472")
    @Override
