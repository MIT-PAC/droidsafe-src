...
public class ClientHello extends Message {
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.246 -0400", hash_original_field = "AD8EBE9263231F4547FD53D5849AC965", hash_generated_field = "87AFE8194BC492AFC7167BB3A54122B9")

    byte[] client_version;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.246 -0400", hash_original_field = "207D91A53A99C0890FBC2F7C6872CC3D", hash_generated_field = "D668480B0E83A7483DCEBA9C8392548F")

    final byte[] random = new byte[32];
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.246 -0400", hash_original_field = "7FC8EF54A8154C28341BF9A47443A5CE", hash_generated_field = "464E487327E8A3D68CAEEB2871FE01AA")

    byte[] session_id;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.246 -0400", hash_original_field = "A2AE8B2C9178F243D1D66776A3B6AE29", hash_generated_field = "A0A44A96F6DB28A1A612B3ED93B5B66F")

    CipherSuite[] cipher_suites;
    @DSGeneratedField(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.246 -0400", hash_original_field = "0A29CD02A8D38C8C61DF9A86DDBE1BAB", hash_generated_field = "47F40258F3E60116F552FCA9A35A3742")

    byte[] compression_methods;
    
        @DSModeled(DSC.SAFE)
@DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.248 -0400", hash_original_method = "B360A744DA2558AEF3A4AD32A9DD66E9", hash_generated_method = "FFD2B2CAD76C273C2B27B53586298235")
...
for(int i = 0;i < cipher_suites.length;i++)
        ...
        @DSModeled(DSC.SAFE)
@DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.256 -0400", hash_original_method = "89F344582D255D48D3BC56CB8686027C", hash_generated_method = "B14597BF86D209FD8A2BBB6F8E95E874")
    @Override
...
for(int i = 0;i < compression_methods.length;i++)
        ...
        @DSModeled(DSC.SAFE)
@DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.256 -0400", hash_original_method = "EDD7E5211887C4E217154E276BC2B61E", hash_generated_method = "DF3BD1D3357ADACBF46A1B49868B849F")
    public byte[] getRandom() {
        byte[] var7DDF32E17A6AC5CE04A8ECBF782CA509_469683822 = (random);
                byte[] var2F9C81BC6E497382285CD6B7A7E33DE1_1367832718 = {getTaintByte()};
        return var2F9C81BC6E497382285CD6B7A7E33DE1_1367832718;
        // ---------- Original Method ----------
        //return random;
    }
        ...
        @DSModeled(DSC.SAFE)
@DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-07-17 10:25:31.257 -0400", hash_original_method = "CF19DA1ECE12A56ABD61504AAFBBFE23", hash_generated_method = "3F56E628AE7E48EDF9F3AF8C2532F347")
    @Override
    public int getType() {
        int varE71280FEA2F0862AC622F392C3B87AED_1659264758 = (Handshake.CLIENT_HELLO);
                int varFA7153F7ED1CB6C0FCF2FFB2FAC21748_1793704651 = getTaintInt();
        return varFA7153F7ED1CB6C0FCF2FFB2FAC21748_1793704651;
        // ---------- Original Method ----------
