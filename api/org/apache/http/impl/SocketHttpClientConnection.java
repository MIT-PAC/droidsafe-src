...
public class SocketHttpClientConnection extends AbstractHttpClientConnection implements HttpInetConnection {
    ...
    protected SessionInputBuffer createSessionInputBuffer(
        ...
        SessionInputBuffer varB4EAC82CA7396A68D541C85D26508E83_555364116 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_555364116 = new SocketInputBuffer(socket, buffersize, params);
        addTaint(socket.getTaint());
        addTaint(buffersize);
        addTaint(params.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_555364116.addTaint(getTaint()); 
    ...
    protected SessionOutputBuffer createSessionOutputBuffer(
            ...
            int buffersize,
            final HttpParams params) throws IOException {
        SessionOutputBuffer varB4EAC82CA7396A68D541C85D26508E83_681488489 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_681488489 = new SocketOutputBuffer(socket, buffersize, params);
        addTaint(socket.getTaint());
        addTaint(buffersize);
        addTaint(params.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_681488489.addTaint(getTaint()); 
    ...
    protected Socket getSocket() {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_129504617.addTaint(getTaint()); 
    ...
    public InetAddress getLocalAddress() {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_1889898680 = null; 
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_1815710920 = null; 
        {
        ...
        InetAddress varA7E53CE21691AB073D9660D615818899_1174709370; 
        ...
        varA7E53CE21691AB073D9660D615818899_1174709370.addTaint(getTaint()); 
    ...
    public InetAddress getRemoteAddress() {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_1349309735 = null; 
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_2144512057 = null; 
        {
        ...
        InetAddress varA7E53CE21691AB073D9660D615818899_3518316; 
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: 
        ...
        varA7E53CE21691AB073D9660D615818899_3518316.addTaint(getTaint()); 
