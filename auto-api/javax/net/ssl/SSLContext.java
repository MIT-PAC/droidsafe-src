...
public class SSLContext {
    ...
    public final String getProtocol() {
        String varB4EAC82CA7396A68D541C85D26508E83_2014159604 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2014159604 = protocol;
        varB4EAC82CA7396A68D541C85D26508E83_2014159604.addTaint(getTaint()); //Add taint from parent
    ...
    public final Provider getProvider() {
        Provider varB4EAC82CA7396A68D541C85D26508E83_56168954 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_56168954 = provider;
        varB4EAC82CA7396A68D541C85D26508E83_56168954.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLSocketFactory getSocketFactory() {
        SSLSocketFactory varB4EAC82CA7396A68D541C85D26508E83_370737753 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_370737753 = spiImpl.engineGetSocketFactory();
        varB4EAC82CA7396A68D541C85D26508E83_370737753.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLServerSocketFactory getServerSocketFactory() {
        SSLServerSocketFactory varB4EAC82CA7396A68D541C85D26508E83_2097313328 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2097313328 = spiImpl.engineGetServerSocketFactory();
        varB4EAC82CA7396A68D541C85D26508E83_2097313328.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLEngine createSSLEngine() {
        SSLEngine varB4EAC82CA7396A68D541C85D26508E83_999027170 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_999027170 = spiImpl.engineCreateSSLEngine();
        varB4EAC82CA7396A68D541C85D26508E83_999027170.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLEngine createSSLEngine(String peerHost, int peerPort) {
        SSLEngine varB4EAC82CA7396A68D541C85D26508E83_483358354 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_483358354 = spiImpl.engineCreateSSLEngine(peerHost, peerPort);
        addTaint(peerHost.getTaint());
        addTaint(peerPort);
        varB4EAC82CA7396A68D541C85D26508E83_483358354.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLSessionContext getServerSessionContext() {
        SSLSessionContext varB4EAC82CA7396A68D541C85D26508E83_340078579 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_340078579 = spiImpl.engineGetServerSessionContext();
        varB4EAC82CA7396A68D541C85D26508E83_340078579.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLSessionContext getClientSessionContext() {
        SSLSessionContext varB4EAC82CA7396A68D541C85D26508E83_397744403 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_397744403 = spiImpl.engineGetClientSessionContext();
        varB4EAC82CA7396A68D541C85D26508E83_397744403.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLParameters getDefaultSSLParameters() {
        SSLParameters varB4EAC82CA7396A68D541C85D26508E83_510468701 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_510468701 = spiImpl.engineGetDefaultSSLParameters();
        varB4EAC82CA7396A68D541C85D26508E83_510468701.addTaint(getTaint()); //Add taint from parent
    ...
    public final SSLParameters getSupportedSSLParameters() {
        SSLParameters varB4EAC82CA7396A68D541C85D26508E83_679292246 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_679292246 = spiImpl.engineGetSupportedSSLParameters();
        varB4EAC82CA7396A68D541C85D26508E83_679292246.addTaint(getTaint()); //Add taint from parent
