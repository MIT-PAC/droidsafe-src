...
class DefaultSSLSocketFactory extends SSLSocketFactory {
    ...
    public String[] getDefaultCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_667857806 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_667857806 = EmptyArray.STRING;
        varB4EAC82CA7396A68D541C85D26508E83_667857806.addTaint(getTaint()); //Add taint from parent
    ...
    public String[] getSupportedCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_1769301601 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1769301601 = EmptyArray.STRING;
        varB4EAC82CA7396A68D541C85D26508E83_1769301601.addTaint(getTaint()); //Add taint from parent
