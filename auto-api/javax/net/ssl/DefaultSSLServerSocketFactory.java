...
class DefaultSSLServerSocketFactory extends SSLServerSocketFactory {
	...
	public String[] getDefaultCipherSuites() {
		String[] varB4EAC82CA7396A68D541C85D26508E83_414223024 = null; // Variable
																		// for
																		// return
																		// #1
		varB4EAC82CA7396A68D541C85D26508E83_414223024 = EmptyArray.STRING;
		varB4EAC82CA7396A68D541C85D26508E83_414223024.addTaint(getTaint()); // Add
																			// taint
																			// from
																			// parent
	...
	public String[] getSupportedCipherSuites() {
		String[] varB4EAC82CA7396A68D541C85D26508E83_978683070 = null; // Variable
																		// for
																		// return
																		// #1
		varB4EAC82CA7396A68D541C85D26508E83_978683070 = EmptyArray.STRING;
		varB4EAC82CA7396A68D541C85D26508E83_978683070.addTaint(getTaint()); // Add
																			// taint
																			// from
																			// parent
