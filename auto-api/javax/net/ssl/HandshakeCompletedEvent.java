...
public class HandshakeCompletedEvent extends EventObject {
    ...
    public SSLSession getSession() {
        SSLSession varB4EAC82CA7396A68D541C85D26508E83_1017571735 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1017571735 = session;
        varB4EAC82CA7396A68D541C85D26508E83_1017571735.addTaint(getTaint()); //Add taint from parent
    ...
    public String getCipherSuite() {
        String varB4EAC82CA7396A68D541C85D26508E83_237804217 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_237804217 = session.getCipherSuite();
        varB4EAC82CA7396A68D541C85D26508E83_237804217.addTaint(getTaint()); //Add taint from parent
    ...
    public Certificate[] getLocalCertificates() {
        Certificate[] varB4EAC82CA7396A68D541C85D26508E83_1876624450 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1876624450 = session.getLocalCertificates();
        varB4EAC82CA7396A68D541C85D26508E83_1876624450.addTaint(getTaint()); //Add taint from parent
    ...
    public Certificate[] getPeerCertificates() throws SSLPeerUnverifiedException {
        Certificate[] varB4EAC82CA7396A68D541C85D26508E83_1070288223 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1070288223 = session.getPeerCertificates();
        varB4EAC82CA7396A68D541C85D26508E83_1070288223.addTaint(getTaint()); //Add taint from parent
    ...
    public X509Certificate[] getPeerCertificateChain() throws SSLPeerUnverifiedException {
        X509Certificate[] varB4EAC82CA7396A68D541C85D26508E83_2112852278 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2112852278 = session.getPeerCertificateChain();
        varB4EAC82CA7396A68D541C85D26508E83_2112852278.addTaint(getTaint()); //Add taint from parent
    ...
    public Principal getPeerPrincipal() throws SSLPeerUnverifiedException {
        Principal varB4EAC82CA7396A68D541C85D26508E83_453518030 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_453518030 = session.getPeerPrincipal();
        varB4EAC82CA7396A68D541C85D26508E83_453518030.addTaint(getTaint()); //Add taint from parent
    ...
    public Principal getLocalPrincipal() {
        Principal varB4EAC82CA7396A68D541C85D26508E83_21569090 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_21569090 = session.getLocalPrincipal();
        varB4EAC82CA7396A68D541C85D26508E83_21569090.addTaint(getTaint()); //Add taint from parent
    ...
    public SSLSocket getSocket() {
        SSLSocket varB4EAC82CA7396A68D541C85D26508E83_1383165719 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1383165719 = (SSLSocket) this.source;
        varB4EAC82CA7396A68D541C85D26508E83_1383165719.addTaint(getTaint()); //Add taint from parent
