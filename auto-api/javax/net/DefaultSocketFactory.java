...
final class DefaultSocketFactory extends SocketFactory {
    ...
    public Socket createSocket() throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_2071764856 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2071764856 = new Socket();
        varB4EAC82CA7396A68D541C85D26508E83_2071764856.addTaint(getTaint()); //Add taint from parent
    ...
    public Socket createSocket(String host, int port) throws IOException, UnknownHostException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_1019868137 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1019868137 = new Socket(host, port);
        addTaint(host.getTaint());
        addTaint(port);
        varB4EAC82CA7396A68D541C85D26508E83_1019868137.addTaint(getTaint()); //Add taint from parent
    ...
    public Socket createSocket(String host, int port, InetAddress localHost, int localPort) throws IOException, UnknownHostException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_1932653993 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1932653993 = new Socket(host, port, localHost, localPort);
        addTaint(host.getTaint());
        addTaint(port);
        addTaint(localHost.getTaint());
        addTaint(localPort);
        varB4EAC82CA7396A68D541C85D26508E83_1932653993.addTaint(getTaint()); //Add taint from parent
    ...
    public Socket createSocket(InetAddress host, int port) throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_742096966 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_742096966 = new Socket(host, port);
        addTaint(host.getTaint());
        addTaint(port);
        varB4EAC82CA7396A68D541C85D26508E83_742096966.addTaint(getTaint()); //Add taint from parent
    ...
    public Socket createSocket(InetAddress address, int port, InetAddress localAddress,
        ...
        Socket varB4EAC82CA7396A68D541C85D26508E83_183159674 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_183159674 = new Socket(address, port, localAddress, localPort);
        addTaint(address.getTaint());
        addTaint(port);
        addTaint(localAddress.getTaint());
        addTaint(localPort);
        varB4EAC82CA7396A68D541C85D26508E83_183159674.addTaint(getTaint()); //Add taint from parent
