...
public class SecretKeyFactory {
    ...
    public final String getAlgorithm() {
        String varB4EAC82CA7396A68D541C85D26508E83_507236724 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_507236724 = algorithm;
        varB4EAC82CA7396A68D541C85D26508E83_507236724.addTaint(getTaint()); 
    ...
    public final Provider getProvider() {
        Provider varB4EAC82CA7396A68D541C85D26508E83_720709691 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_720709691 = provider;
        varB4EAC82CA7396A68D541C85D26508E83_720709691.addTaint(getTaint()); 
    ...
    public final SecretKey generateSecret(KeySpec keySpec) throws InvalidKeySpecException {
        SecretKey varB4EAC82CA7396A68D541C85D26508E83_580416795 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_580416795 = spiImpl.engineGenerateSecret(keySpec);
        addTaint(keySpec.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_580416795.addTaint(getTaint()); 
    ...
    public final KeySpec getKeySpec(SecretKey key, Class keySpec) throws InvalidKeySpecException {
        KeySpec varB4EAC82CA7396A68D541C85D26508E83_1230568497 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1230568497 = spiImpl.engineGetKeySpec(key, keySpec);
        addTaint(key.getTaint());
        addTaint(keySpec.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1230568497.addTaint(getTaint()); 
    ...
    public final SecretKey translateKey(SecretKey key) throws InvalidKeyException {
        SecretKey varB4EAC82CA7396A68D541C85D26508E83_2009444594 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_2009444594 = spiImpl.engineTranslateKey(key);
        addTaint(key.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_2009444594.addTaint(getTaint()); 
