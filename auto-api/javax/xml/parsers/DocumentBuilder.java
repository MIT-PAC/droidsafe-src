...
public abstract class DocumentBuilder {
    ...
    public Document parse(InputStream is) throws SAXException, IOException {
        Document varB4EAC82CA7396A68D541C85D26508E83_1179603581 = null; 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1179603581.addTaint(getTaint()); 
    ...
    public Document parse(InputStream is, String systemId) throws SAXException, IOException {
        Document varB4EAC82CA7396A68D541C85D26508E83_1162769101 = null; 
        {
            if (DroidSafeAndroidRuntime.control) throw new IllegalArgumentException("InputStream cannot be null");
        } 
        InputSource in = new InputSource(is);
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1162769101.addTaint(getTaint()); 
    ...
    public Document parse(String uri) throws SAXException, IOException {
        Document varB4EAC82CA7396A68D541C85D26508E83_74972216 = null; 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_74972216.addTaint(getTaint()); 
    ...
    public Document parse(File f) throws SAXException, IOException {
        Document varB4EAC82CA7396A68D541C85D26508E83_478268475 = null; 
        {
        ...
        addTaint(f.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_478268475.addTaint(getTaint()); 
