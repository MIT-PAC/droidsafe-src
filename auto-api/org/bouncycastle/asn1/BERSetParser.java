...
public class BERSetParser implements ASN1SetParser {
    ...
    public DEREncodable readObject() throws IOException {
        DEREncodable varB4EAC82CA7396A68D541C85D26508E83_782977963 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_782977963 = _parser.readObject();
        varB4EAC82CA7396A68D541C85D26508E83_782977963.addTaint(getTaint()); //Add taint from parent
    ...
    public DERObject getLoadedObject() throws IOException {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_969850999 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_969850999 = new BERSet(_parser.readVector(), false);
        varB4EAC82CA7396A68D541C85D26508E83_969850999.addTaint(getTaint()); //Add taint from parent
    ...
    public DERObject getDERObject() {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_190294371 = null; //Variable for return #1
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_190294371.addTaint(getTaint()); //Add taint from parent
