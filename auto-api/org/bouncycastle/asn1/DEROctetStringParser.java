...
public class DEROctetStringParser implements ASN1OctetStringParser {
    ...
    public InputStream getOctetStream() {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_434998445.addTaint(getTaint()); 
    ...
    public DERObject getLoadedObject() throws IOException {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_2097103004 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_2097103004 = new DEROctetString(stream.toByteArray());
        varB4EAC82CA7396A68D541C85D26508E83_2097103004.addTaint(getTaint()); 
    ...
    public DERObject getDERObject() {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_1206563830 = null; 
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1206563830.addTaint(getTaint()); 
