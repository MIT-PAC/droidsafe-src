...
public class DERUTCTime extends ASN1Object {
    ...
    public Date getDate() throws ParseException {
        Date varB4EAC82CA7396A68D541C85D26508E83_1075130096 = null; //Variable for return #1
        SimpleDateFormat dateF = new SimpleDateFormat("yyMMddHHmmssz");
        varB4EAC82CA7396A68D541C85D26508E83_1075130096 = dateF.parse(getTime());
        varB4EAC82CA7396A68D541C85D26508E83_1075130096.addTaint(getTaint()); //Add taint from parent
    ...
    public Date getAdjustedDate() throws ParseException {
        Date varB4EAC82CA7396A68D541C85D26508E83_719959723 = null; //Variable for return #1
        SimpleDateFormat dateF = new SimpleDateFormat("yyyyMMddHHmmssz");
        dateF.setTimeZone(new SimpleTimeZone(0, "Z"));
        varB4EAC82CA7396A68D541C85D26508E83_719959723 = dateF.parse(getAdjustedTime());
        varB4EAC82CA7396A68D541C85D26508E83_719959723.addTaint(getTaint()); //Add taint from parent
    ...
    public String getTime() {
        String varB4EAC82CA7396A68D541C85D26508E83_1844238782 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1712151983 = null; //Variable for return #2
        String varB4EAC82CA7396A68D541C85D26508E83_1319491207 = null; //Variable for return #3
        String varB4EAC82CA7396A68D541C85D26508E83_837229670 = null; //Variable for return #4
        {
        ...
        String varA7E53CE21691AB073D9660D615818899_382172749; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_382172749.addTaint(getTaint()); //Add taint from parent
    ...
    public String getAdjustedTime() {
        String varB4EAC82CA7396A68D541C85D26508E83_430793906 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_716824550 = null; //Variable for return #2
        ...
        String varA7E53CE21691AB073D9660D615818899_760257967; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_760257967.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_975428110 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_975428110 = time;
        varB4EAC82CA7396A68D541C85D26508E83_975428110.addTaint(getTaint()); //Add taint from parent
