...
public class DERExternalParser implements DEREncodable, InMemoryRepresentable {
    ...
    public DEREncodable readObject() throws IOException {
        DEREncodable varB4EAC82CA7396A68D541C85D26508E83_463972363 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_463972363 = _parser.readObject();
        varB4EAC82CA7396A68D541C85D26508E83_463972363.addTaint(getTaint()); //Add taint from parent
    ...
    public DERObject getLoadedObject() throws IOException {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_1630693766 = null; //Variable for return #1
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1630693766.addTaint(getTaint()); //Add taint from parent
    ...
    public DERObject getDERObject() {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_846462516 = null; //Variable for return #1
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_846462516.addTaint(getTaint()); //Add taint from parent
