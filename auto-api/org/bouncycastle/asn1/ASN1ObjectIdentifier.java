...
public class ASN1ObjectIdentifier extends DERObjectIdentifier {
    ...
    public ASN1ObjectIdentifier branch(String branchID) {
        ASN1ObjectIdentifier varB4EAC82CA7396A68D541C85D26508E83_1070038761 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1070038761 = new ASN1ObjectIdentifier(getId() + "." + branchID);
        addTaint(branchID.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1070038761.addTaint(getTaint()); //Add taint from parent
