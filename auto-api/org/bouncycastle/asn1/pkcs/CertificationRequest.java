...
public class CertificationRequest extends ASN1Encodable {
    ...
    public CertificationRequestInfo getCertificationRequestInfo() {
        CertificationRequestInfo varB4EAC82CA7396A68D541C85D26508E83_1466456346 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1466456346 = reqInfo;
        varB4EAC82CA7396A68D541C85D26508E83_1466456346.addTaint(getTaint()); //Add taint from parent
    ...
    public AlgorithmIdentifier getSignatureAlgorithm() {
        AlgorithmIdentifier varB4EAC82CA7396A68D541C85D26508E83_2106399621 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2106399621 = sigAlgId;
        varB4EAC82CA7396A68D541C85D26508E83_2106399621.addTaint(getTaint()); //Add taint from parent
    ...
    public DERBitString getSignature() {
        DERBitString varB4EAC82CA7396A68D541C85D26508E83_268815789 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_268815789 = sigBits;
        varB4EAC82CA7396A68D541C85D26508E83_268815789.addTaint(getTaint()); //Add taint from parent
    ...
    public DERObject toASN1Object() {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_1965466522 = null; //Variable for return #1
        ASN1EncodableVector v = new ASN1EncodableVector();
        v.add(reqInfo);
        v.add(sigAlgId);
        v.add(sigBits);
        varB4EAC82CA7396A68D541C85D26508E83_1965466522 = new DERSequence(v);
        varB4EAC82CA7396A68D541C85D26508E83_1965466522.addTaint(getTaint()); //Add taint from parent
