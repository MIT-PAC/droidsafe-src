...
public class BERSequenceParser implements ASN1SequenceParser {
    ...
    public DEREncodable readObject() throws IOException {
        DEREncodable varB4EAC82CA7396A68D541C85D26508E83_290520566 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_290520566 = _parser.readObject();
        varB4EAC82CA7396A68D541C85D26508E83_290520566.addTaint(getTaint()); //Add taint from parent
    ...
    public DERObject getLoadedObject() throws IOException {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_796374645 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_796374645 = new BERSequence(_parser.readVector());
        varB4EAC82CA7396A68D541C85D26508E83_796374645.addTaint(getTaint()); //Add taint from parent
    ...
    public DERObject getDERObject() {
        DERObject varB4EAC82CA7396A68D541C85D26508E83_699079306 = null; //Variable for return #1
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_699079306.addTaint(getTaint()); //Add taint from parent
