...
class WTauNafMultiplier implements ECMultiplier {
    ...
    public ECPoint multiply(ECPoint point, BigInteger k, PreCompInfo preCompInfo) {
        ECPoint varB4EAC82CA7396A68D541C85D26508E83_267022635 = null; 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_267022635.addTaint(getTaint()); 
    ...
    private ECPoint.F2m multiplyWTnaf(ECPoint.F2m p, ZTauElement lambda,
        ...
        ECPoint.F2m varB4EAC82CA7396A68D541C85D26508E83_1393054138 = null; 
        ZTauElement[] alpha;
        {
            alpha = Tnaf.alpha0;
        } 
        ...
        addTaint(a);
        addTaint(mu);
        varB4EAC82CA7396A68D541C85D26508E83_1393054138.addTaint(getTaint()); 
