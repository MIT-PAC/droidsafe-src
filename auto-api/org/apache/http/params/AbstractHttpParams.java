...
public abstract class AbstractHttpParams implements HttpParams {
    ...
    public HttpParams setLongParameter(final String name, long value) {
        HttpParams varB4EAC82CA7396A68D541C85D26508E83_1746152157 = null; //Variable for return #1
        setParameter(name, new Long(value));
        varB4EAC82CA7396A68D541C85D26508E83_1746152157 = this;
        addTaint(name.getTaint());
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1746152157.addTaint(getTaint()); //Add taint from parent
    ...
    public HttpParams setIntParameter(final String name, int value) {
        HttpParams varB4EAC82CA7396A68D541C85D26508E83_1176945915 = null; //Variable for return #1
        setParameter(name, new Integer(value));
        varB4EAC82CA7396A68D541C85D26508E83_1176945915 = this;
        addTaint(name.getTaint());
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1176945915.addTaint(getTaint()); //Add taint from parent
    ...
    public HttpParams setDoubleParameter(final String name, double value) {
        HttpParams varB4EAC82CA7396A68D541C85D26508E83_1456104970 = null; //Variable for return #1
        setParameter(name, new Double(value));
        varB4EAC82CA7396A68D541C85D26508E83_1456104970 = this;
        addTaint(name.getTaint());
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1456104970.addTaint(getTaint()); //Add taint from parent
    ...
    public HttpParams setBooleanParameter(final String name, boolean value) {
        HttpParams varB4EAC82CA7396A68D541C85D26508E83_1305137421 = null; //Variable for return #1
        setParameter(name, value ? Boolean.TRUE : Boolean.FALSE);
        varB4EAC82CA7396A68D541C85D26508E83_1305137421 = this;
        addTaint(name.getTaint());
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1305137421.addTaint(getTaint()); //Add taint from parent
