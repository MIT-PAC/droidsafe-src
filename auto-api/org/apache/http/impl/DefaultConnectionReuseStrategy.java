...
public class DefaultConnectionReuseStrategy implements ConnectionReuseStrategy {
    ...
    protected TokenIterator createTokenIterator(HeaderIterator hit) {
        TokenIterator varB4EAC82CA7396A68D541C85D26508E83_1897685489 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1897685489 = new BasicTokenIterator(hit);
        addTaint(hit.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1897685489.addTaint(getTaint()); //Add taint from parent
