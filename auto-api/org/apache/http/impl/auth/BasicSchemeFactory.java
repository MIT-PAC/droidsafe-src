...
public class BasicSchemeFactory implements AuthSchemeFactory {
    ...
    public AuthScheme newInstance(final HttpParams params) {
        AuthScheme varB4EAC82CA7396A68D541C85D26508E83_1613043312 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1613043312 = new BasicScheme();
        addTaint(params.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1613043312.addTaint(getTaint()); //Add taint from parent
