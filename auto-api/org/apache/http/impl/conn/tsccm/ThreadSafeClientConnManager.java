...
public class ThreadSafeClientConnManager implements ClientConnectionManager {
    ...
    protected AbstractConnPool createConnectionPool(final HttpParams params) {
        AbstractConnPool varB4EAC82CA7396A68D541C85D26508E83_1639446597 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1639446597.addTaint(getTaint()); //Add taint from parent
    ...
    protected ClientConnectionOperator createConnectionOperator(SchemeRegistry schreg) {
        ClientConnectionOperator varB4EAC82CA7396A68D541C85D26508E83_854067861 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_854067861 = new DefaultClientConnectionOperator(schreg);
        addTaint(schreg.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_854067861.addTaint(getTaint()); //Add taint from parent
    ...
    public SchemeRegistry getSchemeRegistry() {
        SchemeRegistry varB4EAC82CA7396A68D541C85D26508E83_241105017 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_241105017 = this.schemeRegistry;
        varB4EAC82CA7396A68D541C85D26508E83_241105017.addTaint(getTaint()); //Add taint from parent
    ...
    public ClientConnectionRequest requestConnection(
            ...
            final Object state) {
        ClientConnectionRequest varB4EAC82CA7396A68D541C85D26508E83_83493792 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_83493792.addTaint(getTaint()); //Add taint from parent
