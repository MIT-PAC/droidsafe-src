...
public abstract class AbstractCookieSpec implements CookieSpec {
    ...
    protected CookieAttributeHandler findAttribHandler(final String name) {
        CookieAttributeHandler varB4EAC82CA7396A68D541C85D26508E83_357146696 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_357146696 = this.attribHandlerMap.get(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_357146696.addTaint(getTaint()); 
    ...
    protected CookieAttributeHandler getAttribHandler(final String name) {
        CookieAttributeHandler varB4EAC82CA7396A68D541C85D26508E83_452258437 = null; 
        ...
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_452258437.addTaint(getTaint()); 
    ...
    protected Collection<CookieAttributeHandler> getAttribHandlers() {
        Collection<CookieAttributeHandler> varB4EAC82CA7396A68D541C85D26508E83_2139855042 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_2139855042 = this.attribHandlerMap.values();
        varB4EAC82CA7396A68D541C85D26508E83_2139855042.addTaint(getTaint()); 
