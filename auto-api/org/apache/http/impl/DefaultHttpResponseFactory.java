...
public class DefaultHttpResponseFactory implements HttpResponseFactory {
    ...
    public HttpResponse newHttpResponse(final ProtocolVersion ver,
                                        final int status,
                                        HttpContext context) {
        HttpResponse varB4EAC82CA7396A68D541C85D26508E83_1126231000 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1126231000.addTaint(getTaint()); //Add taint from parent
    ...
    public HttpResponse newHttpResponse(final StatusLine statusline,
                                        HttpContext context) {
        HttpResponse varB4EAC82CA7396A68D541C85D26508E83_228050673 = null; //Variable for return #1
        {
        ...
        addTaint(context.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_228050673.addTaint(getTaint()); //Add taint from parent
    ...
    protected Locale determineLocale(HttpContext context) {
        Locale varB4EAC82CA7396A68D541C85D26508E83_480559151 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_480559151 = Locale.getDefault();
        addTaint(context.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_480559151.addTaint(getTaint()); //Add taint from parent
