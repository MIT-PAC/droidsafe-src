...
public class StringBuilderWriter extends Writer implements Serializable {
    ...
    public Writer append(char value) {
        Writer varB4EAC82CA7396A68D541C85D26508E83_651525642 = null; //Variable for return #1
        builder.append(value);
        varB4EAC82CA7396A68D541C85D26508E83_651525642 = this;
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_651525642.addTaint(getTaint()); //Add taint from parent
    ...
    public Writer append(CharSequence value) {
        Writer varB4EAC82CA7396A68D541C85D26508E83_92158837 = null; //Variable for return #1
        builder.append(value);
        varB4EAC82CA7396A68D541C85D26508E83_92158837 = this;
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_92158837.addTaint(getTaint()); //Add taint from parent
    ...
    public Writer append(CharSequence value, int start, int end) {
        Writer varB4EAC82CA7396A68D541C85D26508E83_1455046909 = null; //Variable for return #1
        builder.append(value, start, end);
        varB4EAC82CA7396A68D541C85D26508E83_1455046909 = this;
        addTaint(value.getTaint());
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_1455046909.addTaint(getTaint()); //Add taint from parent
    ...
    public StringBuilder getBuilder() {
        StringBuilder varB4EAC82CA7396A68D541C85D26508E83_1863656755 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1863656755 = builder;
        varB4EAC82CA7396A68D541C85D26508E83_1863656755.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_809019566 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_809019566 = builder.toString();
        varB4EAC82CA7396A68D541C85D26508E83_809019566.addTaint(getTaint()); //Add taint from parent
