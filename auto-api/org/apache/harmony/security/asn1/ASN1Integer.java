...
public final class ASN1Integer extends ASN1Primitive {
    ...
    public Object decode(BerInputStream in) throws IOException {
        Object varB4EAC82CA7396A68D541C85D26508E83_136438957 = null; //Variable for return #1
        Object varB4EAC82CA7396A68D541C85D26508E83_897484854 = null; //Variable for return #2
        in.readInteger();
        {
        ...
        Object varA7E53CE21691AB073D9660D615818899_2036922707; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_2036922707.addTaint(getTaint()); //Add taint from parent
    ...
    public Object getDecodedObject(BerInputStream in) throws IOException {
        Object varB4EAC82CA7396A68D541C85D26508E83_1657977568 = null; //Variable for return #1
        ...
        addTaint(in.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1657977568.addTaint(getTaint()); //Add taint from parent
