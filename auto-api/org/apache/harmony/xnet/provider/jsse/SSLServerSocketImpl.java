...
public class SSLServerSocketImpl extends SSLServerSocket {
    ...
    public String[] getSupportedCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_1076374774 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1076374774 = CipherSuite.getSupportedCipherSuiteNames();
        varB4EAC82CA7396A68D541C85D26508E83_1076374774.addTaint(getTaint()); //Add taint from parent
    ...
    public String[] getEnabledCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_335777483 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_335777483 = sslParameters.getEnabledCipherSuites();
        varB4EAC82CA7396A68D541C85D26508E83_335777483.addTaint(getTaint()); //Add taint from parent
    ...
    public String[] getSupportedProtocols() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_2055015334 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2055015334 = ProtocolVersion.supportedProtocols.clone();
        varB4EAC82CA7396A68D541C85D26508E83_2055015334.addTaint(getTaint()); //Add taint from parent
    ...
    public String[] getEnabledProtocols() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_818407447 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_818407447 = sslParameters.getEnabledProtocols();
        varB4EAC82CA7396A68D541C85D26508E83_818407447.addTaint(getTaint()); //Add taint from parent
    ...
    public Socket accept() throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_106878257 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_106878257.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_674496323 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_674496323 = "[SSLServerSocketImpl]";
        varB4EAC82CA7396A68D541C85D26508E83_674496323.addTaint(getTaint()); //Add taint from parent
