...
public class SSLServerSocketFactoryImpl extends SSLServerSocketFactory {
    ...
    public String[] getDefaultCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_1302143434 = null; //Variable for return #1
        String[] varB4EAC82CA7396A68D541C85D26508E83_1206316822 = null; //Variable for return #2
        {
        ...
        String[] varA7E53CE21691AB073D9660D615818899_1713446304; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1713446304.addTaint(getTaint()); //Add taint from parent
    ...
    public String[] getSupportedCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_2092934497 = null; //Variable for return #1
        String[] varB4EAC82CA7396A68D541C85D26508E83_1241407175 = null; //Variable for return #2
        {
        ...
        String[] varA7E53CE21691AB073D9660D615818899_2077892000; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_2077892000.addTaint(getTaint()); //Add taint from parent
    ...
    public ServerSocket createServerSocket() throws IOException {
        ServerSocket varB4EAC82CA7396A68D541C85D26508E83_1665303883 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1665303883.addTaint(getTaint()); //Add taint from parent
    ...
    public ServerSocket createServerSocket(int port) throws IOException {
        ServerSocket varB4EAC82CA7396A68D541C85D26508E83_934461757 = null; //Variable for return #1
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } //End block
        ...
        addTaint(port);
        varB4EAC82CA7396A68D541C85D26508E83_934461757.addTaint(getTaint()); //Add taint from parent
    ...
    public ServerSocket createServerSocket(int port, int backlog) throws IOException {
        ServerSocket varB4EAC82CA7396A68D541C85D26508E83_1519409100 = null; //Variable for return #1
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } //End block
        ...
        addTaint(port);
        addTaint(backlog);
        varB4EAC82CA7396A68D541C85D26508E83_1519409100.addTaint(getTaint()); //Add taint from parent
    ...
    public ServerSocket createServerSocket(int port, int backlog,
        ...
        ServerSocket varB4EAC82CA7396A68D541C85D26508E83_298345111 = null; //Variable for return #1
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } //End block
        ...
        varB4EAC82CA7396A68D541C85D26508E83_298345111.addTaint(getTaint()); //Add taint from parent
