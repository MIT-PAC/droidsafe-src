...
public class SSLSocketFactoryImpl extends SSLSocketFactory {
    ...
    public String[] getDefaultCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_964356744 = null; 
        String[] varB4EAC82CA7396A68D541C85D26508E83_762355506 = null; 
        {
        ...
        String[] varA7E53CE21691AB073D9660D615818899_893725116; 
        ...
        varA7E53CE21691AB073D9660D615818899_893725116.addTaint(getTaint()); 
    ...
    public String[] getSupportedCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_370764373 = null; 
        String[] varB4EAC82CA7396A68D541C85D26508E83_301398556 = null; 
        {
        ...
        String[] varA7E53CE21691AB073D9660D615818899_1277712289; 
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: 
        ...
        varA7E53CE21691AB073D9660D615818899_1277712289.addTaint(getTaint()); 
    ...
    public Socket createSocket(Socket s, String host, int port,
        ...
        Socket varB4EAC82CA7396A68D541C85D26508E83_875396938 = null; 
        {
        ...
        addTaint(port);
        addTaint(autoClose);
        varB4EAC82CA7396A68D541C85D26508E83_875396938.addTaint(getTaint()); 
    ...
    public Socket createSocket() throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_41006926 = null; 
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } 
        varB4EAC82CA7396A68D541C85D26508E83_41006926 = new SSLSocketImpl((SSLParametersImpl) sslParameters.clone());
        varB4EAC82CA7396A68D541C85D26508E83_41006926.addTaint(getTaint()); 
    ...
    public Socket createSocket(String host, int port) throws IOException, UnknownHostException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_1520800270 = null; 
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } 
        ...
        addTaint(host.getTaint());
        addTaint(port);
        varB4EAC82CA7396A68D541C85D26508E83_1520800270.addTaint(getTaint()); 
    ...
    public Socket createSocket(String host, int port,
        ...
        Socket varB4EAC82CA7396A68D541C85D26508E83_190079765 = null; 
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } 
        ...
        addTaint(localPort);
        varB4EAC82CA7396A68D541C85D26508E83_190079765.addTaint(getTaint()); 
    ...
    public Socket createSocket(InetAddress host, int port) throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_976453671 = null; 
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } 
        ...
        addTaint(host.getTaint());
        addTaint(port);
        varB4EAC82CA7396A68D541C85D26508E83_976453671.addTaint(getTaint()); 
    ...
    public Socket createSocket(InetAddress address, int port,
        ...
        Socket varB4EAC82CA7396A68D541C85D26508E83_506576142 = null; 
        {
            if (DroidSafeAndroidRuntime.control) throw instantiationException;
        } 
        ...
        addTaint(localPort);
        varB4EAC82CA7396A68D541C85D26508E83_506576142.addTaint(getTaint()); 
