...
public class OpenSSLSocketFactoryImpl extends javax.net.ssl.SSLSocketFactory {
    ...
    public String[] getDefaultCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_2129613893 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_2129613893 = NativeCrypto.getDefaultCipherSuites();
        varB4EAC82CA7396A68D541C85D26508E83_2129613893.addTaint(getTaint()); 
    ...
    public String[] getSupportedCipherSuites() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_419490168 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_419490168 = NativeCrypto.getSupportedCipherSuites();
        varB4EAC82CA7396A68D541C85D26508E83_419490168.addTaint(getTaint()); 
    ...
    public Socket createSocket() throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_461913512 = null; 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_461913512.addTaint(getTaint()); 
    ...
    public Socket createSocket(String host, int port) throws IOException, UnknownHostException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_671638856 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_671638856 = new OpenSSLSocketImpl(host, port, (SSLParametersImpl) sslParameters.clone());
        addTaint(host.getTaint());
        addTaint(port);
        varB4EAC82CA7396A68D541C85D26508E83_671638856.addTaint(getTaint()); 
    ...
    public Socket createSocket(String host, int port, InetAddress localHost, int localPort) throws IOException, UnknownHostException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_1391793791 = null; 
        ...
        addTaint(localPort);
        varB4EAC82CA7396A68D541C85D26508E83_1391793791.addTaint(getTaint()); 
    ...
    public Socket createSocket(InetAddress host, int port) throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_442879513 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_442879513 = new OpenSSLSocketImpl(host, port, (SSLParametersImpl) sslParameters.clone());
        addTaint(host.getTaint());
        addTaint(port);
        varB4EAC82CA7396A68D541C85D26508E83_442879513.addTaint(getTaint()); 
    ...
    public Socket createSocket(InetAddress address,
        ...
        Socket varB4EAC82CA7396A68D541C85D26508E83_143226332 = null; 
        ...
        addTaint(localPort);
        varB4EAC82CA7396A68D541C85D26508E83_143226332.addTaint(getTaint()); 
    ...
    public Socket createSocket(Socket s, String host, int port, boolean autoClose) throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_1414353404 = null; 
        ...
        addTaint(port);
        addTaint(autoClose);
        varB4EAC82CA7396A68D541C85D26508E83_1414353404.addTaint(getTaint()); 
