...
abstract class ExpatAttributes implements Attributes {
    ...
    public String getURI(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_2135924183 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_2028081247 = null; //Variable for return #2
        {
        ...
        addTaint(index);
        String varA7E53CE21691AB073D9660D615818899_1685416500; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1685416500.addTaint(getTaint()); //Add taint from parent
    ...
    public String getLocalName(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_665525518 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_665525518 = (index < 0 || index >= getLength())
                ? null
                : getLocalName(getParserPointer(), getPointer(), index);
        addTaint(index);
        varB4EAC82CA7396A68D541C85D26508E83_665525518.addTaint(getTaint()); //Add taint from parent
    ...
    public String getQName(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_457325168 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_457325168 = (index < 0 || index >= getLength())
                ? null
                : getQName(getParserPointer(), getPointer(), index);
        addTaint(index);
        varB4EAC82CA7396A68D541C85D26508E83_457325168.addTaint(getTaint()); //Add taint from parent
    ...
    public String getType(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_1353383903 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1353383903 = (index < 0 || index >= getLength()) ? null : CDATA;
        addTaint(index);
        varB4EAC82CA7396A68D541C85D26508E83_1353383903.addTaint(getTaint()); //Add taint from parent
    ...
    public String getValue(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_136865702 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_136865702 = (index < 0 || index >= getLength())
                ? null
                : getValueByIndex(getPointer(), index);
        addTaint(index);
        varB4EAC82CA7396A68D541C85D26508E83_136865702.addTaint(getTaint()); //Add taint from parent
    ...
    public String getType(String uri, String localName) {
        String varB4EAC82CA7396A68D541C85D26508E83_145047384 = null; //Variable for return #1
        {
            if (DroidSafeAndroidRuntime.control) throw new NullPointerException("uri");
        } //End block
        {
        ...
        addTaint(uri.getTaint());
        addTaint(localName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_145047384.addTaint(getTaint()); //Add taint from parent
    ...
    public String getType(String qName) {
        String varB4EAC82CA7396A68D541C85D26508E83_310047646 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_310047646 = getIndex(qName) == -1 ? null : CDATA;
        addTaint(qName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_310047646.addTaint(getTaint()); //Add taint from parent
    ...
    public String getValue(String uri, String localName) {
        String varB4EAC82CA7396A68D541C85D26508E83_220592141 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_390111018 = null; //Variable for return #2
        {
            if (DroidSafeAndroidRuntime.control) throw new NullPointerException("uri");
        } //End block
        {
        ...
        addTaint(uri.getTaint());
        addTaint(localName.getTaint());
        String varA7E53CE21691AB073D9660D615818899_579021567; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_579021567.addTaint(getTaint()); //Add taint from parent
    ...
    public String getValue(String qName) {
        String varB4EAC82CA7396A68D541C85D26508E83_1121980726 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_994077892 = null; //Variable for return #2
        {
        ...
        addTaint(qName.getTaint());
        String varA7E53CE21691AB073D9660D615818899_1691903902; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1691903902.addTaint(getTaint()); //Add taint from parent
