...
class DocumentBuilderImpl extends DocumentBuilder {
    ...
    public DOMImplementation getDOMImplementation() {
        DOMImplementation varB4EAC82CA7396A68D541C85D26508E83_898069866 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_898069866 = dom;
        varB4EAC82CA7396A68D541C85D26508E83_898069866.addTaint(getTaint()); //Add taint from parent
    ...
    public Document newDocument() {
        Document varB4EAC82CA7396A68D541C85D26508E83_1061310967 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1061310967 = dom.createDocument(null, null, null);
        varB4EAC82CA7396A68D541C85D26508E83_1061310967.addTaint(getTaint()); //Add taint from parent
    ...
    public Document parse(InputSource source) throws SAXException, IOException {
        Document varB4EAC82CA7396A68D541C85D26508E83_139995197 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_139995197.addTaint(getTaint()); //Add taint from parent
        ...
        {
            {
                ...
                String target = (dot != -1 ? text.substring(0, dot) : text);//DSFIXME:  CODE0008: Nested ternary operator in expression
                String data = (dot != -1 ? text.substring(dot + 1) : "");//DSFIXME:  CODE0008: Nested ternary operator in expression
    ...
    private String resolvePredefinedOrCharacterEntity(String entityName) {
        String varB4EAC82CA7396A68D541C85D26508E83_1858887693 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1531425955 = null; //Variable for return #2
        String varB4EAC82CA7396A68D541C85D26508E83_703076245 = null; //Variable for return #3
        String varB4EAC82CA7396A68D541C85D26508E83_1543845371 = null; //Variable for return #4
        String varB4EAC82CA7396A68D541C85D26508E83_87914732 = null; //Variable for return #5
        String varB4EAC82CA7396A68D541C85D26508E83_1820689621 = null; //Variable for return #6
        String varB4EAC82CA7396A68D541C85D26508E83_1854442280 = null; //Variable for return #7
        String varB4EAC82CA7396A68D541C85D26508E83_2110959256 = null; //Variable for return #8
        {
        ...
        String varA7E53CE21691AB073D9660D615818899_1332492471; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1332492471.addTaint(getTaint()); //Add taint from parent
    ...
    private String resolveCharacterReference(String value, int base) {
        String varB4EAC82CA7396A68D541C85D26508E83_806815119 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_357030425 = null; //Variable for return #2
        String varB4EAC82CA7396A68D541C85D26508E83_1489350800 = null; //Variable for return #3
        try 
        {
        ...
        addTaint(base);
        String varA7E53CE21691AB073D9660D615818899_1767237604; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1767237604.addTaint(getTaint()); //Add taint from parent
