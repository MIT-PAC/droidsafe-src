...
public class ElementImpl extends InnerNodeImpl implements Element {
    ...
    public String getAttribute(String name) {
        String varB4EAC82CA7396A68D541C85D26508E83_65830250 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1663610236 = null; //Variable for return #2
        ...
        addTaint(name.getTaint());
        String varA7E53CE21691AB073D9660D615818899_1325858389; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1325858389.addTaint(getTaint()); //Add taint from parent
    ...
    public String getAttributeNS(String namespaceURI, String localName) {
        String varB4EAC82CA7396A68D541C85D26508E83_1221681597 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_908870434 = null; //Variable for return #2
        ...
        addTaint(namespaceURI.getTaint());
        addTaint(localName.getTaint());
        String varA7E53CE21691AB073D9660D615818899_1713443917; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1713443917.addTaint(getTaint()); //Add taint from parent
    ...
    public AttrImpl getAttributeNode(String name) {
        AttrImpl varB4EAC82CA7396A68D541C85D26508E83_1852759235 = null; //Variable for return #1
        AttrImpl varB4EAC82CA7396A68D541C85D26508E83_800957570 = null; //Variable for return #2
        ...
        addTaint(name.getTaint());
        AttrImpl varA7E53CE21691AB073D9660D615818899_1132387899; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1132387899.addTaint(getTaint()); //Add taint from parent
    ...
    public AttrImpl getAttributeNodeNS(String namespaceURI, String localName) {
        AttrImpl varB4EAC82CA7396A68D541C85D26508E83_1495876105 = null; //Variable for return #1
        AttrImpl varB4EAC82CA7396A68D541C85D26508E83_1499133881 = null; //Variable for return #2
        ...
        addTaint(namespaceURI.getTaint());
        addTaint(localName.getTaint());
        AttrImpl varA7E53CE21691AB073D9660D615818899_504836798; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_504836798.addTaint(getTaint()); //Add taint from parent
    ...
    public NamedNodeMap getAttributes() {
        NamedNodeMap varB4EAC82CA7396A68D541C85D26508E83_1655460091 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1655460091 = new ElementAttrNamedNodeMapImpl();
        varB4EAC82CA7396A68D541C85D26508E83_1655460091.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:15:36.074 -0400", hash_original_method = "75972D234B77F7219B8A807D51F2F4BE", hash_generated_method = "D450B03B44E55D25C7556DD2177147BF")
     Element getElementById(String name) {
        Element varB4EAC82CA7396A68D541C85D26508E83_1499400828 = null; //Variable for return #1
        Element varB4EAC82CA7396A68D541C85D26508E83_837759612 = null; //Variable for return #2
        ...
        addTaint(name.getTaint());
        Element varA7E53CE21691AB073D9660D615818899_229849131; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_229849131.addTaint(getTaint()); //Add taint from parent
    ...
    public NodeList getElementsByTagName(String name) {
        NodeList varB4EAC82CA7396A68D541C85D26508E83_344173469 = null; //Variable for return #1
        NodeListImpl result = new NodeListImpl();
        getElementsByTagName(result, name);
        varB4EAC82CA7396A68D541C85D26508E83_344173469 = result;
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_344173469.addTaint(getTaint()); //Add taint from parent
    ...
    public NodeList getElementsByTagNameNS(String namespaceURI, String localName) {
        NodeList varB4EAC82CA7396A68D541C85D26508E83_611748120 = null; //Variable for return #1
        NodeListImpl result = new NodeListImpl();
        getElementsByTagNameNS(result, namespaceURI, localName);
        varB4EAC82CA7396A68D541C85D26508E83_611748120 = result;
        addTaint(namespaceURI.getTaint());
        addTaint(localName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_611748120.addTaint(getTaint()); //Add taint from parent
    ...
    public String getLocalName() {
        String varB4EAC82CA7396A68D541C85D26508E83_1767845484 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1767845484 = namespaceAware ? localName : null;
        varB4EAC82CA7396A68D541C85D26508E83_1767845484.addTaint(getTaint()); //Add taint from parent
    ...
    public String getNamespaceURI() {
        String varB4EAC82CA7396A68D541C85D26508E83_1832872335 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1832872335 = namespaceURI;
        varB4EAC82CA7396A68D541C85D26508E83_1832872335.addTaint(getTaint()); //Add taint from parent
    ...
    public String getNodeName() {
        String varB4EAC82CA7396A68D541C85D26508E83_1226805768 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1226805768 = getTagName();
        varB4EAC82CA7396A68D541C85D26508E83_1226805768.addTaint(getTaint()); //Add taint from parent
    ...
    public String getPrefix() {
        String varB4EAC82CA7396A68D541C85D26508E83_1428565690 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1428565690 = prefix;
        varB4EAC82CA7396A68D541C85D26508E83_1428565690.addTaint(getTaint()); //Add taint from parent
    ...
    public String getTagName() {
        String varB4EAC82CA7396A68D541C85D26508E83_1110366248 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1110366248 = prefix != null
                ? prefix + ":" + localName
                : localName;
        varB4EAC82CA7396A68D541C85D26508E83_1110366248.addTaint(getTaint()); //Add taint from parent
    ...
    public Attr removeAttributeNode(Attr oldAttr) throws DOMException {
        Attr varB4EAC82CA7396A68D541C85D26508E83_422631817 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_422631817.addTaint(getTaint()); //Add taint from parent
    ...
    public Attr setAttributeNode(Attr newAttr) throws DOMException {
        Attr varB4EAC82CA7396A68D541C85D26508E83_256086621 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_256086621.addTaint(getTaint()); //Add taint from parent
    ...
    public Attr setAttributeNodeNS(Attr newAttr) throws DOMException {
        Attr varB4EAC82CA7396A68D541C85D26508E83_536113545 = null; //Variable for return #1
        AttrImpl newAttrImpl = (AttrImpl) newAttr;
        {
            if (DroidSafeAndroidRuntime.control) throw new DOMException(DOMException.WRONG_DOCUMENT_ERR, null);
        } //End block
        ...
        addTaint(newAttr.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_536113545.addTaint(getTaint()); //Add taint from parent
    ...
    public TypeInfo getSchemaTypeInfo() {
        TypeInfo varB4EAC82CA7396A68D541C85D26508E83_2114622202 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2114622202 = NULL_TYPE_INFO;
        varB4EAC82CA7396A68D541C85D26508E83_2114622202.addTaint(getTaint()); //Add taint from parent
    ...
    public class ElementAttrNamedNodeMapImpl implements NamedNodeMap {
        ...
        public Node getNamedItem(String name) {
            Node varB4EAC82CA7396A68D541C85D26508E83_1569445341 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_1569445341 = ElementImpl.this.getAttributeNode(name);
            addTaint(name.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_1569445341.addTaint(getTaint()); //Add taint from parent
        ...
        public Node getNamedItemNS(String namespaceURI, String localName) {
            Node varB4EAC82CA7396A68D541C85D26508E83_1354371259 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_1354371259 = ElementImpl.this.getAttributeNodeNS(namespaceURI, localName);
            addTaint(namespaceURI.getTaint());
            addTaint(localName.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_1354371259.addTaint(getTaint()); //Add taint from parent
        ...
        public Node item(int index) {
            Node varB4EAC82CA7396A68D541C85D26508E83_353434938 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_353434938 = ElementImpl.this.attributes.get(index);
            addTaint(index);
            varB4EAC82CA7396A68D541C85D26508E83_353434938.addTaint(getTaint()); //Add taint from parent
        ...
        public Node removeNamedItem(String name) throws DOMException {
            Node varB4EAC82CA7396A68D541C85D26508E83_1754095629 = null; //Variable for return #1
            ...
            addTaint(name.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_1754095629.addTaint(getTaint()); //Add taint from parent
        ...
        public Node removeNamedItemNS(String namespaceURI, String localName) throws DOMException {
            Node varB4EAC82CA7396A68D541C85D26508E83_2092151216 = null; //Variable for return #1
            ...
            addTaint(namespaceURI.getTaint());
            addTaint(localName.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_2092151216.addTaint(getTaint()); //Add taint from parent
        ...
        public Node setNamedItem(Node arg) throws DOMException {
            Node varB4EAC82CA7396A68D541C85D26508E83_1316386622 = null; //Variable for return #1
            {
            ...
            varB4EAC82CA7396A68D541C85D26508E83_1316386622.addTaint(getTaint()); //Add taint from parent
        ...
        public Node setNamedItemNS(Node arg) throws DOMException {
            Node varB4EAC82CA7396A68D541C85D26508E83_1918293484 = null; //Variable for return #1
            {
                if (DroidSafeAndroidRuntime.control) throw new DOMException(DOMException.HIERARCHY_REQUEST_ERR, null);
            } //End block
            varB4EAC82CA7396A68D541C85D26508E83_1918293484 = ElementImpl.this.setAttributeNodeNS((Attr)arg);
            addTaint(arg.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_1918293484.addTaint(getTaint()); //Add taint from parent
