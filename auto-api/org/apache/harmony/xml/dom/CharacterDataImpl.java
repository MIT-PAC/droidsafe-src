...
public abstract class CharacterDataImpl extends LeafNodeImpl implements CharacterData {
    ...
    public String getData() throws DOMException {
        String varB4EAC82CA7396A68D541C85D26508E83_224646380 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_224646380 = buffer.toString();
        varB4EAC82CA7396A68D541C85D26508E83_224646380.addTaint(getTaint()); //Add taint from parent
    ...
    public String getNodeValue() {
        String varB4EAC82CA7396A68D541C85D26508E83_1652041773 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1652041773 = getData();
        varB4EAC82CA7396A68D541C85D26508E83_1652041773.addTaint(getTaint()); //Add taint from parent
    ...
    public String substringData(int offset, int count) throws DOMException {
        String varB4EAC82CA7396A68D541C85D26508E83_153624859 = null; //Variable for return #1
        try 
        {
        ...
        addTaint(offset);
        addTaint(count);
        varB4EAC82CA7396A68D541C85D26508E83_153624859.addTaint(getTaint()); //Add taint from parent
