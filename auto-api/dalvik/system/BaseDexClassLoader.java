...
public class BaseDexClassLoader extends ClassLoader {
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_861103811 = null; 
        ...
        varB4EAC82CA7396A68D541C85D26508E83_861103811.addTaint(getTaint()); 
    ...
    protected URL findResource(String name) {
        URL varB4EAC82CA7396A68D541C85D26508E83_1496337839 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1496337839 = pathList.findResource(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1496337839.addTaint(getTaint()); 
    ...
    protected Enumeration<URL> findResources(String name) {
        Enumeration<URL> varB4EAC82CA7396A68D541C85D26508E83_1537894793 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1537894793 = pathList.findResources(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1537894793.addTaint(getTaint()); 
    ...
    public String findLibrary(String name) {
        String varB4EAC82CA7396A68D541C85D26508E83_2005116220 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_2005116220 = pathList.findLibrary(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_2005116220.addTaint(getTaint()); 
    ...
    protected synchronized Package getPackage(String name) {
        Package varB4EAC82CA7396A68D541C85D26508E83_212945860 = null; 
        Package varB4EAC82CA7396A68D541C85D26508E83_497740698 = null; 
        {
        ...
        addTaint(name.getTaint());
        Package varA7E53CE21691AB073D9660D615818899_2004869537; 
        ...
        varA7E53CE21691AB073D9660D615818899_2004869537.addTaint(getTaint()); 
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_502583462 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_502583462 = getClass().getName() + "[" + originalPath + "]";
        varB4EAC82CA7396A68D541C85D26508E83_502583462.addTaint(getTaint()); 
