...
public class BigInteger extends Number implements Comparable<BigInteger>, Serializable {
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:52.571 -0400", hash_original_method = "7B92331634E6E3BE19D048B912B09B7F", hash_generated_method = "F387D03F096887BED26E9E02FB32EF25")
     BigInt getBigInt() {
        BigInt varB4EAC82CA7396A68D541C85D26508E83_918386367 = null; //Variable for return #1
        BigInt varB4EAC82CA7396A68D541C85D26508E83_955962232 = null; //Variable for return #2
        BigInt varB4EAC82CA7396A68D541C85D26508E83_659584467 = null; //Variable for return #3
        {
        ...
        BigInt varA7E53CE21691AB073D9660D615818899_1009195178; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1009195178.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger abs() {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_897011774 = null; //Variable for return #1
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1309900935 = null; //Variable for return #2
        ...
        BigInteger varA7E53CE21691AB073D9660D615818899_1990908221; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1990908221.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger negate() {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_54709732 = null; //Variable for return #1
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_329899734 = null; //Variable for return #2
        BigInt bigInt = getBigInt();
        int sign = bigInt.sign();
        {
        ...
        BigInteger varA7E53CE21691AB073D9660D615818899_302703883; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_302703883.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger add(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_2021281243 = null; //Variable for return #1
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_987975445 = null; //Variable for return #2
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1082287603 = null; //Variable for return #3
        ...
        addTaint(value.getTaint());
        BigInteger varA7E53CE21691AB073D9660D615818899_1972912891; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1972912891.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger subtract(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_251694600 = null; //Variable for return #1
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1288436762 = null; //Variable for return #2
        BigInt lhs = getBigInt();
        BigInt rhs = value.getBigInt();
        {
        ...
        addTaint(value.getTaint());
        BigInteger varA7E53CE21691AB073D9660D615818899_2038325093; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_2038325093.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger shiftRight(int n) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1585427938 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1585427938 = shiftLeft(-n);
        addTaint(n);
        varB4EAC82CA7396A68D541C85D26508E83_1585427938.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger shiftLeft(int n) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1177387295 = null; //Variable for return #1
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1556152643 = null; //Variable for return #2
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1651207215 = null; //Variable for return #3
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_2087573346 = null; //Variable for return #4
        {
        ...
        addTaint(n);
        BigInteger varA7E53CE21691AB073D9660D615818899_1474178317; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1474178317.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:52.576 -0400", hash_original_method = "3F948826829C47AB028976261F4B8D55", hash_generated_method = "57A08DF084DE62F0B1BF65FCC6BB7651")
     BigInteger shiftLeftOneBit() {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_2144515070 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2144515070 = (signum() == 0) ? this : BitLevel.shiftLeftOneBit(this);
        varB4EAC82CA7396A68D541C85D26508E83_2144515070.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger setBit(int n) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_405379299 = null; //Variable for return #1
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1180814341 = null; //Variable for return #2
        prepareJavaRepresentation();
        {
        ...
        addTaint(n);
        BigInteger varA7E53CE21691AB073D9660D615818899_2119901403; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_2119901403.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger clearBit(int n) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_892530878 = null; //Variable for return #1
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1468214697 = null; //Variable for return #2
        prepareJavaRepresentation();
        {
        ...
        addTaint(n);
        BigInteger varA7E53CE21691AB073D9660D615818899_103407704; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_103407704.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger flipBit(int n) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_721232284 = null; //Variable for return #1
        prepareJavaRepresentation();
        {
            if (DroidSafeAndroidRuntime.control) throw new ArithmeticException("n < 0: " + n);
        } //End block
        ...
        addTaint(n);
        varB4EAC82CA7396A68D541C85D26508E83_721232284.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger not() {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1503730343 = null; //Variable for return #1
        this.prepareJavaRepresentation();
        varB4EAC82CA7396A68D541C85D26508E83_1503730343 = Logical.not(this);
        varB4EAC82CA7396A68D541C85D26508E83_1503730343.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger and(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_578250896 = null; //Variable for return #1
        this.prepareJavaRepresentation();
        value.prepareJavaRepresentation();
        varB4EAC82CA7396A68D541C85D26508E83_578250896 = Logical.and(this, value);
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_578250896.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger or(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_429872573 = null; //Variable for return #1
        this.prepareJavaRepresentation();
        value.prepareJavaRepresentation();
        varB4EAC82CA7396A68D541C85D26508E83_429872573 = Logical.or(this, value);
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_429872573.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger xor(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_660686492 = null; //Variable for return #1
        this.prepareJavaRepresentation();
        value.prepareJavaRepresentation();
        varB4EAC82CA7396A68D541C85D26508E83_660686492 = Logical.xor(this, value);
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_660686492.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger andNot(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_537900358 = null; //Variable for return #1
        this.prepareJavaRepresentation();
        value.prepareJavaRepresentation();
        varB4EAC82CA7396A68D541C85D26508E83_537900358 = Logical.andNot(this, value);
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_537900358.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger min(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_890799292 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_890799292 = this.compareTo(value) == -1 ? this : value;
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_890799292.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger max(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1280010708 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1280010708 = this.compareTo(value) == 1 ? this : value;
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1280010708.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_2091015514 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2091015514 = getBigInt().decString();
        varB4EAC82CA7396A68D541C85D26508E83_2091015514.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString(int radix) {
        String varB4EAC82CA7396A68D541C85D26508E83_2075430653 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1133375007 = null; //Variable for return #2
        {
        ...
        addTaint(radix);
        String varA7E53CE21691AB073D9660D615818899_881503719; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_881503719.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger gcd(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_56525478 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_56525478 = new BigInteger(BigInt.gcd(getBigInt(), value.getBigInt()));
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_56525478.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger multiply(BigInteger value) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1680532942 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1680532942 = new BigInteger(BigInt.product(getBigInt(), value.getBigInt()));
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1680532942.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger pow(int exp) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1939853814 = null; //Variable for return #1
        {
        ...
        addTaint(exp);
        varB4EAC82CA7396A68D541C85D26508E83_1939853814.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger[] divideAndRemainder(BigInteger divisor) {
        BigInteger[] varB4EAC82CA7396A68D541C85D26508E83_342116114 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_342116114.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger divide(BigInteger divisor) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1676714767 = null; //Variable for return #1
        BigInt quotient = new BigInt();
        ...
        addTaint(divisor.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1676714767.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger remainder(BigInteger divisor) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_445720609 = null; //Variable for return #1
        BigInt remainder = new BigInt();
        ...
        addTaint(divisor.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_445720609.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger modInverse(BigInteger m) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1002387296 = null; //Variable for return #1
        {
        ...
        addTaint(m.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1002387296.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger modPow(BigInteger exponent, BigInteger m) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_122819236 = null; //Variable for return #1
        {
        ...
        addTaint(m.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_122819236.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger mod(BigInteger m) {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1404583373 = null; //Variable for return #1
        {
        ...
        addTaint(m.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1404583373.addTaint(getTaint()); //Add taint from parent
    ...
    public BigInteger nextProbablePrime() {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_1504291881 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1504291881.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:52.617 -0400", hash_original_method = "FABC86F56C336DE2152BE8F133BAAD74", hash_generated_method = "074B1D8E91BBE8B4EC394128DDBBB605")
     BigInteger copy() {
        BigInteger varB4EAC82CA7396A68D541C85D26508E83_2048816250 = null; //Variable for return #1
        prepareJavaRepresentation();
        int[] copyDigits = new int[numberLength];
        System.arraycopy(digits, 0, copyDigits, 0, numberLength);
        varB4EAC82CA7396A68D541C85D26508E83_2048816250 = new BigInteger(sign, numberLength, copyDigits);
        varB4EAC82CA7396A68D541C85D26508E83_2048816250.addTaint(getTaint()); //Add taint from parent
