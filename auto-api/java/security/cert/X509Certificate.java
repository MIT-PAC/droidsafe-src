...
public abstract class X509Certificate extends Certificate implements X509Extension {
    ...
    public X500Principal getIssuerX500Principal() {
        X500Principal varB4EAC82CA7396A68D541C85D26508E83_1114481198 = null; //Variable for return #1
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1114481198.addTaint(getTaint()); //Add taint from parent
    ...
    public X500Principal getSubjectX500Principal() {
        X500Principal varB4EAC82CA7396A68D541C85D26508E83_1873626119 = null; //Variable for return #1
        try 
        {
            CertificateFactory factory = CertificateFactory
                    .getInstance("X.509");
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1873626119.addTaint(getTaint()); //Add taint from parent
    ...
    public List<String> getExtendedKeyUsage() throws CertificateParsingException {
        List<String> varB4EAC82CA7396A68D541C85D26508E83_1990278166 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1990278166 = null;
        varB4EAC82CA7396A68D541C85D26508E83_1990278166.addTaint(getTaint()); //Add taint from parent
    ...
    public Collection<List<?>> getSubjectAlternativeNames() throws CertificateParsingException {
        Collection<List<?>> varB4EAC82CA7396A68D541C85D26508E83_214444423 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_214444423 = null;
        varB4EAC82CA7396A68D541C85D26508E83_214444423.addTaint(getTaint()); //Add taint from parent
    ...
    public Collection<List<?>> getIssuerAlternativeNames() throws CertificateParsingException {
        Collection<List<?>> varB4EAC82CA7396A68D541C85D26508E83_1633563173 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1633563173 = null;
        varB4EAC82CA7396A68D541C85D26508E83_1633563173.addTaint(getTaint()); //Add taint from parent
