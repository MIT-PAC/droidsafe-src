...
public abstract class NumberFormat extends Format {
    ...
    @Override
    public Object clone() {
        Object varB4EAC82CA7396A68D541C85D26508E83_720822178 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_720822178 = super.clone();
        varB4EAC82CA7396A68D541C85D26508E83_720822178.addTaint(getTaint()); //Add taint from parent
    ...
    public final String format(double value) {
        String varB4EAC82CA7396A68D541C85D26508E83_2032691399 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2032691399 = format(value, new StringBuffer(), new FieldPosition(0))
                .toString();
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_2032691399.addTaint(getTaint()); //Add taint from parent
    ...
    public final String format(long value) {
        String varB4EAC82CA7396A68D541C85D26508E83_464176772 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_464176772 = format(value, new StringBuffer(), new FieldPosition(0))
                .toString();
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_464176772.addTaint(getTaint()); //Add taint from parent
    ...
    public StringBuffer format(Object object, StringBuffer buffer, FieldPosition field) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_435612994 = null; //Variable for return #1
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_1158300728 = null; //Variable for return #2
        {
            boolean varD611950ED406B9E001DAC51F5B874D45_1610421566 = (object instanceof Byte || object instanceof Short || object instanceof Integer ||
        ...
        StringBuffer varA7E53CE21691AB073D9660D615818899_245570977; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_245570977.addTaint(getTaint()); //Add taint from parent
    ...
    public Number parse(String string) throws ParseException {
        Number varB4EAC82CA7396A68D541C85D26508E83_1189202990 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1189202990.addTaint(getTaint()); //Add taint from parent
    ...
    public final Object parseObject(String string, ParsePosition position) {
        Object varB4EAC82CA7396A68D541C85D26508E83_827239396 = null; //Variable for return #1
        Object varB4EAC82CA7396A68D541C85D26508E83_644890472 = null; //Variable for return #2
        {
        ...
        Object varA7E53CE21691AB073D9660D615818899_807766844; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_807766844.addTaint(getTaint()); //Add taint from parent
