...
public class DecimalFormat extends NumberFormat {
    ...
    @Override
    public Object clone() {
        Object varB4EAC82CA7396A68D541C85D26508E83_1801123470 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1801123470.addTaint(getTaint()); //Add taint from parent
    ...
    public AttributedCharacterIterator formatToCharacterIterator(Object object) {
        AttributedCharacterIterator varB4EAC82CA7396A68D541C85D26508E83_1560685141 = null; //Variable for return #1
        {
            if (DroidSafeAndroidRuntime.control) throw new NullPointerException();
        } //End block
        varB4EAC82CA7396A68D541C85D26508E83_1560685141 = dform.formatToCharacterIterator(object);
        addTaint(object.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1560685141.addTaint(getTaint()); //Add taint from parent
    ...
    public StringBuffer format(double value, StringBuffer buffer, FieldPosition position) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_451518009 = null; //Variable for return #1
        ...
        addTaint(buffer.getTaint());
        addTaint(position.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_451518009.addTaint(getTaint()); //Add taint from parent
    ...
    public StringBuffer format(long value, StringBuffer buffer, FieldPosition position) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_1388662701 = null; //Variable for return #1
        checkBufferAndFieldPosition(buffer, position);
        ...
        addTaint(buffer.getTaint());
        addTaint(position.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1388662701.addTaint(getTaint()); //Add taint from parent
    ...
    public final StringBuffer format(Object number, StringBuffer buffer, FieldPosition position) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_1267097412 = null; //Variable for return #1
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_588892193 = null; //Variable for return #2
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_932297401 = null; //Variable for return #3
        checkBufferAndFieldPosition(buffer, position);
        {
        ...
        addTaint(buffer.getTaint());
        addTaint(position.getTaint());
        StringBuffer varA7E53CE21691AB073D9660D615818899_312184236; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_312184236.addTaint(getTaint()); //Add taint from parent
    ...
    public DecimalFormatSymbols getDecimalFormatSymbols() {
        DecimalFormatSymbols varB4EAC82CA7396A68D541C85D26508E83_643674334 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_643674334 = (DecimalFormatSymbols) symbols.clone();
        varB4EAC82CA7396A68D541C85D26508E83_643674334.addTaint(getTaint()); //Add taint from parent
    ...
    public Currency getCurrency() {
        Currency varB4EAC82CA7396A68D541C85D26508E83_873851226 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_873851226 = symbols.getCurrency();
        varB4EAC82CA7396A68D541C85D26508E83_873851226.addTaint(getTaint()); //Add taint from parent
    ...
    public String getNegativePrefix() {
        String varB4EAC82CA7396A68D541C85D26508E83_545415742 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_545415742 = dform.getNegativePrefix();
        varB4EAC82CA7396A68D541C85D26508E83_545415742.addTaint(getTaint()); //Add taint from parent
    ...
    public String getNegativeSuffix() {
        String varB4EAC82CA7396A68D541C85D26508E83_1709612418 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1709612418 = dform.getNegativeSuffix();
        varB4EAC82CA7396A68D541C85D26508E83_1709612418.addTaint(getTaint()); //Add taint from parent
    ...
    public String getPositivePrefix() {
        String varB4EAC82CA7396A68D541C85D26508E83_6985048 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_6985048 = dform.getPositivePrefix();
        varB4EAC82CA7396A68D541C85D26508E83_6985048.addTaint(getTaint()); //Add taint from parent
    ...
    public String getPositiveSuffix() {
        String varB4EAC82CA7396A68D541C85D26508E83_1990905043 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1990905043 = dform.getPositiveSuffix();
        varB4EAC82CA7396A68D541C85D26508E83_1990905043.addTaint(getTaint()); //Add taint from parent
    ...
    public Number parse(String string, ParsePosition position) {
        Number varB4EAC82CA7396A68D541C85D26508E83_371356668 = null; //Variable for return #1
        Number varB4EAC82CA7396A68D541C85D26508E83_1787673224 = null; //Variable for return #2
        Number varB4EAC82CA7396A68D541C85D26508E83_593348148 = null; //Variable for return #3
        Number varB4EAC82CA7396A68D541C85D26508E83_282493048 = null; //Variable for return #4
        Number varB4EAC82CA7396A68D541C85D26508E83_1451035862 = null; //Variable for return #5
        Number varB4EAC82CA7396A68D541C85D26508E83_1466865830 = null; //Variable for return #6
        Number varB4EAC82CA7396A68D541C85D26508E83_1534936770 = null; //Variable for return #7
        Number varB4EAC82CA7396A68D541C85D26508E83_75526580 = null; //Variable for return #8
        ...
        addTaint(position.getTaint());
        Number varA7E53CE21691AB073D9660D615818899_1473062022; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1473062022.addTaint(getTaint()); //Add taint from parent
    ...
    public String toLocalizedPattern() {
        String varB4EAC82CA7396A68D541C85D26508E83_1512325148 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1512325148 = dform.toLocalizedPattern();
        varB4EAC82CA7396A68D541C85D26508E83_1512325148.addTaint(getTaint()); //Add taint from parent
    ...
    public String toPattern() {
        String varB4EAC82CA7396A68D541C85D26508E83_958508844 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_958508844 = dform.toPattern();
        varB4EAC82CA7396A68D541C85D26508E83_958508844.addTaint(getTaint()); //Add taint from parent
    ...
    public RoundingMode getRoundingMode() {
        RoundingMode varB4EAC82CA7396A68D541C85D26508E83_1164097555 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1164097555 = roundingMode;
        varB4EAC82CA7396A68D541C85D26508E83_1164097555.addTaint(getTaint()); //Add taint from parent
