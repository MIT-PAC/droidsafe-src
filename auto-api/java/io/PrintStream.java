...
public class PrintStream extends FilterOutputStream implements Appendable, Closeable {
    ...
    public PrintStream format(String format, Object... args) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1494813156 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1494813156 = format(Locale.getDefault(), format, args);
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1494813156.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream format(Locale l, String format, Object... args) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1192623659 = null; //Variable for return #1
        {
        ...
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1192623659.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream printf(String format, Object... args) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_166078233 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_166078233 = format(format, args);
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_166078233.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream printf(Locale l, String format, Object... args) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_748464096 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_748464096 = format(l, format, args);
        addTaint(l.getTaint());
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_748464096.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream append(char c) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1681527610 = null; //Variable for return #1
        print(c);
        varB4EAC82CA7396A68D541C85D26508E83_1681527610 = this;
        addTaint(c);
        varB4EAC82CA7396A68D541C85D26508E83_1681527610.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream append(CharSequence charSequence) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_154120699 = null; //Variable for return #1
        {
            print("null");
        } //End block
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_154120699.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream append(CharSequence charSequence, int start, int end) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_349352109 = null; //Variable for return #1
        {
            charSequence = "null";
        } //End block
        ...
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_349352109.addTaint(getTaint()); //Add taint from parent
