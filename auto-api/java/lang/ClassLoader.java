...
public abstract class ClassLoader {
    ...
    protected final Class<?> defineClass(byte[] classRep, int offset, int length) throws ClassFormatError {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_1248081682 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1248081682 = VMClassLoader.defineClass(this, classRep, offset, length);
        addTaint(classRep[0]);
        addTaint(offset);
        addTaint(length);
        varB4EAC82CA7396A68D541C85D26508E83_1248081682.addTaint(getTaint()); 
    ...
    protected final Class<?> defineClass(String className, byte[] classRep, int offset, int length) throws ClassFormatError {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_187566255 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_187566255 = defineClass(className, classRep, offset, length, null);
        addTaint(className.getTaint());
        addTaint(classRep[0]);
        addTaint(offset);
        addTaint(length);
        varB4EAC82CA7396A68D541C85D26508E83_187566255.addTaint(getTaint()); 
    ...
    protected final Class<?> defineClass(String className, byte[] classRep, int offset, int length,
        ...
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_1255487187 = null; 
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1255487187.addTaint(getTaint()); 
    ...
    protected final Class<?> defineClass(String name, ByteBuffer b,
        ...
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_1650371715 = null; 
        ...
        addTaint(b.getTaint());
        addTaint(protectionDomain.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1650371715.addTaint(getTaint()); 
    ...
    protected final Class<?> findLoadedClass(String className) {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_144047643 = null; 
        ClassLoader loader;
        {
        ...
        addTaint(className.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_144047643.addTaint(getTaint()); 
    ...
    protected final Class<?> findSystemClass(String className) throws ClassNotFoundException {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_872182102 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_872182102 = Class.forName(className, false, getSystemClassLoader());
        addTaint(className.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_872182102.addTaint(getTaint()); 
    ...
    public final ClassLoader getParent() {
        ClassLoader varB4EAC82CA7396A68D541C85D26508E83_725330082 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_725330082 = parent;
        varB4EAC82CA7396A68D541C85D26508E83_725330082.addTaint(getTaint()); 
    ...
    public URL getResource(String resName) {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_798311009.addTaint(getTaint()); 
    ...
    public Enumeration<URL> getResources(String resName) throws IOException {
        Enumeration<URL> varB4EAC82CA7396A68D541C85D26508E83_1504416040 = null; 
        ...
        addTaint(resName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1504416040.addTaint(getTaint()); 
    ...
    public InputStream getResourceAsStream(String resName) {
        InputStream varB4EAC82CA7396A68D541C85D26508E83_1210959697 = null; 
        InputStream varB4EAC82CA7396A68D541C85D26508E83_1283680074 = null; 
        try 
        {
        ...
        addTaint(resName.getTaint());
        InputStream varA7E53CE21691AB073D9660D615818899_1278526613; 
        ...
        varA7E53CE21691AB073D9660D615818899_1278526613.addTaint(getTaint()); 
    ...
    public Class<?> loadClass(String className) throws ClassNotFoundException {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_395536635 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_395536635 = loadClass(className, false);
        addTaint(className.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_395536635.addTaint(getTaint()); 
    ...
    protected Class<?> loadClass(String className, boolean resolve) throws ClassNotFoundException {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_1662102694 = null; 
        ...
        addTaint(className.getTaint());
        addTaint(resolve);
        varB4EAC82CA7396A68D541C85D26508E83_1662102694.addTaint(getTaint()); 
    ...
    protected URL findResource(String resName) {
        ...
        addTaint(resName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_2073059668.addTaint(getTaint()); 
    ...
    protected Enumeration<URL> findResources(String resName) throws IOException {
        Enumeration<URL> varB4EAC82CA7396A68D541C85D26508E83_1492568823 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1492568823 = Collections.emptyEnumeration();
        addTaint(resName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1492568823.addTaint(getTaint()); 
    ...
    protected String findLibrary(String libName) {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1195000074.addTaint(getTaint()); 
    ...
    protected Package getPackage(String name) {
        Package varB4EAC82CA7396A68D541C85D26508E83_548599380 = null; 
        {
            varB4EAC82CA7396A68D541C85D26508E83_548599380 = packages.get(name);
        } 
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_548599380.addTaint(getTaint()); 
    ...
    protected Package[] getPackages() {
        Package[] varB4EAC82CA7396A68D541C85D26508E83_681956449 = null; 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_681956449.addTaint(getTaint()); 
    ...
    protected Package definePackage(String name, String specTitle, String specVersion,
        ...
        Package varB4EAC82CA7396A68D541C85D26508E83_3835966 = null; 
        {
            {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_3835966.addTaint(getTaint()); 
...
class TwoEnumerationsInOne implements Enumeration<URL> {
    ...
    public URL nextElement() {
        ...
        URL varB4EAC82CA7396A68D541C85D26508E83_1223767587 = null; 
        {
        ...
        URL varA7E53CE21691AB073D9660D615818899_1565557526; 
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: 
        ...
        varA7E53CE21691AB073D9660D615818899_1565557526.addTaint(getTaint()); 
...
class BootClassLoader extends ClassLoader {
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_759463392 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_759463392 = VMClassLoader.loadClass(name, false);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_759463392.addTaint(getTaint()); 
    ...
    protected URL findResource(String name) {
        URL varB4EAC82CA7396A68D541C85D26508E83_1749072810 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1749072810 = VMClassLoader.getResource(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1749072810.addTaint(getTaint()); 
    ...
    @Override
    protected Enumeration<URL> findResources(String resName) throws IOException {
        Enumeration<URL> varB4EAC82CA7396A68D541C85D26508E83_377977324 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_377977324 = Collections.enumeration(VMClassLoader.getResources(resName));
        addTaint(resName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_377977324.addTaint(getTaint()); 
    ...
    @Override
    protected Package getPackage(String name) {
        Package varB4EAC82CA7396A68D541C85D26508E83_678302820 = null; 
        Package varB4EAC82CA7396A68D541C85D26508E83_1766063750 = null; 
        {
        ...
        addTaint(name.getTaint());
        Package varA7E53CE21691AB073D9660D615818899_207539044; 
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: 
        ...
        varA7E53CE21691AB073D9660D615818899_207539044.addTaint(getTaint()); 
    ...
    @Override
    public URL getResource(String resName) {
        URL varB4EAC82CA7396A68D541C85D26508E83_732701095 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_732701095 = findResource(resName);
        addTaint(resName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_732701095.addTaint(getTaint()); 
    ...
    @Override
    protected Class<?> loadClass(String className, boolean resolve) throws ClassNotFoundException {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_58448169 = null; 
        Class<?> clazz = findLoadedClass(className);
        {
            clazz = findClass(className);
        } 
        ...
        addTaint(className.getTaint());
        addTaint(resolve);
        varB4EAC82CA7396A68D541C85D26508E83_58448169.addTaint(getTaint()); 
    ...
    @Override
    public Enumeration<URL> getResources(String resName) throws IOException {
        Enumeration<URL> varB4EAC82CA7396A68D541C85D26508E83_815792438 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_815792438 = findResources(resName);
        addTaint(resName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_815792438.addTaint(getTaint()); 
