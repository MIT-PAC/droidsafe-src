...
public final class Method extends AccessibleObject implements GenericDeclaration, Member {
    ...
    public TypeVariable<Method>[] getTypeParameters() {
        TypeVariable<Method>[] varB4EAC82CA7396A68D541C85D26508E83_549101395 = null; //Variable for return #1
        initGenericTypes();
        varB4EAC82CA7396A68D541C85D26508E83_549101395 = formalTypeParameters.clone();
        varB4EAC82CA7396A68D541C85D26508E83_549101395.addTaint(getTaint()); //Add taint from parent
    ...
    @Override
     String getSignatureAttribute() {
        String varB4EAC82CA7396A68D541C85D26508E83_1772093031 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1938011327 = null; //Variable for return #2
        ...
        String varA7E53CE21691AB073D9660D615818899_599099937; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_599099937.addTaint(getTaint()); //Add taint from parent
    ...
    public String toGenericString() {
        String varB4EAC82CA7396A68D541C85D26508E83_451575740 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_451575740.addTaint(getTaint()); //Add taint from parent
    ...
    public Type[] getGenericParameterTypes() {
        Type[] varB4EAC82CA7396A68D541C85D26508E83_261556399 = null; //Variable for return #1
        initGenericTypes();
        varB4EAC82CA7396A68D541C85D26508E83_261556399 = Types.getClonedTypeArray(genericParameterTypes);
        varB4EAC82CA7396A68D541C85D26508E83_261556399.addTaint(getTaint()); //Add taint from parent
    ...
    public Type[] getGenericExceptionTypes() {
        Type[] varB4EAC82CA7396A68D541C85D26508E83_1772261561 = null; //Variable for return #1
        initGenericTypes();
        varB4EAC82CA7396A68D541C85D26508E83_1772261561 = Types.getClonedTypeArray(genericExceptionTypes);
        varB4EAC82CA7396A68D541C85D26508E83_1772261561.addTaint(getTaint()); //Add taint from parent
    ...
    public Type getGenericReturnType() {
        Type varB4EAC82CA7396A68D541C85D26508E83_717249025 = null; //Variable for return #1
        initGenericTypes();
        varB4EAC82CA7396A68D541C85D26508E83_717249025 = Types.getType(genericReturnType);
        varB4EAC82CA7396A68D541C85D26508E83_717249025.addTaint(getTaint()); //Add taint from parent
    ...
    public Annotation[] getDeclaredAnnotations() {
        Annotation[] varB4EAC82CA7396A68D541C85D26508E83_1362196696 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1362196696 = getDeclaredAnnotations(declaringClass, slot);
        varB4EAC82CA7396A68D541C85D26508E83_1362196696.addTaint(getTaint()); //Add taint from parent
    ...
    public <A extends Annotation> A getAnnotation(Class<A> annotationType) {
        A varB4EAC82CA7396A68D541C85D26508E83_1767034432 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1767034432.addTaint(getTaint()); //Add taint from parent
    ...
    public Annotation[][] getParameterAnnotations() {
        Annotation[][] varB4EAC82CA7396A68D541C85D26508E83_624722259 = null; //Variable for return #1
        Annotation[][] varB4EAC82CA7396A68D541C85D26508E83_340551905 = null; //Variable for return #2
        ...
        Annotation[][] varA7E53CE21691AB073D9660D615818899_2132837393; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_2132837393.addTaint(getTaint()); //Add taint from parent
    ...
    public Object getDefaultValue() {
        Object varB4EAC82CA7396A68D541C85D26508E83_1406205822 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1406205822 = getDefaultValue(declaringClass, slot);
        varB4EAC82CA7396A68D541C85D26508E83_1406205822.addTaint(getTaint()); //Add taint from parent
    ...
    public Class<?> getDeclaringClass() {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_2053017153 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2053017153 = declaringClass;
        varB4EAC82CA7396A68D541C85D26508E83_2053017153.addTaint(getTaint()); //Add taint from parent
    ...
    public Class<?>[] getExceptionTypes() {
        Class<?>[] varB4EAC82CA7396A68D541C85D26508E83_171480031 = null; //Variable for return #1
        Class<?>[] varB4EAC82CA7396A68D541C85D26508E83_843607598 = null; //Variable for return #2
        {
        ...
        Class<?>[] varA7E53CE21691AB073D9660D615818899_1585097035; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1585097035.addTaint(getTaint()); //Add taint from parent
    ...
    public String getName() {
        String varB4EAC82CA7396A68D541C85D26508E83_802056819 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_802056819 = name;
        varB4EAC82CA7396A68D541C85D26508E83_802056819.addTaint(getTaint()); //Add taint from parent
    ...
    public Class<?>[] getParameterTypes() {
        Class<?>[] varB4EAC82CA7396A68D541C85D26508E83_798143344 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_798143344 = parameterTypes.clone();
        varB4EAC82CA7396A68D541C85D26508E83_798143344.addTaint(getTaint()); //Add taint from parent
    ...
    public Class<?> getReturnType() {
        Class<?> varB4EAC82CA7396A68D541C85D26508E83_1635565424 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1635565424 = returnType;
        varB4EAC82CA7396A68D541C85D26508E83_1635565424.addTaint(getTaint()); //Add taint from parent
    ...
    public Object invoke(Object receiver, Object... args) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Object varB4EAC82CA7396A68D541C85D26508E83_1916148612 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1916148612.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_949582351 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_949582351.addTaint(getTaint()); //Add taint from parent
    ...
    private String getSignature() {
        String varB4EAC82CA7396A68D541C85D26508E83_1072164620 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1072164620.addTaint(getTaint()); //Add taint from parent
