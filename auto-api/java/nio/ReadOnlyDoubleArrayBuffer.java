...
final class ReadOnlyDoubleArrayBuffer extends DoubleArrayBuffer {
	...
	public DoubleBuffer asReadOnlyBuffer() {
		DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_1308490956 = null; // Variable
																			// for
																			// return
																			// #1
		varB4EAC82CA7396A68D541C85D26508E83_1308490956 = duplicate();
		varB4EAC82CA7396A68D541C85D26508E83_1308490956.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public DoubleBuffer duplicate() {
		DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_2042601018 = null; // Variable
																			// for
																			// return
																			// #1
		varB4EAC82CA7396A68D541C85D26508E83_2042601018 = copy(this, mark);
		varB4EAC82CA7396A68D541C85D26508E83_2042601018.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public DoubleBuffer slice() {
		DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_776676669 = null; // Variable
																			// for
																			// return
																			// #1
		varB4EAC82CA7396A68D541C85D26508E83_776676669 = new ReadOnlyDoubleArrayBuffer(remaining(), backingArray, offset + position);
		varB4EAC82CA7396A68D541C85D26508E83_776676669.addTaint(getTaint()); // Add
																			// taint
																			// from
																			// parent
		return varB4EAC82CA7396A68D541C85D26508E83_776676669;
		// ---------- Original Method ----------
		// return new ReadOnlyDoubleArrayBuffer(remaining(), backingArray,
		// offset + position);
	}
