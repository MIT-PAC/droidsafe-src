...
public abstract class DoubleBuffer extends Buffer implements Comparable<DoubleBuffer> {
    ...
    public DoubleBuffer get(double[] dst) {
        DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_1966504157 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1966504157 = get(dst, 0, dst.length);
        addTaint(dst[0]);
        varB4EAC82CA7396A68D541C85D26508E83_1966504157.addTaint(getTaint()); //Add taint from parent
    ...
    public DoubleBuffer get(double[] dst, int dstOffset, int doubleCount) {
        DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_379009786 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_379009786.addTaint(getTaint()); //Add taint from parent
    ...
    public final DoubleBuffer put(double[] src) {
        DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_852036613 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_852036613 = put(src, 0, src.length);
        addTaint(src[0]);
        varB4EAC82CA7396A68D541C85D26508E83_852036613.addTaint(getTaint()); //Add taint from parent
    ...
    public DoubleBuffer put(double[] src, int srcOffset, int doubleCount) {
        DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_551712169 = null; //Variable for return #1
        ...
        addTaint(srcOffset);
        addTaint(doubleCount);
        varB4EAC82CA7396A68D541C85D26508E83_551712169.addTaint(getTaint()); //Add taint from parent
    ...
    public DoubleBuffer put(DoubleBuffer src) {
        DoubleBuffer varB4EAC82CA7396A68D541C85D26508E83_17156690 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_17156690.addTaint(getTaint()); //Add taint from parent
