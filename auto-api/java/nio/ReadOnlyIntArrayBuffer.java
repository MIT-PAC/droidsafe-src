...
final class ReadOnlyIntArrayBuffer extends IntArrayBuffer {
    ...
    public IntBuffer asReadOnlyBuffer() {
        IntBuffer varB4EAC82CA7396A68D541C85D26508E83_343076514 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_343076514 = duplicate();
        varB4EAC82CA7396A68D541C85D26508E83_343076514.addTaint(getTaint()); //Add taint from parent
...
throw new ReadOnlyBufferException();
    ...
    public IntBuffer duplicate() {
        IntBuffer varB4EAC82CA7396A68D541C85D26508E83_1089930379 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1089930379 = copy(this, mark);
        varB4EAC82CA7396A68D541C85D26508E83_1089930379.addTaint(getTaint()); //Add taint from parent
    ...
    public IntBuffer slice() {
        IntBuffer varB4EAC82CA7396A68D541C85D26508E83_1399962507 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1399962507 = new ReadOnlyIntArrayBuffer(remaining(), backingArray, offset + position);
        varB4EAC82CA7396A68D541C85D26508E83_1399962507.addTaint(getTaint()); //Add taint from parent
