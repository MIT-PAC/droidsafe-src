...
final class ReadWriteHeapByteBuffer extends HeapByteBuffer {
    ...
    public ByteBuffer asReadOnlyBuffer() {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_889353121 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_889353121 = ReadOnlyHeapByteBuffer.copy(this, mark);
        varB4EAC82CA7396A68D541C85D26508E83_889353121.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer compact() {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1420905707 = null; //Variable for return #1
        System.arraycopy(backingArray, position + offset, backingArray, offset, remaining());
        position = limit - position;
        limit = capacity;
        mark = UNSET_MARK;
        varB4EAC82CA7396A68D541C85D26508E83_1420905707 = this;
        varB4EAC82CA7396A68D541C85D26508E83_1420905707.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer duplicate() {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1578222886 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1578222886 = copy(this, mark);
        varB4EAC82CA7396A68D541C85D26508E83_1578222886.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer put(byte b) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_979978187 = null; //Variable for return #1
        {
        ...
        addTaint(b);
        varB4EAC82CA7396A68D541C85D26508E83_979978187.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer put(int index, byte b) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1299446602 = null; //Variable for return #1
        checkIndex(index);
        backingArray[offset + index] = b;
        varB4EAC82CA7396A68D541C85D26508E83_1299446602 = this;
        addTaint(index);
        addTaint(b);
        varB4EAC82CA7396A68D541C85D26508E83_1299446602.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer put(byte[] src, int srcOffset, int byteCount) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_58703567 = null; //Variable for return #1
        ...
        addTaint(srcOffset);
        addTaint(byteCount);
        varB4EAC82CA7396A68D541C85D26508E83_58703567.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putChar(int index, char value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_232913264 = null; //Variable for return #1
        checkIndex(index, SizeOf.CHAR);
        Memory.pokeShort(backingArray, offset + index, (short) value, order);
        varB4EAC82CA7396A68D541C85D26508E83_232913264 = this;
        addTaint(index);
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_232913264.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putChar(char value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1043474065 = null; //Variable for return #1
        ...
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1043474065.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putDouble(double value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_2009353658 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2009353658 = putLong(Double.doubleToRawLongBits(value));
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_2009353658.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putDouble(int index, double value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_108755120 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_108755120 = putLong(index, Double.doubleToRawLongBits(value));
        addTaint(index);
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_108755120.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putFloat(float value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1333160828 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1333160828 = putInt(Float.floatToRawIntBits(value));
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1333160828.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putFloat(int index, float value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1082652918 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1082652918 = putInt(index, Float.floatToRawIntBits(value));
        addTaint(index);
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1082652918.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putInt(int value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_431757365 = null; //Variable for return #1
        ...
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_431757365.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putInt(int index, int value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1440756846 = null; //Variable for return #1
        checkIndex(index, SizeOf.INT);
        Memory.pokeInt(backingArray, offset + index, value, order);
        varB4EAC82CA7396A68D541C85D26508E83_1440756846 = this;
        addTaint(index);
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1440756846.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putLong(int index, long value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_945822572 = null; //Variable for return #1
        checkIndex(index, SizeOf.LONG);
        Memory.pokeLong(backingArray, offset + index, value, order);
        varB4EAC82CA7396A68D541C85D26508E83_945822572 = this;
        addTaint(index);
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_945822572.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putLong(long value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1953539255 = null; //Variable for return #1
        ...
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1953539255.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putShort(int index, short value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1989101987 = null; //Variable for return #1
        checkIndex(index, SizeOf.SHORT);
        Memory.pokeShort(backingArray, offset + index, value, order);
        varB4EAC82CA7396A68D541C85D26508E83_1989101987 = this;
        addTaint(index);
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_1989101987.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer putShort(short value) {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_2012744788 = null; //Variable for return #1
        ...
        addTaint(value);
        varB4EAC82CA7396A68D541C85D26508E83_2012744788.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteBuffer slice() {
        ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_634413006 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_634413006 = new ReadWriteHeapByteBuffer(backingArray, remaining(), offset + position);
        varB4EAC82CA7396A68D541C85D26508E83_634413006.addTaint(getTaint()); //Add taint from parent
