...
final class ReadOnlyHeapByteBuffer extends HeapByteBuffer {
	...
	public ByteBuffer asReadOnlyBuffer() {
		ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1732601702 = null; // Variable
																			// for
																			// return
																			// #1
		varB4EAC82CA7396A68D541C85D26508E83_1732601702 = ReadOnlyHeapByteBuffer.copy(this, mark);
		varB4EAC82CA7396A68D541C85D26508E83_1732601702.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public ByteBuffer duplicate() {
		ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1385143944 = null; // Variable
																			// for
																			// return
																			// #1
		varB4EAC82CA7396A68D541C85D26508E83_1385143944 = copy(this, mark);
		varB4EAC82CA7396A68D541C85D26508E83_1385143944.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public ByteBuffer slice() {
		ByteBuffer varB4EAC82CA7396A68D541C85D26508E83_1185840022 = null; // Variable
																			// for
																			// return
																			// #1
		varB4EAC82CA7396A68D541C85D26508E83_1185840022 = new ReadOnlyHeapByteBuffer(backingArray, remaining(), offset + position);
		varB4EAC82CA7396A68D541C85D26508E83_1185840022.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
		return varB4EAC82CA7396A68D541C85D26508E83_1185840022;
		// ---------- Original Method ----------
		// return new ReadOnlyHeapByteBuffer(backingArray, remaining(), offset +
		// position);
	}
