...
final class LongToByteBufferAdapter extends LongBuffer {
    ...
    public LongBuffer asReadOnlyBuffer() {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_1785820101 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1785820101.addTaint(getTaint()); //Add taint from parent
    ...
    public LongBuffer compact() {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_282645268 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_282645268.addTaint(getTaint()); //Add taint from parent
    ...
    public LongBuffer duplicate() {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_1173903963 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1173903963.addTaint(getTaint()); //Add taint from parent
    ...
    public LongBuffer get(long[] dst, int dstOffset, int longCount) {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_1642956176 = null; //Variable for return #1
        byteBuffer.limit(limit * SizeOf.LONG);
        byteBuffer.position(position * SizeOf.LONG);
        {
        ...
        addTaint(dstOffset);
        addTaint(longCount);
        varB4EAC82CA7396A68D541C85D26508E83_1642956176.addTaint(getTaint()); //Add taint from parent
    ...
    public ByteOrder order() {
        ByteOrder varB4EAC82CA7396A68D541C85D26508E83_10421995 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_10421995 = byteBuffer.order();
        varB4EAC82CA7396A68D541C85D26508E83_10421995.addTaint(getTaint()); //Add taint from parent
    ...
    public LongBuffer put(long c) {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_1705933812 = null; //Variable for return #1
        {
        ...
        addTaint(c);
        varB4EAC82CA7396A68D541C85D26508E83_1705933812.addTaint(getTaint()); //Add taint from parent
    ...
    public LongBuffer put(int index, long c) {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_1593487150 = null; //Variable for return #1
        checkIndex(index);
        byteBuffer.putLong(index * SizeOf.LONG, c);
        varB4EAC82CA7396A68D541C85D26508E83_1593487150 = this;
        addTaint(index);
        addTaint(c);
        varB4EAC82CA7396A68D541C85D26508E83_1593487150.addTaint(getTaint()); //Add taint from parent
    ...
    public LongBuffer put(long[] src, int srcOffset, int longCount) {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_2109063013 = null; //Variable for return #1
        byteBuffer.limit(limit * SizeOf.LONG);
        byteBuffer.position(position * SizeOf.LONG);
        {
        ...
        addTaint(srcOffset);
        addTaint(longCount);
        varB4EAC82CA7396A68D541C85D26508E83_2109063013.addTaint(getTaint()); //Add taint from parent
    ...
    public LongBuffer slice() {
        LongBuffer varB4EAC82CA7396A68D541C85D26508E83_423994466 = null; //Variable for return #1
        byteBuffer.limit(limit * SizeOf.LONG);
        byteBuffer.position(position * SizeOf.LONG);
        ...
        varB4EAC82CA7396A68D541C85D26508E83_423994466.addTaint(getTaint()); //Add taint from parent
