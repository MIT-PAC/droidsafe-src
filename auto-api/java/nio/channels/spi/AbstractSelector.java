...
public abstract class AbstractSelector extends Selector {
    ...
    public final SelectorProvider provider() {
        SelectorProvider varB4EAC82CA7396A68D541C85D26508E83_1672534307 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1672534307 = provider;
        varB4EAC82CA7396A68D541C85D26508E83_1672534307.addTaint(getTaint()); //Add taint from parent
    ...
    protected final Set<SelectionKey> cancelledKeys() {
        Set<SelectionKey> varB4EAC82CA7396A68D541C85D26508E83_1712605694 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1712605694 = cancelledKeysSet;
        varB4EAC82CA7396A68D541C85D26508E83_1712605694.addTaint(getTaint()); //Add taint from parent
