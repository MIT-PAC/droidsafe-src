...
public abstract class SocketImpl implements SocketOptions {
    ...
    protected FileDescriptor getFileDescriptor() {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_439082300 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_439082300 = fd;
        varB4EAC82CA7396A68D541C85D26508E83_439082300.addTaint(getTaint()); //Add taint from parent
    ...
    public FileDescriptor getFD$() {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1363805273 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1363805273 = fd;
        varB4EAC82CA7396A68D541C85D26508E83_1363805273.addTaint(getTaint()); //Add taint from parent
    ...
    protected InetAddress getInetAddress() {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_133983584 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_133983584 = address;
        varB4EAC82CA7396A68D541C85D26508E83_133983584.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_578536524 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_578536524 = "Socket[address=" + getInetAddress() +
                ",port=" + port + ",localPort=" + getLocalPort() + "]";
        varB4EAC82CA7396A68D541C85D26508E83_578536524.addTaint(getTaint()); //Add taint from parent
