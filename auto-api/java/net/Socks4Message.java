...
class Socks4Message {
    ...
    public String getUserId() {
        String varB4EAC82CA7396A68D541C85D26508E83_361905324 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_361905324 = getString(INDEX_USER_ID, MAX_USER_ID_LENGTH);
        varB4EAC82CA7396A68D541C85D26508E83_361905324.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_1887864149 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1887864149.addTaint(getTaint()); //Add taint from parent
    ...
    public String getErrorString(int error) {
        String varB4EAC82CA7396A68D541C85D26508E83_429555057 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_726408867 = null; //Variable for return #2
        String varB4EAC82CA7396A68D541C85D26508E83_903262171 = null; //Variable for return #3
        String varB4EAC82CA7396A68D541C85D26508E83_1135611890 = null; //Variable for return #4
        ...
        //End case default 
        addTaint(error);
        String varA7E53CE21691AB073D9660D615818899_1142884234; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1142884234.addTaint(getTaint()); //Add taint from parent
    ...
    private String getString(int offset, int maxLength) {
        String varB4EAC82CA7396A68D541C85D26508E83_1164889078 = null; //Variable for return #1
        int index = offset;
        ...
        addTaint(offset);
        addTaint(maxLength);
        varB4EAC82CA7396A68D541C85D26508E83_1164889078.addTaint(getTaint()); //Add taint from parent
