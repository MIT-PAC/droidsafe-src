...
public abstract class JarURLConnection extends URLConnection {
    ...
    public Attributes getAttributes() throws java.io.IOException {
        Attributes varB4EAC82CA7396A68D541C85D26508E83_775459833 = null; 
        JarEntry jEntry = getJarEntry();
        varB4EAC82CA7396A68D541C85D26508E83_775459833 = (jEntry == null) ? null : jEntry.getAttributes();
        varB4EAC82CA7396A68D541C85D26508E83_775459833.addTaint(getTaint()); 
    ...
    public Certificate[] getCertificates() throws java.io.IOException {
        Certificate[] varB4EAC82CA7396A68D541C85D26508E83_1484791562 = null; 
        Certificate[] varB4EAC82CA7396A68D541C85D26508E83_1922604747 = null; 
        JarEntry jEntry = getJarEntry();
        {
            varB4EAC82CA7396A68D541C85D26508E83_1484791562 = null;
        } 
        varB4EAC82CA7396A68D541C85D26508E83_1922604747 = jEntry.getCertificates();
        Certificate[] varA7E53CE21691AB073D9660D615818899_1879786462; 
        ...
        varA7E53CE21691AB073D9660D615818899_1879786462.addTaint(getTaint()); 
    ...
    public String getEntryName() {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_2077694413.addTaint(getTaint()); 
    ...
    public JarEntry getJarEntry() throws IOException {
        JarEntry varB4EAC82CA7396A68D541C85D26508E83_832786048 = null; 
        JarEntry varB4EAC82CA7396A68D541C85D26508E83_618665340 = null; 
        {
            connect();
        } 
        {
        ...
        JarEntry varA7E53CE21691AB073D9660D615818899_2091725383; 
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: 
        ...
        varA7E53CE21691AB073D9660D615818899_2091725383.addTaint(getTaint()); 
    ...
    public Manifest getManifest() throws java.io.IOException {
        Manifest varB4EAC82CA7396A68D541C85D26508E83_1360655921 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1360655921 = (Manifest)getJarFile().getManifest().clone();
        varB4EAC82CA7396A68D541C85D26508E83_1360655921.addTaint(getTaint()); 
    ...
    public URL getJarFileURL() {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_2122332115.addTaint(getTaint()); 
    ...
    public Attributes getMainAttributes() throws java.io.IOException {
        Attributes varB4EAC82CA7396A68D541C85D26508E83_1175848621 = null; 
        Manifest m = getJarFile().getManifest();
        varB4EAC82CA7396A68D541C85D26508E83_1175848621 = (m == null) ? null : m.getMainAttributes();
        varB4EAC82CA7396A68D541C85D26508E83_1175848621.addTaint(getTaint()); 
