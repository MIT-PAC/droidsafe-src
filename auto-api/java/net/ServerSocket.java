...
public class ServerSocket {
    ...
    public SocketImpl getImpl$() {
        SocketImpl varB4EAC82CA7396A68D541C85D26508E83_1316014577 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1316014577 = impl;
        varB4EAC82CA7396A68D541C85D26508E83_1316014577.addTaint(getTaint()); //Add taint from parent
    ...
    public Socket accept() throws IOException {
        Socket varB4EAC82CA7396A68D541C85D26508E83_720255953 = null; //Variable for return #1
        checkOpen();
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_720255953.addTaint(getTaint()); //Add taint from parent
    ...
    public InetAddress getInetAddress() {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_933834625 = null; //Variable for return #1
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_1145173221 = null; //Variable for return #2
        {
        ...
        InetAddress varA7E53CE21691AB073D9660D615818899_1242853975; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1242853975.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_1134311169 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_172057747 = null; //Variable for return #2
        ...
        varB4EAC82CA7396A68D541C85D26508E83_172057747 = result.append("addr=")
                ...
                .toString();
        String varA7E53CE21691AB073D9660D615818899_2047910392; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_2047910392.addTaint(getTaint()); //Add taint from parent
    ...
    public SocketAddress getLocalSocketAddress() {
        SocketAddress varB4EAC82CA7396A68D541C85D26508E83_441093208 = null; //Variable for return #1
        SocketAddress varB4EAC82CA7396A68D541C85D26508E83_14257958 = null; //Variable for return #2
        {
        ...
        SocketAddress varA7E53CE21691AB073D9660D615818899_1002364545; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1002364545.addTaint(getTaint()); //Add taint from parent
    ...
    public ServerSocketChannel getChannel() {
        ServerSocketChannel varB4EAC82CA7396A68D541C85D26508E83_1619111911 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1619111911 = null;
        varB4EAC82CA7396A68D541C85D26508E83_1619111911.addTaint(getTaint()); //Add taint from parent
