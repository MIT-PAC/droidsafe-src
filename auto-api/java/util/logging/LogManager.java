...
public class LogManager {
    ...
    public synchronized Logger getLogger(String name) {
        Logger varB4EAC82CA7396A68D541C85D26508E83_721887279 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_721887279 = loggers.get(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_721887279.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized Enumeration<String> getLoggerNames() {
        Enumeration<String> varB4EAC82CA7396A68D541C85D26508E83_1732811004 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1732811004 = loggers.keys();
        varB4EAC82CA7396A68D541C85D26508E83_1732811004.addTaint(getTaint()); //Add taint from parent
    ...
    public String getProperty(String name) {
        String varB4EAC82CA7396A68D541C85D26508E83_1702189657 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1702189657 = props.getProperty(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1702189657.addTaint(getTaint()); //Add taint from parent
    ...
    synchronized Logger getOrCreate(String name, String resourceBundleName) {
        Logger varB4EAC82CA7396A68D541C85D26508E83_1317350450 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1317350450.addTaint(getTaint()); //Add taint from parent
