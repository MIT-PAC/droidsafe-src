...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    ...
    @Override
    public Object clone() {
        Object varB4EAC82CA7396A68D541C85D26508E83_505575554 = null; //Variable for return #1
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_505575554.addTaint(getTaint()); //Add taint from parent
    ...
    public final Date getTime() {
        Date varB4EAC82CA7396A68D541C85D26508E83_231358171 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_231358171 = new Date(getTimeInMillis());
        varB4EAC82CA7396A68D541C85D26508E83_231358171.addTaint(getTaint()); //Add taint from parent
    ...
    public TimeZone getTimeZone() {
        TimeZone varB4EAC82CA7396A68D541C85D26508E83_1727161588 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1727161588 = zone;
        varB4EAC82CA7396A68D541C85D26508E83_1727161588.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_214362291 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_214362291.addTaint(getTaint()); //Add taint from parent
    ...
    public String getDisplayName(int field, int style, Locale locale) {
        String varB4EAC82CA7396A68D541C85D26508E83_478712163 = null; //Variable for return #1
        {
            style = SHORT;
        } //End block
        ...
        addTaint(style);
        addTaint(locale.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_478712163.addTaint(getTaint()); //Add taint from parent
    ...
    private String[] getDisplayNameArray(int field, int style, Locale locale) {
        String[] varB4EAC82CA7396A68D541C85D26508E83_262724521 = null; //Variable for return #1
        String[] varB4EAC82CA7396A68D541C85D26508E83_1308363752 = null; //Variable for return #2
        String[] varB4EAC82CA7396A68D541C85D26508E83_1699896899 = null; //Variable for return #3
        String[] varB4EAC82CA7396A68D541C85D26508E83_139046761 = null; //Variable for return #4
        String[] varB4EAC82CA7396A68D541C85D26508E83_2106997147 = null; //Variable for return #5
        {
        ...
        addTaint(style);
        addTaint(locale.getTaint());
        String[] varA7E53CE21691AB073D9660D615818899_296623462; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_296623462.addTaint(getTaint()); //Add taint from parent
    ...
    public Map<String, Integer> getDisplayNames(int field, int style, Locale locale) {
        Map<String, Integer> varB4EAC82CA7396A68D541C85D26508E83_350803403 = null; //Variable for return #1
        checkStyle(style);
        complete();
        ...
        addTaint(style);
        addTaint(locale.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_350803403.addTaint(getTaint()); //Add taint from parent
