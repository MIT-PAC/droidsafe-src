...
public class IdentityHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Serializable, Cloneable {
    ...
    private Object[] newElementArray(int s) {
        Object[] varB4EAC82CA7396A68D541C85D26508E83_661521152 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_661521152 = new Object[s];
        addTaint(s);
        varB4EAC82CA7396A68D541C85D26508E83_661521152.addTaint(getTaint()); //Add taint from parent
    ...
    private V massageValue(Object value) {
        V varB4EAC82CA7396A68D541C85D26508E83_934622021 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_934622021 = (V) ((value == NULL_OBJECT) ? null : value);
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_934622021.addTaint(getTaint()); //Add taint from parent
    ...
    public V get(Object key) {
        V varB4EAC82CA7396A68D541C85D26508E83_585228903 = null; //Variable for return #1
        V varB4EAC82CA7396A68D541C85D26508E83_289004928 = null; //Variable for return #2
        {
            key = NULL_OBJECT;
        } //End block
        int index = findIndex(key, elementData);
        ...
        addTaint(key.getTaint());
        V varA7E53CE21691AB073D9660D615818899_1367047269; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1367047269.addTaint(getTaint()); //Add taint from parent
    ...
    private IdentityHashMapEntry<K, V> getEntry(Object key) {
        IdentityHashMapEntry<K, V> varB4EAC82CA7396A68D541C85D26508E83_1824060608 = null; //Variable for return #1
        IdentityHashMapEntry<K, V> varB4EAC82CA7396A68D541C85D26508E83_1473428508 = null; //Variable for return #2
        {
            key = NULL_OBJECT;
        } //End block
        int index = findIndex(key, elementData);
        ...
        addTaint(key.getTaint());
        IdentityHashMapEntry<K, V> varA7E53CE21691AB073D9660D615818899_1167081802; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1167081802.addTaint(getTaint()); //Add taint from parent
    ...
    private IdentityHashMapEntry<K, V> getEntry(int index) {
        IdentityHashMapEntry<K, V> varB4EAC82CA7396A68D541C85D26508E83_702933437 = null; //Variable for return #1
        ...
        addTaint(index);
        varB4EAC82CA7396A68D541C85D26508E83_702933437.addTaint(getTaint()); //Add taint from parent
    ...
    public V put(K key, V value) {
        V varB4EAC82CA7396A68D541C85D26508E83_853627991 = null; //Variable for return #1
        Object _key = key;
        Object _value = value;
        {
            _key = NULL_OBJECT;
        ...
        addTaint(key.getTaint());
        addTaint(value.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_853627991.addTaint(getTaint()); //Add taint from parent
    ...
    public V remove(Object key) {
        V varB4EAC82CA7396A68D541C85D26508E83_1694559451 = null; //Variable for return #1
        V varB4EAC82CA7396A68D541C85D26508E83_1969042052 = null; //Variable for return #2
        {
            key = NULL_OBJECT;
        } //End block
        boolean hashedOk;
        ...
        addTaint(key.getTaint());
        V varA7E53CE21691AB073D9660D615818899_1028681978; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1028681978.addTaint(getTaint()); //Add taint from parent
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        Set<Map.Entry<K, V>> varB4EAC82CA7396A68D541C85D26508E83_439324487 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_439324487 = new IdentityHashMapEntrySet<K, V>(this);
        varB4EAC82CA7396A68D541C85D26508E83_439324487.addTaint(getTaint()); //Add taint from parent
    ...
    @Override
    public Set<K> keySet() {
        Set<K> varB4EAC82CA7396A68D541C85D26508E83_467864958 = null; //Variable for return #1
        {
            keySet = new AbstractSet<K>() {                
                ...
                public Iterator<K> iterator() {
                    Iterator<K> varB4EAC82CA7396A68D541C85D26508E83_187246772 = null; //Variable for return #1
                    ...
                    varB4EAC82CA7396A68D541C85D26508E83_187246772.addTaint(getTaint()); //Add taint from parent
        ...
        varB4EAC82CA7396A68D541C85D26508E83_467864958.addTaint(getTaint()); //Add taint from parent
    ...
    public Collection<V> values() {
        Collection<V> varB4EAC82CA7396A68D541C85D26508E83_562859744 = null; //Variable for return #1
        {
            valuesCollection = new AbstractCollection<V>() {                
                ...
                public Iterator<V> iterator() {
                    Iterator<V> varB4EAC82CA7396A68D541C85D26508E83_248076205 = null; //Variable for return #1
                    ...
                    varB4EAC82CA7396A68D541C85D26508E83_248076205.addTaint(getTaint()); //Add taint from parent
        ...
        varB4EAC82CA7396A68D541C85D26508E83_562859744.addTaint(getTaint()); //Add taint from parent
    ...
    @Override
    public Object clone() {
        Object varB4EAC82CA7396A68D541C85D26508E83_2016894653 = null; //Variable for return #1
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_2016894653.addTaint(getTaint()); //Add taint from parent
    ...
    static class IdentityHashMapEntry<K, V> extends MapEntry<K, V> {
        ...
        @Override
        public Object clone() {
            Object varB4EAC82CA7396A68D541C85D26508E83_1332765546 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_1332765546 = super.clone();
            varB4EAC82CA7396A68D541C85D26508E83_1332765546.addTaint(getTaint()); //Add taint from parent
        ...
        public String toString() {
            String varB4EAC82CA7396A68D541C85D26508E83_1539489011 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_1539489011 = key + "=" + value;
            varB4EAC82CA7396A68D541C85D26508E83_1539489011.addTaint(getTaint()); //Add taint from parent
        ...
        public V setValue(V object) {
            V varB4EAC82CA7396A68D541C85D26508E83_2135751105 = null; //Variable for return #1
            V result = super.setValue(object);
            map.put(key, object);
            varB4EAC82CA7396A68D541C85D26508E83_2135751105 = result;
            addTaint(object.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_2135751105.addTaint(getTaint()); //Add taint from parent
    ...
    static class IdentityHashMapIterator<E, KT, VT> implements Iterator<E> {
        ...
        public E next() {
            E varB4EAC82CA7396A68D541C85D26508E83_591929636 = null; //Variable for return #1
            checkConcurrentMod();
            {
            ...
            varB4EAC82CA7396A68D541C85D26508E83_591929636.addTaint(getTaint()); //Add taint from parent
    ...
    static class IdentityHashMapEntrySet<KT, VT> extends AbstractSet<Map.Entry<KT, VT>> {
        ...
        @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:15:09.463 -0400", hash_original_method = "DF0712385DAC2839FE08C1A7B2E52EB0", hash_generated_method = "9C9DA92BEDBEEECA79B8FFB6EEA055ED")
         IdentityHashMap<KT, VT> hashMap() {
            IdentityHashMap<KT, VT> varB4EAC82CA7396A68D541C85D26508E83_1364925225 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_1364925225 = associatedMap;
            varB4EAC82CA7396A68D541C85D26508E83_1364925225.addTaint(getTaint()); //Add taint from parent
        ...
        public Iterator<Map.Entry<KT, VT>> iterator() {
            Iterator<Map.Entry<KT, VT>> varB4EAC82CA7396A68D541C85D26508E83_1052747161 = null; //Variable for return #1
            ...
            varB4EAC82CA7396A68D541C85D26508E83_1052747161.addTaint(getTaint()); //Add taint from parent
