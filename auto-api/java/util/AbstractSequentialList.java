...
public abstract class AbstractSequentialList<E> extends AbstractList<E> {
    ...
    public E get(int location) {
        E varB4EAC82CA7396A68D541C85D26508E83_1285350242 = null; 
        try 
        {
        ...
        addTaint(location);
        varB4EAC82CA7396A68D541C85D26508E83_1285350242.addTaint(getTaint()); 
    ...
    public Iterator<E> iterator() {
        Iterator<E> varB4EAC82CA7396A68D541C85D26508E83_1542819083 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1542819083 = listIterator(0);
        varB4EAC82CA7396A68D541C85D26508E83_1542819083.addTaint(getTaint()); 
...
public abstract ListIterator<E> listIterator(int location);
    ...
    public E remove(int location) {
        E varB4EAC82CA7396A68D541C85D26508E83_739246064 = null; 
        try 
        {
            ListIterator<E> it = listIterator(location);
            E result = it.next();
        ...
        addTaint(location);
        varB4EAC82CA7396A68D541C85D26508E83_739246064.addTaint(getTaint()); 
    ...
    public E set(int location, E object) {
        E varB4EAC82CA7396A68D541C85D26508E83_1866122686 = null; 
        ListIterator<E> it = listIterator(location);
        {
        ...
        addTaint(location);
        addTaint(object.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1866122686.addTaint(getTaint()); 
