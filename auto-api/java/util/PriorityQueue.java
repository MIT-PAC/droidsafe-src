...
public class PriorityQueue<E> extends AbstractQueue<E> implements Serializable {
    ...
    public Iterator<E> iterator() {
        Iterator<E> varB4EAC82CA7396A68D541C85D26508E83_144127799 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_144127799 = new PriorityIterator();
        varB4EAC82CA7396A68D541C85D26508E83_144127799.addTaint(getTaint()); //Add taint from parent
    ...
    public E poll() {
        E varB4EAC82CA7396A68D541C85D26508E83_2020860148 = null; //Variable for return #1
        E varB4EAC82CA7396A68D541C85D26508E83_1021745944 = null; //Variable for return #2
        {
        ...
        E varA7E53CE21691AB073D9660D615818899_401393758; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_401393758.addTaint(getTaint()); //Add taint from parent
    ...
    public E peek() {
        E varB4EAC82CA7396A68D541C85D26508E83_1024095134 = null; //Variable for return #1
        E varB4EAC82CA7396A68D541C85D26508E83_291889699 = null; //Variable for return #2
        {
        ...
        E varA7E53CE21691AB073D9660D615818899_183154460; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_183154460.addTaint(getTaint()); //Add taint from parent
    ...
    public Comparator<? super E> comparator() {
        Comparator<? super E> varB4EAC82CA7396A68D541C85D26508E83_1041404170 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1041404170 = comparator;
        varB4EAC82CA7396A68D541C85D26508E83_1041404170.addTaint(getTaint()); //Add taint from parent
    ...
    private E[] newElementArray(int capacity) {
        E[] varB4EAC82CA7396A68D541C85D26508E83_933228281 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_933228281 = (E[]) new Object[capacity];
        addTaint(capacity);
        varB4EAC82CA7396A68D541C85D26508E83_933228281.addTaint(getTaint()); //Add taint from parent
    ...
    private class PriorityIterator implements Iterator<E> {
        ...
        public E next() {
            E varB4EAC82CA7396A68D541C85D26508E83_1314774558 = null; //Variable for return #1
            {
            ...
            varB4EAC82CA7396A68D541C85D26508E83_1314774558.addTaint(getTaint()); //Add taint from parent
