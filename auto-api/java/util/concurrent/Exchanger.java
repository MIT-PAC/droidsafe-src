...
public class Exchanger<V> {
    ...
    private Object doExchange(Object item, boolean timed, long nanos) {
        Object varB4EAC82CA7396A68D541C85D26508E83_645392046 = null; //Variable for return #1
        Object varB4EAC82CA7396A68D541C85D26508E83_1574568479 = null; //Variable for return #2
        Object varB4EAC82CA7396A68D541C85D26508E83_105994575 = null; //Variable for return #3
        ...
        addTaint(timed);
        addTaint(nanos);
        Object varA7E53CE21691AB073D9660D615818899_672694288; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_672694288.addTaint(getTaint()); //Add taint from parent
    ...
    private Object awaitNanos(Node node, Slot slot, long nanos) {
        Object varB4EAC82CA7396A68D541C85D26508E83_499064129 = null; //Variable for return #1
        Object varB4EAC82CA7396A68D541C85D26508E83_1511308196 = null; //Variable for return #2
        ...
        addTaint(nanos);
        Object varA7E53CE21691AB073D9660D615818899_171179654; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_171179654.addTaint(getTaint()); //Add taint from parent
    ...
    private Object scanOnTimeout(Node node) {
        Object varB4EAC82CA7396A68D541C85D26508E83_1289002109 = null; //Variable for return #1
        Object varB4EAC82CA7396A68D541C85D26508E83_937982600 = null; //Variable for return #2
        Object y;
        {
        ...
        addTaint(node.getTaint());
        Object varA7E53CE21691AB073D9660D615818899_455026448; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_455026448.addTaint(getTaint()); //Add taint from parent
    ...
    public V exchange(V x) throws InterruptedException {
        V varB4EAC82CA7396A68D541C85D26508E83_1780210649 = null; //Variable for return #1
        V varB4EAC82CA7396A68D541C85D26508E83_1501254381 = null; //Variable for return #2
        {
            boolean var7802430CC9FA3C264EA55E37D5C0452C_1069493857 = (!Thread.interrupted());
            {
                Object v = doExchange((x == null) ? NULL_ITEM : x, false, 0);//DSFIXME:  CODE0008: Nested ternary operator in expression
        ...
        addTaint(x.getTaint());
        V varA7E53CE21691AB073D9660D615818899_611425972; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_611425972.addTaint(getTaint()); //Add taint from parent
    ...
    public V exchange(V x, long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
        V varB4EAC82CA7396A68D541C85D26508E83_1691719686 = null; //Variable for return #1
        V varB4EAC82CA7396A68D541C85D26508E83_1336217552 = null; //Variable for return #2
        {
        ...
        V varA7E53CE21691AB073D9660D615818899_1980333857; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1980333857.addTaint(getTaint()); //Add taint from parent
