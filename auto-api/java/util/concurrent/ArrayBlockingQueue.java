...
public class ArrayBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
    ...
    final E itemAt(int i) {
        E varB4EAC82CA7396A68D541C85D26508E83_1824219954 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1824219954 = this.<E>cast(items[i]);
        addTaint(i);
        varB4EAC82CA7396A68D541C85D26508E83_1824219954.addTaint(getTaint()); //Add taint from parent
    ...
    private E extract() {
        E varB4EAC82CA7396A68D541C85D26508E83_853725490 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_853725490.addTaint(getTaint()); //Add taint from parent
    ...
    public E poll() {
        E varB4EAC82CA7396A68D541C85D26508E83_2050380488 = null; //Variable for return #1
        final ReentrantLock lock = this.lock;
        lock.lock();
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_2050380488.addTaint(getTaint()); //Add taint from parent
    ...
    public E take() throws InterruptedException {
        E varB4EAC82CA7396A68D541C85D26508E83_993745996 = null; //Variable for return #1
        final ReentrantLock lock = this.lock;
        lock.lockInterruptibly();
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_993745996.addTaint(getTaint()); //Add taint from parent
    ...
    public E poll(long timeout, TimeUnit unit) throws InterruptedException {
        E varB4EAC82CA7396A68D541C85D26508E83_938603626 = null; //Variable for return #1
        E varB4EAC82CA7396A68D541C85D26508E83_236156939 = null; //Variable for return #2
        long nanos = unit.toNanos(timeout);
        final ReentrantLock lock = this.lock;
        lock.lockInterruptibly();
        try 
        ...
        addTaint(timeout);
        addTaint(unit.getTaint());
        E varA7E53CE21691AB073D9660D615818899_195078243; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_195078243.addTaint(getTaint()); //Add taint from parent
    ...
    public E peek() {
        E varB4EAC82CA7396A68D541C85D26508E83_1517462679 = null; //Variable for return #1
        final ReentrantLock lock = this.lock;
        lock.lock();
        try 
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1517462679.addTaint(getTaint()); //Add taint from parent
    ...
    public Object[] toArray() {
        Object[] varB4EAC82CA7396A68D541C85D26508E83_416128236 = null; //Variable for return #1
        final Object[] items = this.items;
        final ReentrantLock lock = this.lock;
        lock.lock();
        try 
        ...
        varB4EAC82CA7396A68D541C85D26508E83_416128236.addTaint(getTaint()); //Add taint from parent
    ...
    public <T> T[] toArray(T[] a) {
        T[] varB4EAC82CA7396A68D541C85D26508E83_456196711 = null; //Variable for return #1
        final Object[] items = this.items;
        final ReentrantLock lock = this.lock;
        lock.lock();
        try 
        ...
        varB4EAC82CA7396A68D541C85D26508E83_456196711.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_623893992 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1636111782 = null; //Variable for return #2
        final ReentrantLock lock = this.lock;
        lock.lock();
        try 
        {
        ...
        String varA7E53CE21691AB073D9660D615818899_1866246457; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1866246457.addTaint(getTaint()); //Add taint from parent
    ...
    public Iterator<E> iterator() {
        Iterator<E> varB4EAC82CA7396A68D541C85D26508E83_2065580283 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2065580283 = new Itr();
        varB4EAC82CA7396A68D541C85D26508E83_2065580283.addTaint(getTaint()); //Add taint from parent
    ...
    private class Itr implements Iterator<E> {
        ...
        public E next() {
            E varB4EAC82CA7396A68D541C85D26508E83_1937988191 = null; //Variable for return #1
            final ReentrantLock lock = ArrayBlockingQueue.this.lock;
            lock.lock();
            try 
            {
            ...
            varB4EAC82CA7396A68D541C85D26508E83_1937988191.addTaint(getTaint()); //Add taint from parent
