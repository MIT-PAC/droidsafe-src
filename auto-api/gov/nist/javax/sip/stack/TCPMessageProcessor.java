...
public class TCPMessageProcessor extends MessageProcessor {
    ...
    public String getTransport() {
        String varB4EAC82CA7396A68D541C85D26508E83_1666443436 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1666443436 = "tcp";
        varB4EAC82CA7396A68D541C85D26508E83_1666443436.addTaint(getTaint()); //Add taint from parent
    ...
    public SIPTransactionStack getSIPStack() {
        SIPTransactionStack varB4EAC82CA7396A68D541C85D26508E83_2076088320 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2076088320 = sipStack;
        varB4EAC82CA7396A68D541C85D26508E83_2076088320.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized MessageChannel createMessageChannel(HostPort targetHostPort) throws IOException {
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_450072599 = null; //Variable for return #1
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_150610106 = null; //Variable for return #2
        ...
        MessageChannel varA7E53CE21691AB073D9660D615818899_384236634; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_384236634.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized MessageChannel createMessageChannel(InetAddress host, int port) throws IOException {
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_2116417105 = null; //Variable for return #1
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_745792319 = null; //Variable for return #2
        try 
        {
        ...
        addTaint(port);
        MessageChannel varA7E53CE21691AB073D9660D615818899_2076429344; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_2076429344.addTaint(getTaint()); //Add taint from parent
