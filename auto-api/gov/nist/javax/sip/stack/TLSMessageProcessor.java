...
public class TLSMessageProcessor extends MessageProcessor {
    ...
    public SIPTransactionStack getSIPStack() {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_300285001.addTaint(getTaint()); 
    ...
    public synchronized MessageChannel createMessageChannel(HostPort targetHostPort) throws IOException {
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_1738445671 = null; 
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_1452711627 = null; 
        ...
        MessageChannel varA7E53CE21691AB073D9660D615818899_1482747330; 
        ...
        varA7E53CE21691AB073D9660D615818899_1482747330.addTaint(getTaint()); 
    ...
    public synchronized MessageChannel createMessageChannel(InetAddress host, int port) throws IOException {
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_993359278 = null; 
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_945295780 = null; 
        try 
        {
        ...
        addTaint(port);
        MessageChannel varA7E53CE21691AB073D9660D615818899_1529009976; 
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: 
        ...
        varA7E53CE21691AB073D9660D615818899_1529009976.addTaint(getTaint()); 
