...
class IOHandler {
    ...
    protected Socket getSocket(String key) {
        Socket varB4EAC82CA7396A68D541C85D26508E83_1249537148 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1249537148 = (Socket) socketTable.get(key);
        addTaint(key.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1249537148.addTaint(getTaint()); //Add taint from parent
    ...
    public SocketAddress obtainLocalAddress(InetAddress dst, int dstPort,
        ...
        SocketAddress varB4EAC82CA7396A68D541C85D26508E83_1632332282 = null; //Variable for return #1
        ...
        addTaint(localPort);
        varB4EAC82CA7396A68D541C85D26508E83_1632332282.addTaint(getTaint()); //Add taint from parent
    ...
    public Socket sendBytes(InetAddress senderAddress, InetAddress receiverAddress,
        ...
        Socket varB4EAC82CA7396A68D541C85D26508E83_491993616 = null; //Variable for return #1
        Socket varB4EAC82CA7396A68D541C85D26508E83_1522506632 = null; //Variable for return #2
        Socket varB4EAC82CA7396A68D541C85D26508E83_2110391742 = null; //Variable for return #3
        int retry_count = 0;
        int max_retry;
        max_retry = 2;
        max_retry = 1;
        ...
        Socket varA7E53CE21691AB073D9660D615818899_144025443; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_144025443.addTaint(getTaint()); //Add taint from parent
