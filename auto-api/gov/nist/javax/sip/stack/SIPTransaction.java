...
public abstract class SIPTransaction extends MessageChannel implements javax.sip.Transaction, gov.nist.javax.sip.TransactionExt {
    ...
    public String getBranchId() {
        String varB4EAC82CA7396A68D541C85D26508E83_488245193 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_488245193 = this.branch;
        varB4EAC82CA7396A68D541C85D26508E83_488245193.addTaint(getTaint()); //Add taint from parent
    ...
    public SIPRequest getOriginalRequest() {
        SIPRequest varB4EAC82CA7396A68D541C85D26508E83_881085297 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_881085297 = originalRequest;
        varB4EAC82CA7396A68D541C85D26508E83_881085297.addTaint(getTaint()); //Add taint from parent
    ...
    public Request getRequest() {
        Request varB4EAC82CA7396A68D541C85D26508E83_1857789013 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1857789013 = (Request) originalRequest;
        varB4EAC82CA7396A68D541C85D26508E83_1857789013.addTaint(getTaint()); //Add taint from parent
    ...
    public MessageChannel getMessageChannel() {
        MessageChannel varB4EAC82CA7396A68D541C85D26508E83_597850450 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_597850450 = encapsulatedChannel;
        varB4EAC82CA7396A68D541C85D26508E83_597850450.addTaint(getTaint()); //Add taint from parent
    ...
    public final String getBranch() {
        String varB4EAC82CA7396A68D541C85D26508E83_1553190188 = null; //Variable for return #1
        {
            this.branch = getOriginalRequest().getTopmostVia().getBranch();
        } //End block
        varB4EAC82CA7396A68D541C85D26508E83_1553190188 = branch;
        varB4EAC82CA7396A68D541C85D26508E83_1553190188.addTaint(getTaint()); //Add taint from parent
    ...
    public final String getMethod() {
        String varB4EAC82CA7396A68D541C85D26508E83_1949991163 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1949991163 = this.method;
        varB4EAC82CA7396A68D541C85D26508E83_1949991163.addTaint(getTaint()); //Add taint from parent
    ...
    public TransactionState getState() {
        TransactionState varB4EAC82CA7396A68D541C85D26508E83_1780714913 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1780714913 = this.currentState;
        varB4EAC82CA7396A68D541C85D26508E83_1780714913.addTaint(getTaint()); //Add taint from parent
    ...
    public String getHost() {
        String varB4EAC82CA7396A68D541C85D26508E83_117715501 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_117715501 = encapsulatedChannel.getHost();
        varB4EAC82CA7396A68D541C85D26508E83_117715501.addTaint(getTaint()); //Add taint from parent
    ...
    public String getKey() {
        String varB4EAC82CA7396A68D541C85D26508E83_1831737592 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1831737592 = encapsulatedChannel.getKey();
        varB4EAC82CA7396A68D541C85D26508E83_1831737592.addTaint(getTaint()); //Add taint from parent
    ...
    public SIPTransactionStack getSIPStack() {
        SIPTransactionStack varB4EAC82CA7396A68D541C85D26508E83_343812661 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_343812661 = (SIPTransactionStack) sipStack;
        varB4EAC82CA7396A68D541C85D26508E83_343812661.addTaint(getTaint()); //Add taint from parent
    ...
    public String getPeerAddress() {
        String varB4EAC82CA7396A68D541C85D26508E83_1114089147 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1114089147 = this.peerAddress;
        varB4EAC82CA7396A68D541C85D26508E83_1114089147.addTaint(getTaint()); //Add taint from parent
    ...
    public InetAddress getPeerPacketSourceAddress() {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_533054364 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_533054364 = this.peerPacketSourceAddress;
        varB4EAC82CA7396A68D541C85D26508E83_533054364.addTaint(getTaint()); //Add taint from parent
    ...
    protected InetAddress getPeerInetAddress() {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_1144970816 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1144970816 = this.peerInetAddress;
        varB4EAC82CA7396A68D541C85D26508E83_1144970816.addTaint(getTaint()); //Add taint from parent
    ...
    protected String getPeerProtocol() {
        String varB4EAC82CA7396A68D541C85D26508E83_541300750 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_541300750 = this.peerProtocol;
        varB4EAC82CA7396A68D541C85D26508E83_541300750.addTaint(getTaint()); //Add taint from parent
    ...
    public String getTransport() {
        String varB4EAC82CA7396A68D541C85D26508E83_1760228269 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1760228269 = encapsulatedChannel.getTransport();
        varB4EAC82CA7396A68D541C85D26508E83_1760228269.addTaint(getTaint()); //Add taint from parent
    ...
    public Via getViaHeader() {
        Via varB4EAC82CA7396A68D541C85D26508E83_253331370 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_253331370.addTaint(getTaint()); //Add taint from parent
    ...
    public String getViaHost() {
        String varB4EAC82CA7396A68D541C85D26508E83_454422365 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_454422365 = this.getViaHeader().getHost();
        varB4EAC82CA7396A68D541C85D26508E83_454422365.addTaint(getTaint()); //Add taint from parent
    ...
    public SIPResponse getLastResponse() {
        SIPResponse varB4EAC82CA7396A68D541C85D26508E83_1274613207 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1274613207 = this.lastResponse;
        varB4EAC82CA7396A68D541C85D26508E83_1274613207.addTaint(getTaint()); //Add taint from parent
    ...
    public Response getResponse() {
        Response varB4EAC82CA7396A68D541C85D26508E83_112874827 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_112874827 = (Response) this.lastResponse;
        varB4EAC82CA7396A68D541C85D26508E83_112874827.addTaint(getTaint()); //Add taint from parent
    ...
    public String getTransactionId() {
        String varB4EAC82CA7396A68D541C85D26508E83_1820090797 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1820090797 = this.transactionId;
        varB4EAC82CA7396A68D541C85D26508E83_1820090797.addTaint(getTaint()); //Add taint from parent
    ...
    public MessageProcessor getMessageProcessor() {
        MessageProcessor varB4EAC82CA7396A68D541C85D26508E83_211303178 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_211303178 = this.encapsulatedChannel.getMessageProcessor();
        varB4EAC82CA7396A68D541C85D26508E83_211303178.addTaint(getTaint()); //Add taint from parent
    ...
    public Object getApplicationData() {
        Object varB4EAC82CA7396A68D541C85D26508E83_334316144 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_334316144 = this.applicationData;
        varB4EAC82CA7396A68D541C85D26508E83_334316144.addTaint(getTaint()); //Add taint from parent
    ...
    public SipProviderImpl getSipProvider() {
        SipProviderImpl varB4EAC82CA7396A68D541C85D26508E83_1344893273 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1344893273 = this.getMessageProcessor().getListeningPoint().getProvider();
        varB4EAC82CA7396A68D541C85D26508E83_1344893273.addTaint(getTaint()); //Add taint from parent
    ...
    public String getCipherSuite() throws UnsupportedOperationException {
        String varB4EAC82CA7396A68D541C85D26508E83_1376887580 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1667936736 = null; //Variable for return #2
        String varB4EAC82CA7396A68D541C85D26508E83_488010497 = null; //Variable for return #3
        {
        ...
        String varA7E53CE21691AB073D9660D615818899_498347941; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_498347941.addTaint(getTaint()); //Add taint from parent
    ...
    public java.security.cert.Certificate[] getLocalCertificates() throws UnsupportedOperationException {
        java.security.cert.Certificate[] varB4EAC82CA7396A68D541C85D26508E83_1304259905 = null; //Variable for return #1
        java.security.cert.Certificate[] varB4EAC82CA7396A68D541C85D26508E83_1728962350 = null; //Variable for return #2
        java.security.cert.Certificate[] varB4EAC82CA7396A68D541C85D26508E83_727175595 = null; //Variable for return #3
        {
        ...
        java.security.cert.Certificate[] varA7E53CE21691AB073D9660D615818899_266527372; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_266527372.addTaint(getTaint()); //Add taint from parent
    ...
    public java.security.cert.Certificate[] getPeerCertificates() throws SSLPeerUnverifiedException {
        java.security.cert.Certificate[] varB4EAC82CA7396A68D541C85D26508E83_474863017 = null; //Variable for return #1
        java.security.cert.Certificate[] varB4EAC82CA7396A68D541C85D26508E83_1911364638 = null; //Variable for return #2
        java.security.cert.Certificate[] varB4EAC82CA7396A68D541C85D26508E83_445853585 = null; //Variable for return #3
        {
        ...
        java.security.cert.Certificate[] varA7E53CE21691AB073D9660D615818899_1903282982; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1903282982.addTaint(getTaint()); //Add taint from parent
