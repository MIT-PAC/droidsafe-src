...
public class UnsupportedList extends SIPHeaderList<Unsupported> {
    ...
    public Object clone() {
        Object varB4EAC82CA7396A68D541C85D26508E83_1024396380 = null; //Variable for return #1
        UnsupportedList retval = new UnsupportedList();
        varB4EAC82CA7396A68D541C85D26508E83_1024396380 = retval.clonehlist(this.hlist);
        varB4EAC82CA7396A68D541C85D26508E83_1024396380.addTaint(getTaint()); //Add taint from parent
