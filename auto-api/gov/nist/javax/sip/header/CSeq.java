...
public class CSeq extends SIPHeader implements javax.sip.header.CSeqHeader {
    ...
    public String encode() {
        String varB4EAC82CA7396A68D541C85D26508E83_2049129711 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2049129711 = headerName + COLON + SP + encodeBody() + NEWLINE;
        varB4EAC82CA7396A68D541C85D26508E83_2049129711.addTaint(getTaint()); //Add taint from parent
    ...
    public String encodeBody() {
        String varB4EAC82CA7396A68D541C85D26508E83_1166926123 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1166926123 = encodeBody(new StringBuffer()).toString();
        varB4EAC82CA7396A68D541C85D26508E83_1166926123.addTaint(getTaint()); //Add taint from parent
    ...
    protected StringBuffer encodeBody(StringBuffer buffer) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_1489860484 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1489860484 = buffer.append(seqno).append(SP).append(method.toUpperCase());
        addTaint(buffer.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1489860484.addTaint(getTaint()); //Add taint from parent
    ...
    public String getMethod() {
        String varB4EAC82CA7396A68D541C85D26508E83_566061136 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_566061136 = method;
        varB4EAC82CA7396A68D541C85D26508E83_566061136.addTaint(getTaint()); //Add taint from parent
