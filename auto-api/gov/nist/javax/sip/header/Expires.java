...
public class Expires extends SIPHeader implements javax.sip.header.ExpiresHeader {
    ...
    public String encodeBody() {
        String varB4EAC82CA7396A68D541C85D26508E83_1329784740 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1329784740 = encodeBody(new StringBuffer()).toString();
        varB4EAC82CA7396A68D541C85D26508E83_1329784740.addTaint(getTaint()); 
    ...
    protected StringBuffer encodeBody(StringBuffer buffer) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_1756090457 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1756090457 = buffer.append(expires);
        addTaint(buffer.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1756090457.addTaint(getTaint()); 
