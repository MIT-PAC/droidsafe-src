...
public class PChargingFunctionAddresses extends gov.nist.javax.sip.header.ParametersHeader implements PChargingFunctionAddressesHeader, SIPHeaderNamesIms, ExtensionHeader {
    ...
    protected String encodeBody() {
        String varB4EAC82CA7396A68D541C85D26508E83_470186518 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_470186518.addTaint(getTaint()); //Add taint from parent
    ...
    public ListIterator getChargingCollectionFunctionAddresses() {
        ListIterator varB4EAC82CA7396A68D541C85D26508E83_1120770421 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1120770421.addTaint(getTaint()); //Add taint from parent
    ...
    public ListIterator<NameValue> getEventChargingFunctionAddresses() {
        ListIterator<NameValue> varB4EAC82CA7396A68D541C85D26508E83_1665381296 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1665381296.addTaint(getTaint()); //Add taint from parent
