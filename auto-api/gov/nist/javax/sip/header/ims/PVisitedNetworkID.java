...
public class PVisitedNetworkID extends gov.nist.javax.sip.header.ParametersHeader implements PVisitedNetworkIDHeader, SIPHeaderNamesIms, ExtensionHeader {
    ...
    protected String encodeBody() {
        String varB4EAC82CA7396A68D541C85D26508E83_1645780433 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1645780433.addTaint(getTaint()); //Add taint from parent
    ...
    public String getVisitedNetworkID() {
        String varB4EAC82CA7396A68D541C85D26508E83_795644532 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_795644532 = networkID;
        varB4EAC82CA7396A68D541C85D26508E83_795644532.addTaint(getTaint()); //Add taint from parent
    ...
    public Object clone() {
        Object varB4EAC82CA7396A68D541C85D26508E83_328189368 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_328189368.addTaint(getTaint()); //Add taint from parent
