...
public class ContentLength extends SIPHeader implements javax.sip.header.ContentLengthHeader {
    ...
    public String encodeBody() {
        String varB4EAC82CA7396A68D541C85D26508E83_1047523501 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1047523501 = encodeBody(new StringBuffer()).toString();
        varB4EAC82CA7396A68D541C85D26508E83_1047523501.addTaint(getTaint()); //Add taint from parent
    ...
    protected StringBuffer encodeBody(StringBuffer buffer) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_951260566 = null; //Variable for return #1
        buffer.append("0");
        buffer.append(contentLength.toString());
        varB4EAC82CA7396A68D541C85D26508E83_951260566 = buffer;
        addTaint(buffer.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_951260566.addTaint(getTaint()); //Add taint from parent
