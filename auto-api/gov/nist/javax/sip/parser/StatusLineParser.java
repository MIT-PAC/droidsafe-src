...
public class StatusLineParser extends Parser {
    ...
    protected String reasonPhrase() throws ParseException {
        String varB4EAC82CA7396A68D541C85D26508E83_1559481039 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1559481039 = this.lexer.getRest().trim();
        varB4EAC82CA7396A68D541C85D26508E83_1559481039.addTaint(getTaint()); 
    ...
    public StatusLine parse() throws ParseException {
        StatusLine varB4EAC82CA7396A68D541C85D26508E83_474552666 = null; 
        try 
        {
            dbg_enter("parse");
        ...
        varB4EAC82CA7396A68D541C85D26508E83_474552666.addTaint(getTaint()); 
