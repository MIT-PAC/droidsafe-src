...
public class Authority extends NetObject {
    ...
    public String encode() {
        String varB4EAC82CA7396A68D541C85D26508E83_2014305530 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2014305530 = encode(new StringBuffer()).toString();
        varB4EAC82CA7396A68D541C85D26508E83_2014305530.addTaint(getTaint()); //Add taint from parent
    ...
    public StringBuffer encode(StringBuffer buffer) {
        StringBuffer varB4EAC82CA7396A68D541C85D26508E83_1421285373 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1421285373.addTaint(getTaint()); //Add taint from parent
    ...
    public HostPort getHostPort() {
        HostPort varB4EAC82CA7396A68D541C85D26508E83_1325236006 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1325236006 = hostPort;
        varB4EAC82CA7396A68D541C85D26508E83_1325236006.addTaint(getTaint()); //Add taint from parent
    ...
    public UserInfo getUserInfo() {
        UserInfo varB4EAC82CA7396A68D541C85D26508E83_2026475520 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2026475520 = userInfo;
        varB4EAC82CA7396A68D541C85D26508E83_2026475520.addTaint(getTaint()); //Add taint from parent
    ...
    public String getPassword() {
        String varB4EAC82CA7396A68D541C85D26508E83_2062931823 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_73984106 = null; //Variable for return #2
        varB4EAC82CA7396A68D541C85D26508E83_2062931823 = null;
        varB4EAC82CA7396A68D541C85D26508E83_73984106 = userInfo.password;
        String varA7E53CE21691AB073D9660D615818899_552174216; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_552174216.addTaint(getTaint()); //Add taint from parent
    ...
    public String getUser() {
        String varB4EAC82CA7396A68D541C85D26508E83_1122385401 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1122385401 = userInfo != null ? userInfo.user : null;
        varB4EAC82CA7396A68D541C85D26508E83_1122385401.addTaint(getTaint()); //Add taint from parent
    ...
    public Host getHost() {
        Host varB4EAC82CA7396A68D541C85D26508E83_910900154 = null; //Variable for return #1
        Host varB4EAC82CA7396A68D541C85D26508E83_2079886327 = null; //Variable for return #2
        varB4EAC82CA7396A68D541C85D26508E83_910900154 = null;
        varB4EAC82CA7396A68D541C85D26508E83_2079886327 = hostPort.getHost();
        Host varA7E53CE21691AB073D9660D615818899_92274117; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_92274117.addTaint(getTaint()); //Add taint from parent
    ...
    public Object clone() {
        Object varB4EAC82CA7396A68D541C85D26508E83_1605081791 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1605081791.addTaint(getTaint()); //Add taint from parent
