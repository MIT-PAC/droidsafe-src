...
public class HostNameParser extends ParserCore {
    ...
    protected String ipv6Reference() throws ParseException {
        String varB4EAC82CA7396A68D541C85D26508E83_697701878 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_681908480 = null; //Variable for return #2
        String varB4EAC82CA7396A68D541C85D26508E83_790458039 = null; //Variable for return #3
        ...
        String varA7E53CE21691AB073D9660D615818899_802575203; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_802575203.addTaint(getTaint()); //Add taint from parent
    ...
    public Host host() throws ParseException {
        Host varB4EAC82CA7396A68D541C85D26508E83_1850762359 = null; //Variable for return #1
        dbg_enter("host");
        try 
        {
            String hostname;
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1850762359.addTaint(getTaint()); //Add taint from parent
    ...
    public HostPort hostPort( boolean allowWS ) throws ParseException {
        HostPort varB4EAC82CA7396A68D541C85D26508E83_146017615 = null; //Variable for return #1
        dbg_enter("hostPort");
        try 
        {
            Host host = this.host();
        ...
        addTaint(allowWS);
        varB4EAC82CA7396A68D541C85D26508E83_146017615.addTaint(getTaint()); //Add taint from parent
