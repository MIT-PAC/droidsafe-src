...
abstract class LoggingPrintStream extends PrintStream {
    ...
    public PrintStream format(String format, Object... args) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1783699520 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1783699520 = format(Locale.getDefault(), format, args);
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1783699520.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream printf(String format, Object... args) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_591597491 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_591597491 = format(format, args);
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_591597491.addTaint(getTaint()); //Add taint from parent
    ...
    public PrintStream printf(Locale l, String format, Object... args) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1739754586 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1739754586 = format(l, format, args);
        addTaint(l.getTaint());
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1739754586.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized PrintStream format(
        ...
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1192732291 = null; //Variable for return #1
        {
        ...
        addTaint(format.getTaint());
        addTaint(args[0].getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1192732291.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized PrintStream append(char c) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1634367157 = null; //Variable for return #1
        print(c);
        varB4EAC82CA7396A68D541C85D26508E83_1634367157 = this;
        addTaint(c);
        varB4EAC82CA7396A68D541C85D26508E83_1634367157.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized PrintStream append(CharSequence csq) {
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_1103212294 = null; //Variable for return #1
        builder.append(csq);
        flush(false);
        varB4EAC82CA7396A68D541C85D26508E83_1103212294 = this;
        addTaint(csq.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1103212294.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized PrintStream append(
        ...
        PrintStream varB4EAC82CA7396A68D541C85D26508E83_2050744479 = null; //Variable for return #1
        ...
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_2050744479.addTaint(getTaint()); //Add taint from parent
