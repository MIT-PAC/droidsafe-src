...
public class MenuBuilder implements Menu {
    ...
    public MenuBuilder setDefaultShowAsAction(int defaultShowAsAction) {
        MenuBuilder varB4EAC82CA7396A68D541C85D26508E83_107679363 = null; //Variable for return #1
        mDefaultShowAsAction = defaultShowAsAction;
        varB4EAC82CA7396A68D541C85D26508E83_107679363 = this;
        varB4EAC82CA7396A68D541C85D26508E83_107679363.addTaint(getTaint()); //Add taint from parent
    ...
    protected String getActionViewStatesKey() {
        String varB4EAC82CA7396A68D541C85D26508E83_1716548442 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1716548442 = ACTION_VIEW_STATES_KEY;
        varB4EAC82CA7396A68D541C85D26508E83_1716548442.addTaint(getTaint()); //Add taint from parent
    ...
    private MenuItem addInternal(int group, int id, int categoryOrder, CharSequence title) {
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_1920156721 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1920156721.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuItem add(CharSequence title) {
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_327582381 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_327582381 = addInternal(0, 0, 0, title);
        addTaint(title.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_327582381.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuItem add(int titleRes) {
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_500537132 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_500537132 = addInternal(0, 0, 0, mResources.getString(titleRes));
        addTaint(titleRes);
        varB4EAC82CA7396A68D541C85D26508E83_500537132.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuItem add(int group, int id, int categoryOrder, CharSequence title) {
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_2067083345 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2067083345 = addInternal(group, id, categoryOrder, title);
        addTaint(group);
        addTaint(id);
        addTaint(categoryOrder);
        addTaint(title.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_2067083345.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuItem add(int group, int id, int categoryOrder, int title) {
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_873433495 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_873433495 = addInternal(group, id, categoryOrder, mResources.getString(title));
        addTaint(group);
        addTaint(id);
        addTaint(categoryOrder);
        addTaint(title);
        varB4EAC82CA7396A68D541C85D26508E83_873433495.addTaint(getTaint()); //Add taint from parent
    ...
    public SubMenu addSubMenu(CharSequence title) {
        SubMenu varB4EAC82CA7396A68D541C85D26508E83_1855174926 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1855174926 = addSubMenu(0, 0, 0, title);
        addTaint(title.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1855174926.addTaint(getTaint()); //Add taint from parent
    ...
    public SubMenu addSubMenu(int titleRes) {
        SubMenu varB4EAC82CA7396A68D541C85D26508E83_1313853800 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1313853800 = addSubMenu(0, 0, 0, mResources.getString(titleRes));
        addTaint(titleRes);
        varB4EAC82CA7396A68D541C85D26508E83_1313853800.addTaint(getTaint()); //Add taint from parent
    ...
    public SubMenu addSubMenu(int group, int id, int categoryOrder, CharSequence title) {
        SubMenu varB4EAC82CA7396A68D541C85D26508E83_1502023991 = null; //Variable for return #1
        ...
        addTaint(categoryOrder);
        addTaint(title.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1502023991.addTaint(getTaint()); //Add taint from parent
    ...
    public SubMenu addSubMenu(int group, int id, int categoryOrder, int title) {
        SubMenu varB4EAC82CA7396A68D541C85D26508E83_1799224866 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1799224866 = addSubMenu(group, id, categoryOrder, mResources.getString(title));
        addTaint(group);
        addTaint(id);
        addTaint(categoryOrder);
        addTaint(title);
        varB4EAC82CA7396A68D541C85D26508E83_1799224866.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuItem findItem(int id) {
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_1377172457 = null; //Variable for return #1
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_796733880 = null; //Variable for return #2
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_1370782502 = null; //Variable for return #3
        final int size = size();
        {
            int i = 0;
            {
        ...
        addTaint(id);
        MenuItem varA7E53CE21691AB073D9660D615818899_1532005496; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1532005496.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuItem getItem(int index) {
        MenuItem varB4EAC82CA7396A68D541C85D26508E83_506952539 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_506952539 = mItems.get(index);
        addTaint(index);
        varB4EAC82CA7396A68D541C85D26508E83_506952539.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:34.341 -0400", hash_original_method = "9FEC9CB1792EB215E49CBF732B0DBF5B", hash_generated_method = "B0362249D2C4AB8C5E366AC059D7D6E3")
     Resources getResources() {
        Resources varB4EAC82CA7396A68D541C85D26508E83_383574173 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_383574173 = mResources;
        varB4EAC82CA7396A68D541C85D26508E83_383574173.addTaint(getTaint()); //Add taint from parent
    ...
    public Context getContext() {
        Context varB4EAC82CA7396A68D541C85D26508E83_1003459278 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1003459278 = mContext;
        varB4EAC82CA7396A68D541C85D26508E83_1003459278.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:34.346 -0400", hash_original_method = "249AD997FE7830E8331222B437093C3E", hash_generated_method = "A911319C2A94DEB9683413CA79CFF248")
     MenuItemImpl findItemWithShortcutForKey(int keyCode, KeyEvent event) {
        MenuItemImpl varB4EAC82CA7396A68D541C85D26508E83_1544654241 = null; //Variable for return #1
        MenuItemImpl varB4EAC82CA7396A68D541C85D26508E83_883662 = null; //Variable for return #2
        MenuItemImpl varB4EAC82CA7396A68D541C85D26508E83_1428236279 = null; //Variable for return #3
        MenuItemImpl varB4EAC82CA7396A68D541C85D26508E83_425721551 = null; //Variable for return #4
        ...
        addTaint(keyCode);
        addTaint(event.getTaint());
        MenuItemImpl varA7E53CE21691AB073D9660D615818899_500523331; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_500523331.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:34.365 -0400", hash_original_method = "66450A6B071A6D6254ADE6AFA4286392", hash_generated_method = "7300ED4E09B7EDF196DA353C4DEF60C8")
     ArrayList<MenuItemImpl> getVisibleItems() {
        ArrayList<MenuItemImpl> varB4EAC82CA7396A68D541C85D26508E83_1471134530 = null; //Variable for return #1
        ArrayList<MenuItemImpl> varB4EAC82CA7396A68D541C85D26508E83_1634642245 = null; //Variable for return #2
        ...
        ArrayList<MenuItemImpl> varA7E53CE21691AB073D9660D615818899_990754789; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_990754789.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:34.379 -0400", hash_original_method = "B1634DAD61F1C3BCC25AA2BE8A5F685D", hash_generated_method = "DEC8F1DCDEB1C7EEED5C2A52415062E3")
     ArrayList<MenuItemImpl> getActionItems() {
        ArrayList<MenuItemImpl> varB4EAC82CA7396A68D541C85D26508E83_1782590088 = null; //Variable for return #1
        flagActionItems();
        varB4EAC82CA7396A68D541C85D26508E83_1782590088 = mActionItems;
        varB4EAC82CA7396A68D541C85D26508E83_1782590088.addTaint(getTaint()); //Add taint from parent
    ...
    @DSGenerator(tool_name = "Doppelganger", tool_version = "0.4.2", generated_on = "2013-06-28 14:14:34.380 -0400", hash_original_method = "B350BF5A73D0E23634B50CFF93D74F82", hash_generated_method = "161B3F35FC5D8A7020BB5BC3AD131DEC")
     ArrayList<MenuItemImpl> getNonActionItems() {
        ArrayList<MenuItemImpl> varB4EAC82CA7396A68D541C85D26508E83_1457187699 = null; //Variable for return #1
        flagActionItems();
        varB4EAC82CA7396A68D541C85D26508E83_1457187699 = mNonActionItems;
        varB4EAC82CA7396A68D541C85D26508E83_1457187699.addTaint(getTaint()); //Add taint from parent
    ...
    protected MenuBuilder setHeaderTitleInt(CharSequence title) {
        MenuBuilder varB4EAC82CA7396A68D541C85D26508E83_59741446 = null; //Variable for return #1
        setHeaderInternal(0, title, 0, null, null);
        varB4EAC82CA7396A68D541C85D26508E83_59741446 = this;
        addTaint(title.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_59741446.addTaint(getTaint()); //Add taint from parent
    ...
    protected MenuBuilder setHeaderTitleInt(int titleRes) {
        MenuBuilder varB4EAC82CA7396A68D541C85D26508E83_1947714815 = null; //Variable for return #1
        setHeaderInternal(titleRes, null, 0, null, null);
        varB4EAC82CA7396A68D541C85D26508E83_1947714815 = this;
        addTaint(titleRes);
        varB4EAC82CA7396A68D541C85D26508E83_1947714815.addTaint(getTaint()); //Add taint from parent
    ...
    protected MenuBuilder setHeaderIconInt(Drawable icon) {
        MenuBuilder varB4EAC82CA7396A68D541C85D26508E83_143960260 = null; //Variable for return #1
        setHeaderInternal(0, null, 0, icon, null);
        varB4EAC82CA7396A68D541C85D26508E83_143960260 = this;
        addTaint(icon.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_143960260.addTaint(getTaint()); //Add taint from parent
    ...
    protected MenuBuilder setHeaderIconInt(int iconRes) {
        MenuBuilder varB4EAC82CA7396A68D541C85D26508E83_1627696029 = null; //Variable for return #1
        setHeaderInternal(0, null, iconRes, null, null);
        varB4EAC82CA7396A68D541C85D26508E83_1627696029 = this;
        addTaint(iconRes);
        varB4EAC82CA7396A68D541C85D26508E83_1627696029.addTaint(getTaint()); //Add taint from parent
    ...
    protected MenuBuilder setHeaderViewInt(View view) {
        MenuBuilder varB4EAC82CA7396A68D541C85D26508E83_1617458036 = null; //Variable for return #1
        setHeaderInternal(0, null, 0, null, view);
        varB4EAC82CA7396A68D541C85D26508E83_1617458036 = this;
        addTaint(view.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1617458036.addTaint(getTaint()); //Add taint from parent
    ...
    public CharSequence getHeaderTitle() {
        CharSequence varB4EAC82CA7396A68D541C85D26508E83_946139323 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_946139323 = mHeaderTitle;
        varB4EAC82CA7396A68D541C85D26508E83_946139323.addTaint(getTaint()); //Add taint from parent
    ...
    public Drawable getHeaderIcon() {
        Drawable varB4EAC82CA7396A68D541C85D26508E83_335475240 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_335475240 = mHeaderIcon;
        varB4EAC82CA7396A68D541C85D26508E83_335475240.addTaint(getTaint()); //Add taint from parent
    ...
    public View getHeaderView() {
        View varB4EAC82CA7396A68D541C85D26508E83_44494550 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_44494550 = mHeaderView;
        varB4EAC82CA7396A68D541C85D26508E83_44494550.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuBuilder getRootMenu() {
        MenuBuilder varB4EAC82CA7396A68D541C85D26508E83_530549906 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_530549906 = this;
        varB4EAC82CA7396A68D541C85D26508E83_530549906.addTaint(getTaint()); //Add taint from parent
    ...
    public MenuItemImpl getExpandedItem() {
        MenuItemImpl varB4EAC82CA7396A68D541C85D26508E83_2120589182 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2120589182 = mExpandedItem;
        varB4EAC82CA7396A68D541C85D26508E83_2120589182.addTaint(getTaint()); //Add taint from parent
