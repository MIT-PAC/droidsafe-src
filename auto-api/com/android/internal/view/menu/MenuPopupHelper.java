...
public class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener, ViewTreeObserver.OnGlobalLayoutListener, PopupWindow.OnDismissListener, View.OnAttachStateChangeListener, MenuPresenter {
    ...
    public Parcelable onSaveInstanceState() {
        //DSFIXME:  CODE0009: Possible callback target function detected
        Parcelable varB4EAC82CA7396A68D541C85D26508E83_1928539166 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1928539166 = null;
        varB4EAC82CA7396A68D541C85D26508E83_1928539166.addTaint(getTaint()); //Add taint from parent
    ...
    private class MenuAdapter extends BaseAdapter {
        ...
        public MenuItemImpl getItem(int position) {
            MenuItemImpl varB4EAC82CA7396A68D541C85D26508E83_1984449278 = null; //Variable for return #1
            ArrayList<MenuItemImpl> items;
            items = mAdapterMenu.getNonActionItems();
            items = mAdapterMenu.getVisibleItems();
            varB4EAC82CA7396A68D541C85D26508E83_1984449278 = items.get(position);
            addTaint(position);
            varB4EAC82CA7396A68D541C85D26508E83_1984449278.addTaint(getTaint()); //Add taint from parent
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View varB4EAC82CA7396A68D541C85D26508E83_1496704141 = null; //Variable for return #1
            {
            ...
            addTaint(parent.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_1496704141.addTaint(getTaint()); //Add taint from parent
