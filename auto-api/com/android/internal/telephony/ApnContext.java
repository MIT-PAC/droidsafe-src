...
public class ApnContext {
    ...
    public String getApnType() {
        String varB4EAC82CA7396A68D541C85D26508E83_1755106436 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1755106436 = mApnType;
        varB4EAC82CA7396A68D541C85D26508E83_1755106436.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized DataConnection getDataConnection() {
        DataConnection varB4EAC82CA7396A68D541C85D26508E83_807891407 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_807891407 = mDataConnection;
        varB4EAC82CA7396A68D541C85D26508E83_807891407.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized DataConnectionAc getDataConnectionAc() {
        DataConnectionAc varB4EAC82CA7396A68D541C85D26508E83_1942728691 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1942728691 = mDataConnectionAc;
        varB4EAC82CA7396A68D541C85D26508E83_1942728691.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized ApnSetting getApnSetting() {
        ApnSetting varB4EAC82CA7396A68D541C85D26508E83_498812577 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_498812577 = mApnSetting;
        varB4EAC82CA7396A68D541C85D26508E83_498812577.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized ApnSetting getNextWaitingApn() {
        ApnSetting varB4EAC82CA7396A68D541C85D26508E83_1932969003 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1932969003.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized ArrayList<ApnSetting> getWaitingApns() {
        ArrayList<ApnSetting> varB4EAC82CA7396A68D541C85D26508E83_1716551498 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1716551498 = mWaitingApns;
        varB4EAC82CA7396A68D541C85D26508E83_1716551498.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized DataConnectionTracker.State getState() {
        DataConnectionTracker.State varB4EAC82CA7396A68D541C85D26508E83_1634035166 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1634035166 = mState;
        varB4EAC82CA7396A68D541C85D26508E83_1634035166.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized String getReason() {
        String varB4EAC82CA7396A68D541C85D26508E83_1951802594 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1951802594 = mReason;
        varB4EAC82CA7396A68D541C85D26508E83_1951802594.addTaint(getTaint()); //Add taint from parent
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_1757282323 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1757282323 = "state=" + getState() + " apnType=" + mApnType;
        varB4EAC82CA7396A68D541C85D26508E83_1757282323.addTaint(getTaint()); //Add taint from parent
