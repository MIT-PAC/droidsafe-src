...
public class FastXmlSerializer implements XmlSerializer {
    ...
    public XmlSerializer attribute(String namespace, String name, String value) throws IOException,
        ...
        XmlSerializer varB4EAC82CA7396A68D541C85D26508E83_2093470642 = null; 
        append(' ');
        {
            append(namespace);
            append(':');
        ...
        varB4EAC82CA7396A68D541C85D26508E83_2093470642.addTaint(getTaint()); 
    ...
    public XmlSerializer endTag(String namespace, String name) throws IOException,
            IllegalArgumentException, IllegalStateException {
        XmlSerializer varB4EAC82CA7396A68D541C85D26508E83_1857057812 = null; 
        {
            append(" />\n");
        } 
        {
        ...
        addTaint(namespace.getTaint());
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1857057812.addTaint(getTaint()); 
    ...
    public XmlSerializer startTag(String namespace, String name) throws IOException,
            IllegalArgumentException, IllegalStateException {
        XmlSerializer varB4EAC82CA7396A68D541C85D26508E83_748768765 = null; 
        {
            append(">\n");
        } 
        append('<');
        ...
        addTaint(namespace.getTaint());
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_748768765.addTaint(getTaint()); 
    ...
    public XmlSerializer text(char[] buf, int start, int len) throws IOException,
            IllegalArgumentException, IllegalStateException {
        XmlSerializer varB4EAC82CA7396A68D541C85D26508E83_1345747864 = null; 
        {
            append(">");
            mInTag = false;
        } 
        ...
        addTaint(start);
        addTaint(len);
        varB4EAC82CA7396A68D541C85D26508E83_1345747864.addTaint(getTaint()); 
    ...
    public XmlSerializer text(String text) throws IOException, IllegalArgumentException,
            IllegalStateException {
        XmlSerializer varB4EAC82CA7396A68D541C85D26508E83_617591508 = null; 
        {
            append(">");
            mInTag = false;
        } 
        ...
        addTaint(text.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_617591508.addTaint(getTaint()); 
