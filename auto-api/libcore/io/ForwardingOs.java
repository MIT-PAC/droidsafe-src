...
public class ForwardingOs implements Os {
    ...
    public FileDescriptor accept(FileDescriptor fd, InetSocketAddress peerAddress) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_166332208 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_166332208 = os.accept(fd, peerAddress);
        addTaint(fd.getTaint());
        addTaint(peerAddress.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_166332208.addTaint(getTaint()); //Add taint from parent
    ...
    public FileDescriptor dup(FileDescriptor oldFd) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1679281741 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1679281741 = os.dup(oldFd);
        addTaint(oldFd.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1679281741.addTaint(getTaint()); //Add taint from parent
    ...
    public FileDescriptor dup2(FileDescriptor oldFd, int newFd) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1860717987 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1860717987 = os.dup2(oldFd, newFd);
        addTaint(oldFd.getTaint());
        addTaint(newFd);
        varB4EAC82CA7396A68D541C85D26508E83_1860717987.addTaint(getTaint()); //Add taint from parent
    ...
    public String[] environ() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_2137419158 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2137419158 = os.environ();
        varB4EAC82CA7396A68D541C85D26508E83_2137419158.addTaint(getTaint()); //Add taint from parent
    ...
    public StructStat fstat(FileDescriptor fd) throws ErrnoException {
        StructStat varB4EAC82CA7396A68D541C85D26508E83_1201309537 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1201309537 = os.fstat(fd);
        addTaint(fd.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1201309537.addTaint(getTaint()); //Add taint from parent
    ...
    public StructStatFs fstatfs(FileDescriptor fd) throws ErrnoException {
        StructStatFs varB4EAC82CA7396A68D541C85D26508E83_1359306609 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1359306609 = os.fstatfs(fd);
        addTaint(fd.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1359306609.addTaint(getTaint()); //Add taint from parent
    ...
    public String gai_strerror(int error) {
        String varB4EAC82CA7396A68D541C85D26508E83_1166001094 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1166001094 = os.gai_strerror(error);
        addTaint(error);
        varB4EAC82CA7396A68D541C85D26508E83_1166001094.addTaint(getTaint()); //Add taint from parent
    ...
    public InetAddress[] getaddrinfo(String node, StructAddrinfo hints) throws GaiException {
        InetAddress[] varB4EAC82CA7396A68D541C85D26508E83_1911287558 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1911287558 = os.getaddrinfo(node, hints);
        addTaint(node.getTaint());
        addTaint(hints.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1911287558.addTaint(getTaint()); //Add taint from parent
    ...
    public String getenv(String name) {
        String varB4EAC82CA7396A68D541C85D26508E83_1197781696 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1197781696 = os.getenv(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1197781696.addTaint(getTaint()); //Add taint from parent
    ...
    public String getnameinfo(InetAddress address, int flags) throws GaiException {
        String varB4EAC82CA7396A68D541C85D26508E83_1403642071 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1403642071 = os.getnameinfo(address, flags);
        addTaint(address.getTaint());
        addTaint(flags);
        varB4EAC82CA7396A68D541C85D26508E83_1403642071.addTaint(getTaint()); //Add taint from parent
    ...
    public StructPasswd getpwnam(String name) throws ErrnoException {
        StructPasswd varB4EAC82CA7396A68D541C85D26508E83_1974141448 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1974141448 = os.getpwnam(name);
        addTaint(name.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1974141448.addTaint(getTaint()); //Add taint from parent
    ...
    public StructPasswd getpwuid(int uid) throws ErrnoException {
        StructPasswd varB4EAC82CA7396A68D541C85D26508E83_948341899 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_948341899 = os.getpwuid(uid);
        addTaint(uid);
        varB4EAC82CA7396A68D541C85D26508E83_948341899.addTaint(getTaint()); //Add taint from parent
    ...
    public SocketAddress getsockname(FileDescriptor fd) throws ErrnoException {
        SocketAddress varB4EAC82CA7396A68D541C85D26508E83_134722347 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_134722347 = os.getsockname(fd);
        addTaint(fd.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_134722347.addTaint(getTaint()); //Add taint from parent
    ...
    public InetAddress getsockoptInAddr(FileDescriptor fd, int level, int option) throws ErrnoException {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_106549637 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_106549637 = os.getsockoptInAddr(fd, level, option);
        addTaint(fd.getTaint());
        addTaint(level);
        addTaint(option);
        varB4EAC82CA7396A68D541C85D26508E83_106549637.addTaint(getTaint()); //Add taint from parent
    ...
    public StructLinger getsockoptLinger(FileDescriptor fd, int level, int option) throws ErrnoException {
        StructLinger varB4EAC82CA7396A68D541C85D26508E83_1014652608 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1014652608 = os.getsockoptLinger(fd, level, option);
        addTaint(fd.getTaint());
        addTaint(level);
        addTaint(option);
        varB4EAC82CA7396A68D541C85D26508E83_1014652608.addTaint(getTaint()); //Add taint from parent
    ...
    public StructTimeval getsockoptTimeval(FileDescriptor fd, int level, int option) throws ErrnoException {
        StructTimeval varB4EAC82CA7396A68D541C85D26508E83_1439637440 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1439637440 = os.getsockoptTimeval(fd, level, option);
        addTaint(fd.getTaint());
        addTaint(level);
        addTaint(option);
        varB4EAC82CA7396A68D541C85D26508E83_1439637440.addTaint(getTaint()); //Add taint from parent
    ...
    public String if_indextoname(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_1877444243 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1877444243 = os.if_indextoname(index);
        addTaint(index);
        varB4EAC82CA7396A68D541C85D26508E83_1877444243.addTaint(getTaint()); //Add taint from parent
    ...
    public InetAddress inet_pton(int family, String address) {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_1703769894 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1703769894 = os.inet_pton(family, address);
        addTaint(family);
        addTaint(address.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1703769894.addTaint(getTaint()); //Add taint from parent
    ...
    public InetAddress ioctlInetAddress(FileDescriptor fd, int cmd, String interfaceName) throws ErrnoException {
        InetAddress varB4EAC82CA7396A68D541C85D26508E83_1845813344 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1845813344 = os.ioctlInetAddress(fd, cmd, interfaceName);
        addTaint(fd.getTaint());
        addTaint(cmd);
        addTaint(interfaceName.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1845813344.addTaint(getTaint()); //Add taint from parent
    ...
    public StructStat lstat(String path) throws ErrnoException {
        StructStat varB4EAC82CA7396A68D541C85D26508E83_439057283 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_439057283 = os.lstat(path);
        addTaint(path.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_439057283.addTaint(getTaint()); //Add taint from parent
    ...
    public FileDescriptor open(String path, int flags, int mode) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1467783590 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1467783590 = os.open(path, flags, mode);
        addTaint(path.getTaint());
        addTaint(flags);
        addTaint(mode);
        varB4EAC82CA7396A68D541C85D26508E83_1467783590.addTaint(getTaint()); //Add taint from parent
    ...
    public FileDescriptor[] pipe() throws ErrnoException {
        FileDescriptor[] varB4EAC82CA7396A68D541C85D26508E83_353710716 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_353710716 = os.pipe();
        varB4EAC82CA7396A68D541C85D26508E83_353710716.addTaint(getTaint()); //Add taint from parent
    ...
    public FileDescriptor socket(int domain, int type, int protocol) throws ErrnoException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1198136878 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1198136878 = os.socket(domain, type, protocol);
        addTaint(domain);
        addTaint(type);
        addTaint(protocol);
        varB4EAC82CA7396A68D541C85D26508E83_1198136878.addTaint(getTaint()); //Add taint from parent
    ...
    public StructStat stat(String path) throws ErrnoException {
        StructStat varB4EAC82CA7396A68D541C85D26508E83_1111282533 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1111282533 = os.stat(path);
        addTaint(path.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1111282533.addTaint(getTaint()); //Add taint from parent
    ...
    public StructStatFs statfs(String path) throws ErrnoException {
        StructStatFs varB4EAC82CA7396A68D541C85D26508E83_1615590439 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1615590439 = os.statfs(path);
        addTaint(path.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1615590439.addTaint(getTaint()); //Add taint from parent
    ...
    public String strerror(int errno) {
        String varB4EAC82CA7396A68D541C85D26508E83_1611048412 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1611048412 = os.strerror(errno);
        addTaint(errno);
        varB4EAC82CA7396A68D541C85D26508E83_1611048412.addTaint(getTaint()); //Add taint from parent
    ...
    public StructUtsname uname() {
        StructUtsname varB4EAC82CA7396A68D541C85D26508E83_2034951652 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2034951652 = os.uname();
        varB4EAC82CA7396A68D541C85D26508E83_2034951652.addTaint(getTaint()); //Add taint from parent
