...
public final class HttpsHandler extends URLStreamHandler {
    ...
    protected URLConnection openConnection(URL url) throws IOException {
        URLConnection varB4EAC82CA7396A68D541C85D26508E83_924645893 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_924645893 = new HttpsURLConnectionImpl(url, getDefaultPort());
        addTaint(url.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_924645893.addTaint(getTaint()); //Add taint from parent
    ...
    protected URLConnection openConnection(URL url, Proxy proxy) throws IOException {
        URLConnection varB4EAC82CA7396A68D541C85D26508E83_748941299 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_748941299.addTaint(getTaint()); //Add taint from parent
