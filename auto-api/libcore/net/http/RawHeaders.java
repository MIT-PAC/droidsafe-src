...
public final class RawHeaders {
    ...
    public String getStatusLine() {
        String varB4EAC82CA7396A68D541C85D26508E83_1962484270 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1962484270 = statusLine;
        varB4EAC82CA7396A68D541C85D26508E83_1962484270.addTaint(getTaint()); //Add taint from parent
    ...
    public String getResponseMessage() {
        String varB4EAC82CA7396A68D541C85D26508E83_2115850207 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2115850207 = responseMessage;
        varB4EAC82CA7396A68D541C85D26508E83_2115850207.addTaint(getTaint()); //Add taint from parent
    ...
    public String getFieldName(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_260542381 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1898857669 = null; //Variable for return #2
        ...
        addTaint(index);
        String varA7E53CE21691AB073D9660D615818899_1808108677; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1808108677.addTaint(getTaint()); //Add taint from parent
    ...
    public String getValue(int index) {
        String varB4EAC82CA7396A68D541C85D26508E83_534996389 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_469190576 = null; //Variable for return #2
        ...
        addTaint(index);
        String varA7E53CE21691AB073D9660D615818899_1973141435; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1973141435.addTaint(getTaint()); //Add taint from parent
    ...
    public String get(String fieldName) {
        String varB4EAC82CA7396A68D541C85D26508E83_641920140 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1907451771 = null; //Variable for return #2
        {
        ...
        addTaint(fieldName.getTaint());
        String varA7E53CE21691AB073D9660D615818899_926796866; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_926796866.addTaint(getTaint()); //Add taint from parent
    ...
    public RawHeaders getAll(Set<String> fieldNames) {
        RawHeaders varB4EAC82CA7396A68D541C85D26508E83_134216017 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_134216017.addTaint(getTaint()); //Add taint from parent
    ...
    public String toHeaderString() {
        String varB4EAC82CA7396A68D541C85D26508E83_964089485 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_964089485.addTaint(getTaint()); //Add taint from parent
    ...
    public Map<String, List<String>> toMultimap() {
        Map<String, List<String>> varB4EAC82CA7396A68D541C85D26508E83_546309983 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_546309983.addTaint(getTaint()); //Add taint from parent
