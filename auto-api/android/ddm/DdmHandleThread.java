...
public class DdmHandleThread extends ChunkHandler {
    ...
    public Chunk handleChunk(Chunk request) {
        Chunk varB4EAC82CA7396A68D541C85D26508E83_2085612588 = null; //Variable for return #1
        Chunk varB4EAC82CA7396A68D541C85D26508E83_768209179 = null; //Variable for return #2
        Chunk varB4EAC82CA7396A68D541C85D26508E83_999564200 = null; //Variable for return #3
        ...
        Chunk varA7E53CE21691AB073D9660D615818899_874736788; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_874736788.addTaint(getTaint()); //Add taint from parent
    ...
    private Chunk handleTHEN(Chunk request) {
        Chunk varB4EAC82CA7396A68D541C85D26508E83_1781129078 = null; //Variable for return #1
        ByteBuffer in = wrapChunk(request);
        boolean enable = (in.get() != 0);
        DdmVmInternal.threadNotify(enable);
        varB4EAC82CA7396A68D541C85D26508E83_1781129078 = null;
        addTaint(request.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1781129078.addTaint(getTaint()); //Add taint from parent
    ...
    private Chunk handleTHST(Chunk request) {
        Chunk varB4EAC82CA7396A68D541C85D26508E83_692933192 = null; //Variable for return #1
        Chunk varB4EAC82CA7396A68D541C85D26508E83_1719136106 = null; //Variable for return #2
        ByteBuffer in = wrapChunk(request);
        ...
        addTaint(request.getTaint());
        Chunk varA7E53CE21691AB073D9660D615818899_1638869029; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1638869029.addTaint(getTaint()); //Add taint from parent
    ...
    private Chunk handleSTKL(Chunk request) {
        Chunk varB4EAC82CA7396A68D541C85D26508E83_336299697 = null; //Variable for return #1
        Chunk varB4EAC82CA7396A68D541C85D26508E83_644725842 = null; //Variable for return #2
        ByteBuffer in = wrapChunk(request);
        int threadId;
        threadId = in.getInt();
        ...
        addTaint(request.getTaint());
        Chunk varA7E53CE21691AB073D9660D615818899_885318612; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_885318612.addTaint(getTaint()); //Add taint from parent
    ...
    private Chunk createStackChunk(StackTraceElement[] trace, int threadId) {
        Chunk varB4EAC82CA7396A68D541C85D26508E83_338030773 = null; //Variable for return #1
        int bufferSize = 0;
        bufferSize += 4;
        bufferSize += 4;
        bufferSize += 4;
        ...
        addTaint(threadId);
        varB4EAC82CA7396A68D541C85D26508E83_338030773.addTaint(getTaint()); //Add taint from parent
