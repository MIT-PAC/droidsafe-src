...
public final class EmojiFactory {
	...
	public String name() {
		String varB4EAC82CA7396A68D541C85D26508E83_784923669 = null; // Variable
																		// for
																		// return
																		// #1
		varB4EAC82CA7396A68D541C85D26508E83_784923669 = mName;
		varB4EAC82CA7396A68D541C85D26508E83_784923669.addTaint(getTaint()); // Add
																			// taint
																			// from
																			// parent
	...
	public synchronized Bitmap getBitmapFromAndroidPua(int pua) {
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_1075674105 = null; // Variable
																		// for
																		// return
																		// #1
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_1137147639 = null; // Variable
																		// for
																		// return
																		// #2
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_1983840721 = null; // Variable
																		// for
																		// return
																		// #3
		...
		addTaint(pua);
		Bitmap varA7E53CE21691AB073D9660D615818899_2038965472; // Final return
																// value
		...
		varA7E53CE21691AB073D9660D615818899_2038965472.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public synchronized Bitmap getBitmapFromVendorSpecificSjis(char sjis) {
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_1541062137 = null; // Variable
																		// for
																		// return
																		// #1
		varB4EAC82CA7396A68D541C85D26508E83_1541062137 = getBitmapFromAndroidPua(getAndroidPuaFromVendorSpecificSjis(sjis));
		addTaint(sjis);
		varB4EAC82CA7396A68D541C85D26508E83_1541062137.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
		...
		// ---------- Original Method ----------
		// return
		// getBitmapFromAndroidPua(getAndroidPuaFromVendorSpecificSjis(sjis));
	}
	...
	public synchronized Bitmap getBitmapFromVendorSpecificPua(int vsp) {
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_1739316414 = null; // Variable
																		// for
																		// return
																		// #1
		varB4EAC82CA7396A68D541C85D26508E83_1739316414 = getBitmapFromAndroidPua(getAndroidPuaFromVendorSpecificPua(vsp));
		addTaint(vsp);
		varB4EAC82CA7396A68D541C85D26508E83_1739316414.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
		...
		// ---------- Original Method ----------
		// return
		// getBitmapFromAndroidPua(getAndroidPuaFromVendorSpecificPua(vsp));
	}
	...
	public int getAndroidPuaFromVendorSpecificSjis(char sjis) {
		...
		// ---------- Original Method ----------
		// return nativeGetAndroidPuaFromVendorSpecificSjis(mNativeEmojiFactory,
		// sjis);
	}
	...
	public int getVendorSpecificSjisFromAndroidPua(int pua) {
		...
		// ---------- Original Method ----------
		// return nativeGetVendorSpecificSjisFromAndroidPua(mNativeEmojiFactory,
		// pua);
	}
	...
	public int getAndroidPuaFromVendorSpecificPua(int vsp) {
		...
		// ---------- Original Method ----------
		// return nativeGetAndroidPuaFromVendorSpecificPua(mNativeEmojiFactory,
		// vsp);
	}
	...
	public String getAndroidPuaFromVendorSpecificPua(String vspString) {
		String varB4EAC82CA7396A68D541C85D26508E83_1105543467 = null; // Variable
																		// for
																		// return
																		// #1
		String varB4EAC82CA7396A68D541C85D26508E83_1275648027 = null; // Variable
																		// for
																		// return
																		// #2
		{
		...
		String varA7E53CE21691AB073D9660D615818899_1072852029; // Final return
																// value
		switch (DroidSafeAndroidRuntime.switchControl) {
		case 1: // Assign result for return ordinal #1
		...
		varA7E53CE21691AB073D9660D615818899_1072852029.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public int getVendorSpecificPuaFromAndroidPua(int pua) {
		...
		// ---------- Original Method ----------
		// return nativeGetVendorSpecificPuaFromAndroidPua(mNativeEmojiFactory,
		// pua);
	}
	...
	public String getVendorSpecificPuaFromAndroidPua(String puaString) {
		String varB4EAC82CA7396A68D541C85D26508E83_753618903 = null; // Variable
																		// for
																		// return
																		// #1
		String varB4EAC82CA7396A68D541C85D26508E83_1060552897 = null; // Variable
																		// for
																		// return
																		// #2
		{
		...
		String varA7E53CE21691AB073D9660D615818899_795724688; // Final return
																// value
		switch (DroidSafeAndroidRuntime.switchControl) {
		case 1: // Assign result for return ordinal #1
		...
		varA7E53CE21691AB073D9660D615818899_795724688.addTaint(getTaint()); // Add
																			// taint
																			// from
																			// parent
