...
public class LruCache<K, V> {
    ...
    public final V get(K key) {
        V varB4EAC82CA7396A68D541C85D26508E83_151281798 = null; //Variable for return #1
        V varB4EAC82CA7396A68D541C85D26508E83_1789590719 = null; //Variable for return #2
        V varB4EAC82CA7396A68D541C85D26508E83_84310554 = null; //Variable for return #3
        V varB4EAC82CA7396A68D541C85D26508E83_1032342214 = null; //Variable for return #4
        {
        ...
        V varA7E53CE21691AB073D9660D615818899_1069970679; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1069970679.addTaint(getTaint()); //Add taint from parent
    ...
    public final V put(K key, V value) {
        V varB4EAC82CA7396A68D541C85D26508E83_50110971 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_50110971.addTaint(getTaint()); //Add taint from parent
    ...
    public final V remove(K key) {
        V varB4EAC82CA7396A68D541C85D26508E83_643623699 = null; //Variable for return #1
        {
            if (DroidSafeAndroidRuntime.control) throw new NullPointerException("key == null");
        } //End block
        V previous;
        ...
        varB4EAC82CA7396A68D541C85D26508E83_643623699.addTaint(getTaint()); //Add taint from parent
    ...
    protected V create(K key) {
        V varB4EAC82CA7396A68D541C85D26508E83_762464435 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_762464435 = null;
        addTaint(key.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_762464435.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized final Map<K, V> snapshot() {
        Map<K, V> varB4EAC82CA7396A68D541C85D26508E83_2096436125 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2096436125 = new LinkedHashMap<K, V>(map);
        varB4EAC82CA7396A68D541C85D26508E83_2096436125.addTaint(getTaint()); //Add taint from parent
    ...
    public synchronized final String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_523543746 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_523543746.addTaint(getTaint()); //Add taint from parent
