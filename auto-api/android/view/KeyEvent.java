...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final Parcelable.Creator<KeyEvent> CREATOR = new Parcelable.Creator<KeyEvent>() {        
        ...
        public KeyEvent createFromParcel(Parcel in) {
            ...
            in.readInt();
            KeyEvent var03AF82A7FA5057C19F378563FCB46039_495070477 = (KeyEvent.createFromParcelBody(in));
    ...
    public final boolean hasModifiers(int modifiers) {
        ...
        boolean var648F7A9F0962E8E4161828F1E8BA6E46_136445512 = (metaStateHasModifiers(mMetaState, modifiers));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
    ...
    public final KeyCharacterMap getKeyCharacterMap() {
        KeyCharacterMap varBC0AD1CB5BEA5213ACCA573EB70C7169_1946394837 = (KeyCharacterMap.load(mDeviceId));
    ...
    public char getDisplayLabel() {
        char var402815CACAA9DDFAEFEDC0C125FB2994_685018596 = (getKeyCharacterMap().getDisplayLabel(mKeyCode));
    ...
    public int getUnicodeChar(int metaState) {
        dsTaint.addTaint(metaState);
        int varF80F7315F1665EF264F4B56CCC263B71_68416953 = (getKeyCharacterMap().get(mKeyCode, metaState));
        return dsTaint.getTaintInt();
        // ---------- Original Method ----------
    ...
    public boolean getKeyData(KeyData results) {
        ...
        boolean var9311F07A06D0009CABF0BB59BF9F1F37_1675787848 = (getKeyCharacterMap().getKeyData(mKeyCode, results));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
    ...
    public char getMatch(char[] chars, int metaState) {
        dsTaint.addTaint(metaState);
        dsTaint.addTaint(chars);
        char varB61CD108FAACC946B9AA0DE89FD2060B_385075345 = (getKeyCharacterMap().getMatch(mKeyCode, chars, metaState));
        return dsTaint.getTaintChar();
        // ---------- Original Method ----------
    ...
    public char getNumber() {
        char varB4F648281DAF3DD70FE46CEDEBEDC863_562662531 = (getKeyCharacterMap().getNumber(mKeyCode));
        return dsTaint.getTaintChar();
        // ---------- Original Method ----------
    ...
    public boolean isPrintingKey() {
        boolean varF8D3C8E19AA06F294286F3275CCB7518_1348847471 = (getKeyCharacterMap().isPrintingKey(mKeyCode));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
    ...
    public final boolean dispatch(Callback receiver) {
        ...
        boolean varC90D4E641E4ACDB8930DA9EB1973CAAD_981454393 = (dispatch(receiver, null, null));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
    ...
    public final boolean dispatch(Callback receiver, DispatcherState state,
        ...
        //Begin case ACTION_DOWN 
        {
            ...
            res = receiver.onKeyDown(mKeyCode, this);
            {
                ...
                {
                    boolean var15107DBA9F13C4EA3AFAF1BF65D7423F_539373097 = (isLongPress() && state.isTracking(this));
                    {
                        try 
                        {
                            {
                                boolean varEA4A626A3C3882CC4284F222EB564648_1942609030 = (receiver.onKeyLongPress(mKeyCode, this));
                                {
        ...
        //End case ACTION_UP 
        //Begin case ACTION_UP 
        boolean var6AE796001B04D3F5946E38C8232FB430_773070096 = (receiver.onKeyUp(mKeyCode, this));
        //End case ACTION_UP 
        ...
        //Begin case ACTION_MULTIPLE 
        {
            boolean varCD86412E58971559452CF2B6E9A652F6_1885825225 = (receiver.onKeyMultiple(code, count, this));
        } //End collapsed parenthetic
        //End case ACTION_MULTIPLE 
        //Begin case ACTION_MULTIPLE 
        {
    ...
    public static class DispatcherState {
        ...
        public void startTracking(KeyEvent event, Object target) {
            ...
            dsTaint.addTaint(target.dsTaint);
            {
                boolean varEFF761F3EEED65C62FBA77AF5B033178_1588306977 = (event.getAction() != ACTION_DOWN);
                {
        ...
        public boolean isTracking(KeyEvent event) {
            dsTaint.addTaint(event.dsTaint);
            boolean var296CB63EF97B12631998C71582F3F238_103873787 = (mDownKeyCode == event.getKeyCode());
            return dsTaint.getTaintBoolean();
            // ---------- Original Method ----------
