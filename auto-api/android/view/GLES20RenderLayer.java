...
class GLES20RenderLayer extends GLES20Layer {
    ...
    @Override
     HardwareCanvas getCanvas() {
        HardwareCanvas varB4EAC82CA7396A68D541C85D26508E83_1497283529 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1497283529 = mCanvas;
        varB4EAC82CA7396A68D541C85D26508E83_1497283529.addTaint(getTaint()); 
    ...
    @Override
     HardwareCanvas start(Canvas currentCanvas) {
        HardwareCanvas varB4EAC82CA7396A68D541C85D26508E83_251689840 = null; 
        {
            ((GLES20Canvas) currentCanvas).interrupt();
        } 
        varB4EAC82CA7396A68D541C85D26508E83_251689840 = getCanvas();
        addTaint(currentCanvas.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_251689840.addTaint(getTaint()); 
