...
class FileLoader extends StreamLoader {
    ...
    private String errString(Exception ex) {
        String varB4EAC82CA7396A68D541C85D26508E83_1706160810 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1706160810.addTaint(getTaint()); //Add taint from parent
