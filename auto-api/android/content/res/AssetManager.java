...
public final class AssetManager {
    ...
    final CharSequence getResourceText(int ident) {
        dsTaint.addTaint(ident);
        {
            ...
            {
                {
                    CharSequence var747A6D32C3D82F99223EF45CF3A73B35_908349664 = (mStringBlocks[block].get(tmpValue.data));
                } //End block
                CharSequence var5200720FC65BCF35BAA60FEC9418BD99_192952946 = (tmpValue.coerceToString());
            } //End block
        } //End block
    ...
    final CharSequence getResourceBagText(int ident, int bagEntryId) {
        ...
        dsTaint.addTaint(bagEntryId);
        {
            ...
            {
                {
                    CharSequence var747A6D32C3D82F99223EF45CF3A73B35_1979198788 = (mStringBlocks[block].get(tmpValue.data));
                } //End block
                CharSequence var5200720FC65BCF35BAA60FEC9418BD99_485005715 = (tmpValue.coerceToString());
            } //End block
        } //End block
        return dsTaint.getTaintString();
        // ---------- Original Method ----------
    ...
    final CharSequence getPooledString(int block, int id) {
        ...
        CharSequence var2FB0EBD01C989B705B8AA64E1D1A9B7D_1340910356 = (mStringBlocks[block-1].get(id));
        return dsTaint.getTaintString();
        // ---------- Original Method ----------
    ...
    public final InputStream open(String fileName) throws IOException {
        ...
        InputStream varAB31E48FA16E0E586786604F8F82CDBD_1601911570 = (open(fileName, ACCESS_STREAMING));
    ...
    public final InputStream openNonAsset(String fileName) throws IOException {
        ...
        dsTaint.addTaint(fileName);
        InputStream var9605422D6A5365A30A544F5BC8368736_699785084 = (openNonAsset(0, fileName, ACCESS_STREAMING));
        return (InputStream)dsTaint.getTaint();
        // ---------- Original Method ----------
    ...
    public final InputStream openNonAsset(String fileName, int accessMode) throws IOException {
        ...
        dsTaint.addTaint(accessMode);
        dsTaint.addTaint(fileName);
        InputStream var211B711A11721A99A7A9A4493EFF5C8A_2137703916 = (openNonAsset(0, fileName, accessMode));
        return (InputStream)dsTaint.getTaint();
        // ---------- Original Method ----------
    ...
    public final InputStream openNonAsset(int cookie, String fileName) throws IOException {
        ...
        dsTaint.addTaint(fileName);
        InputStream var2A361830EC5B7807729DAC3457304EB9_1277340770 = (openNonAsset(cookie, fileName, ACCESS_STREAMING));
        return (InputStream)dsTaint.getTaint();
        // ---------- Original Method ----------
    ...
    public final AssetFileDescriptor openNonAssetFd(String fileName) throws IOException {
        //DSFIXME:  CODE0009: Possible callback target function detected
        dsTaint.addTaint(fileName);
        AssetFileDescriptor var8DF85496AD417EDB3C857E07FCD09E5E_1864916810 = (openNonAssetFd(0, fileName));
        return (AssetFileDescriptor)dsTaint.getTaint();
        // ---------- Original Method ----------
    ...
    public final XmlResourceParser openXmlResourceParser(String fileName) throws IOException {
        dsTaint.addTaint(fileName);
        XmlResourceParser varB3244557841A22C57996A99C43B66DE3_1261018421 = (openXmlResourceParser(0, fileName));
    ...
    final XmlBlock openXmlBlockAsset(String fileName) throws IOException {
        dsTaint.addTaint(fileName);
        XmlBlock varC0FD185D2A2B5D1F9928F67BA2682B32_1110428166 = (openXmlBlockAsset(0, fileName));
        ...
        {
            {
                {
                    {
                        Iterator<RuntimeException> seatecAstronomy42 = mRefStacks.values().iterator();
    ...
    public final class AssetInputStream extends InputStream {
        ...
        public final int read(byte[] b) throws IOException {
            dsTaint.addTaint(b);
            int var3CAE9971BC75CFC378BD3B49F33BE480_224390218 = (readAsset(mAsset, b, 0, b.length));
            return dsTaint.getTaintInt();
            // ---------- Original Method ----------
        ...
        public final int read(byte[] b, int off, int len) throws IOException {
            ...
            dsTaint.addTaint(off);
            dsTaint.addTaint(len);
            int var1CBB9CD65705D33AD4651F0428BDA301_376728318 = (readAsset(mAsset, b, off, len));
            return dsTaint.getTaintInt();
            // ---------- Original Method ----------
