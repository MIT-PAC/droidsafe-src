...
public final class Bitmap implements Parcelable {
	...
	public Bitmap copy(Config config, boolean isMutable) {
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_1358647877 = null; // Variable
																		// for
																		// return
																		// #1
		...
		addTaint(isMutable);
		varB4EAC82CA7396A68D541C85D26508E83_1358647877.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public final int getHeight() {
		...
		// ---------- Original Method ----------
		// return mHeight == -1 ? mHeight = nativeHeight(mNativeBitmap) :
		// mHeight;
	}
	...
	public final Config getConfig() {
		Config varB4EAC82CA7396A68D541C85D26508E83_110213994 = null; // Variable
																		// for
																		// return
																		// #1
		varB4EAC82CA7396A68D541C85D26508E83_110213994 = Config.nativeToConfig(nativeConfig(mNativeBitmap));
		varB4EAC82CA7396A68D541C85D26508E83_110213994.addTaint(getTaint()); // Add
																			// taint
																			// from
																			// parent
	...
	public Bitmap extractAlpha() {
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_1790324847 = null; // Variable
																		// for
																		// return
																		// #1
		varB4EAC82CA7396A68D541C85D26508E83_1790324847 = extractAlpha(null, null);
		varB4EAC82CA7396A68D541C85D26508E83_1790324847.addTaint(getTaint()); // Add
																				// taint
																				// from
																				// parent
	...
	public Bitmap extractAlpha(Paint paint, int[] offsetXY) {
		Bitmap varB4EAC82CA7396A68D541C85D26508E83_203314352 = null; // Variable
																		// for
																		// return
																		// #1
		...
		addTaint(offsetXY[0]);
		varB4EAC82CA7396A68D541C85D26508E83_203314352.addTaint(getTaint()); // Add
																			// taint
																			// from
																			// parent
