...
public class Interpolator {
    ...
    public Result timeToValues(float[] values) {
        Result varB4EAC82CA7396A68D541C85D26508E83_891222495 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_891222495 = timeToValues((int)SystemClock.uptimeMillis(), values);
        addTaint(values[0]);
        varB4EAC82CA7396A68D541C85D26508E83_891222495.addTaint(getTaint()); //Add taint from parent
    ...
    public Result timeToValues(int msec, float[] values) {
        Result varB4EAC82CA7396A68D541C85D26508E83_476406546 = null; //Variable for return #1
        Result varB4EAC82CA7396A68D541C85D26508E83_307346954 = null; //Variable for return #2
        Result varB4EAC82CA7396A68D541C85D26508E83_1266953575 = null; //Variable for return #3
        {
            if (DroidSafeAndroidRuntime.control) throw new ArrayStoreException();
        } //End block
        {
        ...
        addTaint(msec);
        addTaint(values[0]);
        Result varA7E53CE21691AB073D9660D615818899_1465346939; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1465346939.addTaint(getTaint()); //Add taint from parent
