...
public class ActivityManager {
    ...
    public List<RecentTaskInfo> getRecentTasks(int maxNum, int flags) throws SecurityException {
        List<RecentTaskInfo> varB4EAC82CA7396A68D541C85D26508E83_1916390342 = null; //Variable for return #1
        List<RecentTaskInfo> varB4EAC82CA7396A68D541C85D26508E83_520121874 = null; //Variable for return #2
        try 
        {
        ...
        addTaint(maxNum);
        addTaint(flags);
        List<RecentTaskInfo> varA7E53CE21691AB073D9660D615818899_1602029236; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_1602029236.addTaint(getTaint()); //Add taint from parent
    ...
    public List<RunningTaskInfo> getRunningTasks(int maxNum, int flags, IThumbnailReceiver receiver) throws SecurityException {
        List<RunningTaskInfo> varB4EAC82CA7396A68D541C85D26508E83_1997871953 = null; //Variable for return #1
        List<RunningTaskInfo> varB4EAC82CA7396A68D541C85D26508E83_962701541 = null; //Variable for return #2
        try 
        {
        ...
        List<RunningTaskInfo> varA7E53CE21691AB073D9660D615818899_294091813; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_294091813.addTaint(getTaint()); //Add taint from parent
    ...
    public List<RunningTaskInfo> getRunningTasks(int maxNum) throws SecurityException {
        List<RunningTaskInfo> varB4EAC82CA7396A68D541C85D26508E83_1960314857 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1960314857 = getRunningTasks(maxNum, 0, null);
        addTaint(maxNum);
        varB4EAC82CA7396A68D541C85D26508E83_1960314857.addTaint(getTaint()); //Add taint from parent
    ...
    public TaskThumbnails getTaskThumbnails(int id) throws SecurityException {
        TaskThumbnails varB4EAC82CA7396A68D541C85D26508E83_2097368933 = null; //Variable for return #1
        TaskThumbnails varB4EAC82CA7396A68D541C85D26508E83_1933909064 = null; //Variable for return #2
        try 
        {
        ...
        addTaint(id);
        TaskThumbnails varA7E53CE21691AB073D9660D615818899_382198491; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_382198491.addTaint(getTaint()); //Add taint from parent
    ...
    public List<RunningServiceInfo> getRunningServices(int maxNum) throws SecurityException {
        List<RunningServiceInfo> varB4EAC82CA7396A68D541C85D26508E83_846400479 = null; //Variable for return #1
        List<RunningServiceInfo> varB4EAC82CA7396A68D541C85D26508E83_1202351948 = null; //Variable for return #2
        try 
        {
        ...
        addTaint(maxNum);
        List<RunningServiceInfo> varA7E53CE21691AB073D9660D615818899_173431190; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_173431190.addTaint(getTaint()); //Add taint from parent
    ...
    public PendingIntent getRunningServiceControlPanel(ComponentName service) throws SecurityException {
        PendingIntent varB4EAC82CA7396A68D541C85D26508E83_856962038 = null; //Variable for return #1
        PendingIntent varB4EAC82CA7396A68D541C85D26508E83_736445918 = null; //Variable for return #2
        try 
        {
        ...
        PendingIntent varA7E53CE21691AB073D9660D615818899_278117552; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_278117552.addTaint(getTaint()); //Add taint from parent
    ...
    public List<ProcessErrorStateInfo> getProcessesInErrorState() {
        List<ProcessErrorStateInfo> varB4EAC82CA7396A68D541C85D26508E83_1832651555 = null; //Variable for return #1
        List<ProcessErrorStateInfo> varB4EAC82CA7396A68D541C85D26508E83_554186424 = null; //Variable for return #2
        try 
        {
        ...
        List<ProcessErrorStateInfo> varA7E53CE21691AB073D9660D615818899_1736746946; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1736746946.addTaint(getTaint()); //Add taint from parent
    ...
    public List<ApplicationInfo> getRunningExternalApplications() {
        List<ApplicationInfo> varB4EAC82CA7396A68D541C85D26508E83_1840113386 = null; //Variable for return #1
        List<ApplicationInfo> varB4EAC82CA7396A68D541C85D26508E83_78927457 = null; //Variable for return #2
        try 
        {
        ...
        List<ApplicationInfo> varA7E53CE21691AB073D9660D615818899_1301403161; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1301403161.addTaint(getTaint()); //Add taint from parent
    ...
    public List<RunningAppProcessInfo> getRunningAppProcesses() {
        List<RunningAppProcessInfo> varB4EAC82CA7396A68D541C85D26508E83_325700236 = null; //Variable for return #1
        List<RunningAppProcessInfo> varB4EAC82CA7396A68D541C85D26508E83_836419734 = null; //Variable for return #2
        try 
        {
        ...
        List<RunningAppProcessInfo> varA7E53CE21691AB073D9660D615818899_871743211; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_871743211.addTaint(getTaint()); //Add taint from parent
    ...
    public Debug.MemoryInfo[] getProcessMemoryInfo(int[] pids) {
        Debug.MemoryInfo[] varB4EAC82CA7396A68D541C85D26508E83_948591984 = null; //Variable for return #1
        Debug.MemoryInfo[] varB4EAC82CA7396A68D541C85D26508E83_20340257 = null; //Variable for return #2
        try 
        {
        ...
        addTaint(pids[0]);
        Debug.MemoryInfo[] varA7E53CE21691AB073D9660D615818899_19572056; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_19572056.addTaint(getTaint()); //Add taint from parent
    ...
    public ConfigurationInfo getDeviceConfigurationInfo() {
        ConfigurationInfo varB4EAC82CA7396A68D541C85D26508E83_1967256331 = null; //Variable for return #1
        ConfigurationInfo varB4EAC82CA7396A68D541C85D26508E83_2031251103 = null; //Variable for return #2
        try 
        {
        ...
        ConfigurationInfo varA7E53CE21691AB073D9660D615818899_1085521791; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1085521791.addTaint(getTaint()); //Add taint from parent
    ...
    public PkgUsageStats[] getAllPackageUsageStats() {
        PkgUsageStats[] varB4EAC82CA7396A68D541C85D26508E83_156569116 = null; //Variable for return #1
        PkgUsageStats[] varB4EAC82CA7396A68D541C85D26508E83_1281699375 = null; //Variable for return #2
        try 
        {
        ...
        PkgUsageStats[] varA7E53CE21691AB073D9660D615818899_1717462693; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1717462693.addTaint(getTaint()); //Add taint from parent
    ...
    public static class TaskThumbnails implements Parcelable {
        ...
        public Bitmap getSubThumbnail(int index) {
            Bitmap varB4EAC82CA7396A68D541C85D26508E83_207372580 = null; //Variable for return #1
            Bitmap varB4EAC82CA7396A68D541C85D26508E83_1432961055 = null; //Variable for return #2
            try 
            {
            ...
            addTaint(index);
            Bitmap varA7E53CE21691AB073D9660D615818899_914227280; //Final return value
            switch (DroidSafeAndroidRuntime.switchControl) {
                case 1: //Assign result for return ordinal #1
            ...
            varA7E53CE21691AB073D9660D615818899_914227280.addTaint(getTaint()); //Add taint from parent
