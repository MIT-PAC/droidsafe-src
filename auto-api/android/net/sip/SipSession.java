...
public final class SipSession {
    ...
    public String getLocalIp() {
        try 
        {
            String var0ADCD22A05C2B1D0284B748801B30A93_2074890904 = (mSession.getLocalIp());
        } //End block
        catch (RemoteException e)
        { }
    ...
    public SipProfile getLocalProfile() {
        try 
        {
            SipProfile var5E1E1E65123BEE29A9CB22EAD573CFD8_1902832524 = (mSession.getLocalProfile());
        } //End block
        catch (RemoteException e)
        { }
    ...
    public SipProfile getPeerProfile() {
        try 
        {
            SipProfile varA061DC31E8E2562D99E981A239D7EED5_752172555 = (mSession.getPeerProfile());
        } //End block
        catch (RemoteException e)
        { }
        return (SipProfile)dsTaint.getTaint();
    ...
    public int getState() {
        try 
        {
            int var5C9BD891D63C83243CB7DCB3EA826EE9_1681928348 = (mSession.getState());
        } //End block
        catch (RemoteException e)
        { }
    ...
    public boolean isInCall() {
        try 
        {
            boolean var756F7B5AF584B3E3C76961D5CC547EFB_903212054 = (mSession.isInCall());
        } //End block
        catch (RemoteException e)
        { }
    ...
    public String getCallId() {
        try 
        {
            String varE47AB60BE9B4BCFFEC05E6A601322D1F_2088487529 = (mSession.getCallId());
        } //End block
        catch (RemoteException e)
        { }
        return dsTaint.getTaintString();
