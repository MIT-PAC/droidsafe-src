...
class PagerTitleStripIcs {
    ...
    private static class SingleLineAllCapsTransform extends SingleLineTransformationMethod {
        ...
        public CharSequence getTransformation(CharSequence source, View view) {
            CharSequence varB4EAC82CA7396A68D541C85D26508E83_1204676340 = null; //Variable for return #1
            source = super.getTransformation(source, view);
            varB4EAC82CA7396A68D541C85D26508E83_1204676340 = source != null ? source.toString().toUpperCase(mLocale) : null;
            addTaint(source.getTaint());
            addTaint(view.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_1204676340.addTaint(getTaint()); //Add taint from parent
