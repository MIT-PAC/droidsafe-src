...
public class ParcelableCompat {
    ...
    static class CompatCreator<T> implements Parcelable.Creator<T> {
        ...
        public T createFromParcel(Parcel source) {
            T varB4EAC82CA7396A68D541C85D26508E83_1508600748 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_1508600748 = mCallbacks.createFromParcel(source, null);
            addTaint(source.getTaint());
            varB4EAC82CA7396A68D541C85D26508E83_1508600748.addTaint(getTaint()); //Add taint from parent
        ...
        public T[] newArray(int size) {
            T[] varB4EAC82CA7396A68D541C85D26508E83_494777887 = null; //Variable for return #1
            varB4EAC82CA7396A68D541C85D26508E83_494777887 = mCallbacks.newArray(size);
            addTaint(size);
            varB4EAC82CA7396A68D541C85D26508E83_494777887.addTaint(getTaint()); //Add taint from parent
