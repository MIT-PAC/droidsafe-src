...
class CursorFilter extends Filter {
    ...
    public CharSequence convertResultToString(Object resultValue) {
        CharSequence varB4EAC82CA7396A68D541C85D26508E83_778685910 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_778685910 = mClient.convertToString((Cursor) resultValue);
        addTaint(resultValue.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_778685910.addTaint(getTaint()); //Add taint from parent
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        FilterResults varB4EAC82CA7396A68D541C85D26508E83_1988419070 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1988419070.addTaint(getTaint()); //Add taint from parent
