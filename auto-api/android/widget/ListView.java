...
public class ListView extends AbsListView {
    ...
    public int getHeaderViewsCount() {
        int var51EB21BA6322BC21883B38109F793DB7_1020600479 = (mHeaderViewInfos.size());
        return dsTaint.getTaintInt();
        // ---------- Original Method ----------
    ...
    public boolean removeHeaderView(View v) {
        dsTaint.addTaint(v.dsTaint);
        {
            boolean varFC339A57DD06D9F6F47BBD3A88B06E10_343013477 = (mHeaderViewInfos.size() > 0);
            {
                boolean result;
                result = false;
                {
                    boolean var9BFD45A2F2990893F8C6EA8C90DB82AA_1753428130 = (mAdapter != null && ((HeaderViewListAdapter) mAdapter).removeHeader(v));
                    {
                        {
                            mDataSetObserver.onChanged();
                        } //End block
    ...
    public int getFooterViewsCount() {
        int var05D2A206262A11BE7E645CDC53B4074D_20617839 = (mFooterViewInfos.size());
        return dsTaint.getTaintInt();
        // ---------- Original Method ----------
    ...
    public boolean removeFooterView(View v) {
        dsTaint.addTaint(v.dsTaint);
        {
            boolean var16785181560AF1EBB84626B752BB868A_1465349529 = (mFooterViewInfos.size() > 0);
            {
                boolean result;
                result = false;
                {
                    boolean var9C4812C55FB91AE0FCF1729C742654B1_1080804465 = (mAdapter != null && ((HeaderViewListAdapter) mAdapter).removeFooter(v));
                    {
                        {
                            mDataSetObserver.onChanged();
                        } //End block
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        mRecycler.clear();
        {
            boolean var424DAEFA84C4CC446223C4E25F5F060B_1182732816 = (mHeaderViewInfos.size() > 0|| mFooterViewInfos.size() > 0);
            {
    ...
    private boolean showingTopFadingEdge() {
        ...
        boolean varCCBED360491DE804AB67732329ABF3EB_2086633923 = ((mFirstPosition > 0) || (getChildAt(0).getTop() > listTop));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
    ...
    public boolean requestChildRectangleOnScreen(View child, Rect rect, boolean immediate) {
        ...
        {
            {
                boolean var1852437954D6FC93B41EE304F855C339_927792044 = (rect.height() > height);
                {
        ...
        {
            {
                boolean var1852437954D6FC93B41EE304F855C339_1378121851 = (rect.height() > height);
                {
    ...
    private View fillFromTop(int nextTop) {
        ...
        View varBC3312FAE5DAD2D4DA02F3A8FDDCF8D0_1960110493 = (fillDown(mFirstPosition, nextTop));
        return (View)dsTaint.getTaint();
        // ---------- Original Method ----------
        //mFirstPosition = Math.min(mFirstPosition, mSelectedPosition);
        //mFirstPosition = Math.min(mFirstPosition, mItemCount - 1);
    ...
    private View fillFromSelection(int selectedTop, int childrenTop, int childrenBottom) {
        ...
        {
            boolean varBFC41726DC719E4AF23B91CEB6FCBE3E_898021140 = (sel.getBottom() > bottomSelectionPixel);
            {
            ...
            {
                boolean var14C65EDD6D5526A3271EC007E995AA33_1087825664 = (sel.getTop() < topSelectionPixel);
                {
                    final int spaceAbove;
    ...
    private View moveSelection(View oldSel, View newSel, int delta, int childrenTop,
                ...
                selectedPosition);
        {
            ...
            sel = makeAndAddView(selectedPosition, oldSel.getBottom() + dividerHeight, true,
                    mListPadding.left, true);
            {
                boolean var809044946283DBF63F29397A5670A6D0_1319842570 = (sel.getBottom() > bottomSelectionPixel);
                {
                    int spaceAbove;
                    spaceAbove = sel.getTop() - topSelectionPixel;
                    int spaceBelow;
        ...
        } //End block
        {
            ...
            {
                boolean var14C65EDD6D5526A3271EC007E995AA33_719601420 = (sel.getTop() < topSelectionPixel);
                {
                    int spaceAbove;
                    spaceAbove = topSelectionPixel - sel.getTop();
                    int spaceBelow;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mItemCount = mAdapter == null ? 0 : mAdapter.getCount();
        {
            ...
            {
                boolean varEB7649CB6D51B846BFB1D35E91D4E330_109676319 = (recycleOnMeasure() && mRecycler.shouldRecycleViewType(
    ...
    final int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition,
        ...
        isScrap = mIsScrap;
        {
            i = startPosition;
            {
                ...
                {
                    boolean var533FFAA3904216431C0F5E425FC7EAF1_1842765288 = (recyle && recycleBin.shouldRecycleViewType(
                    ((LayoutParams) child.getLayoutParams()).viewType));
                    {
            ...
            {
                {
                    ...
                    i = 0;
                    {
                        ...
                        v = getChildAt(i);
                        {
                            boolean var737FD9EF3BFA62490E57511E301591D9_1102472858 = (y <= v.getBottom());
                        } //End collapsed parenthetic
                    } //End block
                } //End collapsed parenthetic
            } //End block
            {
                {
                    ...
                    i = childCount - 1;
                    {
                        ...
                        v = getChildAt(i);
                        {
                            boolean varE7C2FBE8C17E6A36CCD2B0AC678BC146_869199421 = (y >= v.getTop());
                        } //End collapsed parenthetic
                    } //End block
                } //End collapsed parenthetic
            } //End block
    ...
    protected void layoutChildren() {
        ...
        try 
        {
            ...
            {
                boolean varA298A0CB79AEDD2E132E7DADF2F1B74D_1348409580 = (mItemCount != mAdapter.getCount());
                {
            ...
            {
                {
                    boolean var9085EE91A28170DA4ACA96D9BF477D88_313196392 = (mItemsCanFocus && hasFocus() && !sel.hasFocus());
                    {
            ...
            {
                boolean var371628C1F86A56F688D98D9EF6B87E07_252783079 = (focusLayoutRestoreView != null
    ...
    private boolean isDirectChildHeaderOrFooter(View child) {
        ...
        numHeaders = headers.size();
        {
            ...
            {
                {
                    boolean var2E97F2DD1ECC5E322C5090F5951EC49E_256530202 = (child == headers.get(i).view);
                } //End collapsed parenthetic
            } //End block
        } //End collapsed parenthetic
        ...
        numFooters = footers.size();
        {
            ...
            {
                {
                    boolean varA845DE916470E49791E6F275395553FA_1125362397 = (child == footers.get(i).view);
                } //End collapsed parenthetic
            } //End block
        } //End collapsed parenthetic
        return dsTaint.getTaintBoolean();
    ...
    private void setupChild(View child, int position, int y, boolean flowDown, int childrenLeft,
        ...
        } //End block
        {
            ...
            {
                boolean var6B8ECFCCB35D70022AE775423EF95EFF_651106050 = (getContext().getApplicationInfo().targetSdkVersion
        ...
        {
            boolean varFE983D8157D9C3BB7AF96BB07D8A50F7_1943307480 = (mCachingStarted && !child.isDrawingCacheEnabled());
            {
                child.setDrawingCacheEnabled(true);
            } //End block
        } //End collapsed parenthetic
        {
            boolean varCA9C9DB394586E5C1281E2A995FFCD63_1988569713 = (recycled && (((AbsListView.LayoutParams)child.getLayoutParams()).scrappedFromPosition)
                != position);
            {
    ...
    protected boolean canAnimate() {
        boolean varDA480D2F8FF037BACA5DB54A8FBF9642_1134092885 = (super.canAnimate() && mItemCount > 0);
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
        ...
        {
            {
                ...
                {
                    boolean varF9E3A5AB0092C9F908FE41D43CDE1F43_1880647955 = (position < count && !adapter.isEnabled(position));
                    {
                        position++;
                    } //End block
                } //End collapsed parenthetic
            } //End block
            {
                ...
                {
                    boolean var86CF05D4F4C580D8A474D386CDE84CF9_519685611 = (position >= 0 && !adapter.isEnabled(position));
                    {
                        position--;
                    } //End block
                } //End collapsed parenthetic
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        handled = super.dispatchKeyEvent(event);
        {
            ...
            focused = getFocusedChild();
            {
                boolean varD6F50D5E6BAAF6A4042506AB741CE740_1652603774 = (focused != null && event.getAction() == KeyEvent.ACTION_DOWN);
                {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        dsTaint.addTaint(event.dsTaint);
        boolean var7B6BE27715D36B6032CB7DA2718D4FF1_969671088 = (commonKey(keyCode, 1, event));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
    ...
    public boolean onKeyMultiple(int keyCode, int repeatCount, KeyEvent event) {
        ...
        boolean varACEC8A58158104BC4BBB2FE543212B03_44639931 = (commonKey(keyCode, repeatCount, event));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        dsTaint.addTaint(keyCode);
        dsTaint.addTaint(event.dsTaint);
        boolean var7B6BE27715D36B6032CB7DA2718D4FF1_1029206093 = (commonKey(keyCode, 1, event));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
        //return commonKey(keyCode, 1, event);
    }
    ...
    private boolean commonKey(int keyCode, int count, KeyEvent event) {
        ...
        action = event.getAction();
        {
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_1519082579 = (event.hasNoModifiers());
                {
                ...
                {
                    boolean varAB36CD08CFCE6244F546B808D5F456D4_60372687 = (event.hasModifiers(KeyEvent.META_ALT_ON));
                    {
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_1332914032 = (event.hasNoModifiers());
                {
                    handled = resurrectSelectionIfNeeded();
                    {
                        {
                ...
                {
                    boolean varAB36CD08CFCE6244F546B808D5F456D4_1828245040 = (event.hasModifiers(KeyEvent.META_ALT_ON));
                    {
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_489612125 = (event.hasNoModifiers());
                {
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_1120045696 = (event.hasNoModifiers());
                {
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_1810253264 = (event.hasNoModifiers());
                {
                    handled = resurrectSelectionIfNeeded();
                    {
            ...
            {
                boolean varC5267D5BFE7A3E261BDE80A07A8ECCFA_1109104599 = (mPopup == null || !mPopup.isShowing());
                {
                    {
                        boolean var3A3095F7575E47050F710FB26AF5006E_570177592 = (event.hasNoModifiers());
                        {
                            handled = resurrectSelectionIfNeeded() || pageScroll(FOCUS_DOWN);
                        } //End block
                        {
                            boolean varC6F58190DE4A31A0CF9704EF99A62451_1406499314 = (event.hasModifiers(KeyEvent.META_SHIFT_ON));
                            {
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_1694631038 = (event.hasNoModifiers());
                {
                    handled = resurrectSelectionIfNeeded() || pageScroll(FOCUS_UP);
                } //End block
                {
                    boolean varAB36CD08CFCE6244F546B808D5F456D4_1358363534 = (event.hasModifiers(KeyEvent.META_ALT_ON));
                    {
                        handled = resurrectSelectionIfNeeded() || fullScroll(FOCUS_UP);
                    } //End block
                } //End collapsed parenthetic
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_650464591 = (event.hasNoModifiers());
                {
                    handled = resurrectSelectionIfNeeded() || pageScroll(FOCUS_DOWN);
                } //End block
                {
                    boolean varAB36CD08CFCE6244F546B808D5F456D4_1027470224 = (event.hasModifiers(KeyEvent.META_ALT_ON));
                    {
                        handled = resurrectSelectionIfNeeded() || fullScroll(FOCUS_DOWN);
                    } //End block
                } //End collapsed parenthetic
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_842778261 = (event.hasNoModifiers());
                {
                    handled = resurrectSelectionIfNeeded() || fullScroll(FOCUS_UP);
                } //End block
            } //End collapsed parenthetic
            ...
            {
                boolean var01265F35364458CD2A88FFB15C2C1B92_812664848 = (event.hasNoModifiers());
                {
                    handled = resurrectSelectionIfNeeded() || fullScroll(FOCUS_DOWN);
                } //End block
            } //End collapsed parenthetic
            ...
            {
                {
                    boolean varC77C0C11194BD87DFEE086A32DCE5C18_1628799913 = (event.hasNoModifiers());
                    {
                        handled = resurrectSelectionIfNeeded() || arrowScroll(FOCUS_DOWN);
                    } //End block
                    {
                        boolean var7B1040B2192949CFC257B6EE7F25C319_358035334 = (event.hasModifiers(KeyEvent.META_SHIFT_ON));
                        {
        ...
        {
            boolean varF6449376E291BB335EF050093EE80110_1994463380 = (sendToTextFilter(keyCode, count, event));
        } //End collapsed parenthetic
        //Begin case KeyEvent.ACTION_DOWN 
        boolean var8C6E6C19273FC56B5C56CC7DEF63ED7B_1260971650 = (super.onKeyDown(keyCode, event));
        //End case KeyEvent.ACTION_DOWN 
        //Begin case KeyEvent.ACTION_UP 
        boolean varEDD771EBF66425AD21882AB08CD0EE48_1498727121 = (super.onKeyUp(keyCode, event));
        //End case KeyEvent.ACTION_UP 
        //Begin case KeyEvent.ACTION_MULTIPLE 
        boolean varC0357E39557DD275ECAF43C782C78502_687978959 = (super.onKeyMultiple(keyCode, count, event));
     ...
     boolean pageScroll(int direction) {
        ...
        } //End block
        {
            ...
            position = lookForSelectablePosition(nextPage, down);
            {
                ...
                {
                    boolean varA164A5303752DF647D9BF6996D101837_1538604425 = (down && position > mItemCount - getChildCount());
                    {
    ...
    private boolean handleHorizontalFocusWithinListItem(int direction) {
        ...
        numChildren = getChildCount();
        {
            ...
            {
                boolean var5A370CFD3CE8F716DF439EFB07635CD0_879253447 = (selectedView != null && selectedView.hasFocus() &&
                    selectedView instanceof ViewGroup);
                {
                        ...
                        (ViewGroup) selectedView, currentFocus, direction);
                    {
                        ...
                        {
                            boolean var76D8898CFBC448597F15A4BC0E876792_1268909338 = (nextFocus.requestFocus(direction, mTempRect));
                        } //End collapsed parenthetic
                    } //End block
                    ...
                    {
                        boolean varB2F32E25506228F03370ADE074F28912_1573872977 = (isViewAncestorOf(globalNextFocus, this));
                    } //End block
                } //End block
            } //End collapsed parenthetic
        } //End block
    ...
    private boolean arrowScrollImpl(int direction) {
        ...
        final ArrowScrollFocusResult focusResult;
        ...
        {
            boolean varB8E5D6C0579FB6C2780425B3D1ABD141_855837889 = (mItemsCanFocus && (focusResult == null)
                && selectedView != null && selectedView.hasFocus());
            {
                final View focused;
                focused = selectedView.findFocus();
                {
                    boolean var3BB0A88B4E6FC6416F98323008226B4B_2013347477 = (!isViewAncestorOf(focused, this) || distanceToView(focused) > 0);
                    {
                        focused.clearFocus();
                    } //End block
                } //End collapsed parenthetic
        ...
        {
            boolean var089D086D835620A272CDDA708424B586_596239455 = (nextSelectedPosition == INVALID_POSITION && selectedView != null
    ...
    private void measureAndAdjustDown(View child, int childIndex, int numChildren) {
        ...
        measureItem(child);
        {
            boolean var7B22EF90C45277911AB272B76E96E5DA_2082014703 = (child.getMeasuredHeight() != oldHeight);
            {
    ...
    private int getArrowScrollPreviewLength() {
        int var32C3DF276D4CC5AB85EAD318AE4B92AE_1449696667 = (Math.max(MIN_SCROLL_PREVIEW_PIXELS, getVerticalFadingEdgeLength()));
        return dsTaint.getTaintInt();
        // ---------- Original Method ----------
    ...
    private int amountToScroll(int direction, int nextSelectedPosition) {
        ...
        numChildren = getChildCount();
        {
            ...
            {
                boolean var5F736F6450B740E6E9E57C387C57D4DD_679448115 = (viewToMakeVisible.getBottom() <= goalBottom);
            } //End collapsed parenthetic
            {
                boolean var8324A997C3E5144DDD35F3BF25EFB670_327563943 = (nextSelectedPosition != INVALID_POSITION
            ...
            int var1934DA7AFCB63592141CB73FE3F03962_1481432678 = (Math.min(amountToScroll, getMaxScrollAmount()));
        } //End block
        {
            int indexToMakeVisible;
            ...
            {
                boolean var40E2B917BF16844A067981F2A72A29CC_261060950 = (viewToMakeVisible.getTop() >= goalTop);
            } //End collapsed parenthetic
            {
                boolean varC22CD0C0296052301FAE425C57E08A6B_1015866320 = (nextSelectedPosition != INVALID_POSITION &&
            ...
            int var1934DA7AFCB63592141CB73FE3F03962_1363194120 = (Math.min(amountToScroll, getMaxScrollAmount()));
        } //End block
        return dsTaint.getTaintInt();
        // ---------- Original Method ----------
        // Original Method Too Long, Refer to Original Implementation
    ...
    private int lookForSelectablePositionOnScreen(int direction) {
        ...
        firstPosition = mFirstPosition;
        {
            ...
            {
                boolean varFD8F153F7B9B0445D1C8B98618EA7E23_950989444 = (startPos >= mAdapter.getCount());
            } //End collapsed parenthetic
            {
                startPos = firstPosition;
            } //End block
            ...
            adapter = getAdapter();
            {
                ...
                {
                    {
                        boolean var705701EB8E699AA442E2F4E862DC96E7_944833240 = (adapter.isEnabled(pos)
        ...
        } //End block
        {
            ...
            {
                boolean var52FACA214769BF23A240C7E957876F70_2077619591 = (startPos < 0 || startPos >= mAdapter.getCount());
            } //End collapsed parenthetic
            {
                startPos = last;
            } //End block
            ...
            adapter = getAdapter();
            {
                ...
                {
                    {
                        boolean var705701EB8E699AA442E2F4E862DC96E7_1528179305 = (adapter.isEnabled(pos)
                        && getChildAt(pos - firstPosition).getVisibility() == View.VISIBLE);
                    } //End collapsed parenthetic
                } //End block
            } //End collapsed parenthetic
    ...
    private ArrowScrollFocusResult arrowScrollFocused(final int direction) {
        ...
        View newFocus;
        {
            boolean varA1513A08695E8074CF4C05D652884B2C_753467391 = (selectedView != null && selectedView.hasFocus());
            {
                View oldFocus;
            ...
            {
                {
                    ...
                    boolean var0C9DFED1B79DF626EEB83B6645BDE791_674340204 = ((selectedView != null && selectedView.getTop() > listTop));
                ...
                } //End block
                {
                    ...
                    final int ySearchPoint;
                    boolean var535C017266C0FE7A092B0CC38B96CB22_1851086298 = ((selectedView != null && selectedView.getBottom() < listBottom));
    ...
    private int positionOfNewFocus(View newFocus) {
        ...
        numChildren = getChildCount();
        {
            ...
            i = 0;
            {
                ...
                child = getChildAt(i);
                {
                    boolean var743CF1855186FF404A0881633A428604_899185573 = (isViewAncestorOf(newFocus, child));
                } //End collapsed parenthetic
            } //End block
        } //End collapsed parenthetic
    ...
    private boolean isViewAncestorOf(View child, View parent) {
        ...
        boolean var31AD4BA23C577C9A637BA02E579FD0B2_598816079 = ((theParent instanceof ViewGroup) && isViewAncestorOf((View) theParent, parent));
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
        //if (child == parent) {
            //return true;
    ...
    private void scrollListItemsBy(int amount) {
        ...
        recycleBin = mRecycler;
        {
            ...
            {
                boolean var5F1380678D3DF277A8634CE4F78FA5E2_809424582 = (last.getBottom() < listBottom);
                {
                    final int lastVisiblePosition;
            ...
            {
                boolean var5F1380678D3DF277A8634CE4F78FA5E2_1859603352 = (last.getBottom() < listBottom);
                {
            ...
            first = getChildAt(0);
            {
                boolean var5DEAA936426734BA7061F416FF8C6D22_174794262 = (first.getBottom() < listTop);
                {
                    AbsListView.LayoutParams layoutParams;
                    layoutParams = (LayoutParams) first.getLayoutParams();
                    {
                        boolean var2ED08FF5DD3428B26AE67127DC8E5467_434997313 = (recycleBin.shouldRecycleViewType(layoutParams.viewType));
                        {
        ...
        } //End block
        {
            ...
            first = getChildAt(0);
            {
                boolean var4D6C61E96E1628FDB98784EB678A415B_1055384848 = ((first.getTop() > listTop) && (mFirstPosition > 0));
                {
            ...
            {
                boolean varEA4423DF7697B0235733DDAA9E5B11E5_312562508 = (first.getTop() > listTop);
                {
            ...
            {
                boolean var6CFFE8EA59E4FF6F1E1615BCEB3548F9_835884994 = (last.getTop() > listBottom);
                {
                    AbsListView.LayoutParams layoutParams;
                    layoutParams = (LayoutParams) last.getLayoutParams();
                    {
                        boolean var2ED08FF5DD3428B26AE67127DC8E5467_709739131 = (recycleBin.shouldRecycleViewType(layoutParams.viewType));
                        {
    ...
    public boolean isOpaque() {
                ...
                hasOpaqueScrollbars()) || super.isOpaque();
        {
            ...
            first = getChildAt(0);
            {
                boolean var37967F45E1391B4313D5330FBE659A90_667247148 = (first == null || first.getTop() > listTop);
            } //End collapsed parenthetic
            final int listBottom;
            ...
            {
                boolean varA905B41E3DA83EC3F86F88778ACFCAD2_1862014909 = (last == null || last.getBottom() < listBottom);
            } //End collapsed parenthetic
        } //End block
        return dsTaint.getTaintBoolean();
        // ---------- Original Method ----------
                    ...
                    {
                        {
                            ...
                            {
                                {
                                    boolean var6726FD4BAAAC9954E951547807371C28_413190838 = ((areAllItemsSelectable ||
                    ...
                    {
                        {
                            ...
                            {
                                {
                                    boolean var6726FD4BAAAC9954E951547807371C28_1332125819 = ((areAllItemsSelectable ||
                                    (adapter.isEnabled(first + i) && (i == count - 1 ||
                                            adapter.isEnabled(first + i + 1)))));
                                    {
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        closestChildTop = 0;
        {
            ...
            {
                boolean var834FA86141DD35F45E58D6AC3B8AC266_1767453773 = (adapter.getCount() < getChildCount() + mFirstPosition);
                {
                    mLayoutMode = LAYOUT_NORMAL;
                    layoutChildren();
                } //End block
            ...
            firstPosition = mFirstPosition;
            {
                ...
                {
                    {
                        boolean varF0493CBC36FEE8A37314533655677361_1145526357 = (!adapter.isEnabled(firstPosition + i));
                    } //End collapsed parenthetic
                    View other;
                    other = getChildAt(i);
        ...
        dsTaint.addTaint(where.dsTaint);
        {
            ...
            View v;
            {
                ...
                i = 0;
                {
                    v = where.get(i).view;
                    {
                        boolean var3F751ABEC959446BA6608C20A1A0BA91_1615077492 = (!v.isRootNamespace());
                        {
                            v = v.findViewById(id);
                        } //End block
                    } //End collapsed parenthetic
        ...
        dsTaint.addTaint(where.dsTaint);
        {
            ...
            View v;
            {
                ...
                i = 0;
                {
                    v = where.get(i).view;
                    {
                        boolean var3F751ABEC959446BA6608C20A1A0BA91_944594246 = (!v.isRootNamespace());
                        {
        ...
        dsTaint.addTaint(where.dsTaint);
        {
            ...
            View v;
            {
                ...
                i = 0;
                {
                    v = where.get(i).view;
                    {
                        boolean varE559F145C9972D4F93FC59CF981B09D2_673286627 = (v != childToSkip && !v.isRootNamespace());
                        {
    ...
    public long[] getCheckItemIds() {
        {
            boolean var92A5B2B773F784D23AACADEC549061AE_1606781501 = (mAdapter != null && mAdapter.hasStableIds());
            {
        ...
        } //End collapsed parenthetic
        {
            ...
            checkedCount = 0;
            {
                ...
                {
                    {
                        boolean var06DB0322BE5DDF244F3C57344F69D711_905401677 = (states.valueAt(i));
                        {
