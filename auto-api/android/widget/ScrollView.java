...
public class ScrollView extends FrameLayout {
	...
	public ScrollView(Context context, AttributeSet attrs, int defStyle) {
		...
		a = context.obtainStyledAttributes(attrs,
				com.android.internal.R.styleable.ScrollView, defStyle, 0);
		setFillViewport(a
				.getBoolean(R.styleable.ScrollView_fillViewport, false));
		a.recycle();
		// ---------- Original Method ----------
		// initScrollView();
		// TypedArray a =
	...
	private boolean canScroll() {
		...
		child = getChildAt(0);
		{
			...
			boolean var3A415DE46D6A024E28376F2A13A712DB_1348625665 = (getHeight() < childHeight
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		heightMode = MeasureSpec.getMode(heightMeasureSpec);
		{
			boolean varBF62E6C23FE36C17A3594E034FF46D2E_46807107 = (getChildCount() > 0);
			{
				...
				{
					boolean varEEEC94D0CC5FB640673872B86A985E2B_622448380 = (child
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		...
		boolean var160A6DCE359009EE36E492A233BEB313_116338913 = (super
				.dispatchKeyEvent(event) || executeKeyEvent(event));
		return dsTaint.getTaintBoolean();
		// ---------- Original Method ----------
	...
	public boolean executeKeyEvent(KeyEvent event) {
		...
		mTempRect.setEmpty();
		{
			...
			{
				{
					boolean var2897164B636FEEE3DA92631EEF7087B0_921835001 = (isFocused() && event
		...
		handled = false;
		{
			boolean varE78E9647F4429F5955AD42D05C6FEF7A_1126471087 = (event
					.getAction() == KeyEvent.ACTION_DOWN);
			{
				{
					Object varA0761DC6508339A4AD5D875712ADE561_265226116 = (event
							.getKeyCode());
					// Begin case KeyEvent.KEYCODE_DPAD_UP
					{
						boolean var6263B7F37C2CF1348DCC37C937DB4EA5_1081463865 = (!event
								.isAltPressed());
						{
					...
					{
						boolean var6263B7F37C2CF1348DCC37C937DB4EA5_385635754 = (!event
								.isAltPressed());
						{
	...
	private boolean inChild(int x, int y) {
		...
		dsTaint.addTaint(x);
		{
			boolean varBF62E6C23FE36C17A3594E034FF46D2E_1379537818 = (getChildCount() > 0);
			{
				...
				final View child;
				child = getChildAt(0);
				boolean varB6F197A68897B2FF8EC1E9EDD5403361_1917636618 = (!(y < child
						.getTop() - scrollY
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
			...
			// Begin case MotionEvent.ACTION_DOWN
		{
			...
			y = ev.getY();
			{
				boolean varFF34B1086FC4594476FFD6F360BBB78C_953865958 = (!inChild(
						(int) ev.getX(), (int) y));
				{
		...
		// Begin case MotionEvent.ACTION_CANCEL MotionEvent.ACTION_UP
		{
			boolean var5A644DDFA364D0381E7012BF55F348DC_1320765443 = (mScroller
					.springBack(mScrollX, mScrollY, 0, 0, 0, getScrollRange()));
			{
				invalidate();
			} // End block
		} // End collapsed parenthetic
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		// Begin case MotionEvent.ACTION_DOWN
		{
			...
			{
				boolean var11F6C92CC339B9B3B7C0C85A8DBD1165_2076715150 = (!mScroller
						.isFinished());
				{
			...
			// Begin case MotionEvent.ACTION_MOVE
		{
			...
			{
				boolean var670E8200B9D4E089C7377D895DE2F86E_96124209 = (overScrollBy(
						0, deltaY, 0, mScrollY, 0, range, 0,
			...
			onScrollChanged(mScrollX, mScrollY, oldX, oldY);
			{
				...
				pulledToY = oldY + deltaY;
				{
					...
					{
						boolean varE6213428B20479BD32BF17B140F5ED52_2007803219 = (!mEdgeGlowBottom
								.isFinished());
						{
				...
				} // End block
				{
					...
					{
						boolean var5D6A56784A8F83A042E55ED0998DBE18_537508846 = (!mEdgeGlowTop
								.isFinished());
						{
				...
				{
					boolean var4BAAB9D93C535A28BF0C04887423354C_885326500 = (mEdgeGlowTop != null && (!mEdgeGlowTop
							.isFinished() || !mEdgeGlowBottom.isFinished()));
					{
						invalidate();
					} // End block
				} // End collapsed parenthetic
			...
			// Begin case MotionEvent.ACTION_UP
		{
					...
					.getYVelocity(mActivePointerId);
			{
				...
				{
					{
						boolean varCB55D3BE2E93A2FD55EF78A581740AFC_174672553 = ((Math
								.abs(initialVelocity) > mMinimumVelocity));
						{
							fling(-initialVelocity);
						} // End block
						{
							{
								boolean varC93C7034440DD4C8753F4F2114A84A37_1700788864 = (mScroller
										.springBack(mScrollX, mScrollY, 0, 0,
												0, getScrollRange()));
								{
									invalidate();
								} // End block
			...
			// Begin case MotionEvent.ACTION_CANCEL
		{
			...
			{
				{
					boolean var0B94B4CD263DE1DB92077C5CA547FAC2_685520382 = (mScroller
							.springBack(mScrollX, mScrollY, 0, 0, 0,
									getScrollRange()));
					{
						invalidate();
					} // End block
	...
	public boolean onGenericMotionEvent(MotionEvent event) {
		...
		dsTaint.addTaint(event.dsTaint);
		{
			boolean varB5CEEFE1A0B0FE6CF2A2378211A03C4D_598160035 = ((event
					.getSource() & InputDevice.SOURCE_CLASS_POINTER) != 0);
			{
				{
					Object varC2BF00F96F1D1B1ABEF4B0E3FC4FE9EC_989284049 = (event
							.getAction());
		...
		boolean var32C1E3DF40BCC120C79428C7AEB27DD1_61486938 = (super
	...
	protected void onOverScrolled(int scrollX, int scrollY, boolean clampedX,
		...
		{
			boolean var2844BA5E42FD344CC642021B350DFDAC_90345655 = (!mScroller
					.isFinished());
			{
				mScrollX = scrollX;
				mScrollY = scrollY;
				...
				{
					mScroller.springBack(mScrollX, mScrollY, 0, 0, 0,
							getScrollRange());
				} // End block
			} // End block
			{
	...
	private View findFocusableViewInMyBounds(final boolean topFocus,
		...
		bottomWithoutFadingEdge = top + getHeight() - fadingEdgeLength;
		{
			boolean var779C321780A81D8A63D26CAE3AB982D5_797269810 = ((preferredFocusable != null)
					&& (preferredFocusable.getTop() < bottomWithoutFadingEdge) && (preferredFocusable
					.getBottom() > topWithoutFadingEdge));
		} // End collapsed parenthetic
		View var2D76BFFA63757AA84DF2D0B11412E529_1827974761 = (findFocusableViewInBounds(
			...
			i = 0;
			{
				...
				viewBottom = view.getBottom();
				{
					...
					} // End block
					{
						...
						viewIsCloserToBoundary = (topFocus && viewTop < focusCandidate
								.getTop())
	...
	public boolean pageScroll(int direction) {
		...
		height = getHeight();
		{
			...
			count = getChildCount();
			{
				...
				{
					boolean varED85C349B0DA33BB45D7B420A69B2E3A_1171422975 = (mTempRect.top
		...
		boolean var39A84547F8736C141B73A0089E5E641A_512047372 = (scrollAndFocus(
				direction, mTempRect.top, mTempRect.bottom));
		return dsTaint.getTaintBoolean();
		// ---------- Original Method ----------
	...
	public boolean fullScroll(int direction) {
		...
		boolean var39A84547F8736C141B73A0089E5E641A_592198143 = (scrollAndFocus(
				direction, mTempRect.top, mTempRect.bottom));
		return dsTaint.getTaintBoolean();
		// ---------- Original Method ----------
		// boolean down = direction == View.FOCUS_DOWN;
	...
	public boolean arrowScroll(int direction) {
		...
		{
			boolean var9D8E7BEB7B2A9A39F141F9B559F28F2E_1901634128 = (nextFocused != null && isWithinDeltaOfScreen(
					nextFocused, maxJump, getHeight()));
			{
			...
			} // End block
			{
					...
					{
						{
							boolean varB8CB178E8413E8F52B580007177C5576_1792014961 = (getChildCount() > 0);
							{
								...
								int screenBottom;
								screenBottom = getScrollY() + getHeight()
										- mPaddingBottom;
								{
				...
				doScrollY(direction == View.FOCUS_DOWN ? scrollDelta
						: -scrollDelta);
			} // End block
		} // End collapsed parenthetic
		{
			boolean var42D708BBCBC43DF6E5AC106D419B282D_951748128 = (currentFocused != null
					&& currentFocused.isFocused() && isOffScreen(currentFocused));
			{
	...
	private boolean isOffScreen(View descendant) {
		...
		boolean varE152D8C04578A7B6775C0B5DD4F62EE3_1036189723 = (!isWithinDeltaOfScreen(
				descendant, 0, getHeight()));
		return dsTaint.getTaintBoolean();
		// ---------- Original Method ----------
	...
	private boolean isWithinDeltaOfScreen(View descendant, int delta, int height) {
		...
		boolean varF9194AE0C6867682D5312FCB54F0ABEF_882610563 = ((mTempRect.bottom + delta) >= getScrollY() && (mTempRect.top - delta) <= (getScrollY() + height));
		return dsTaint.getTaintBoolean();
		// ---------- Original Method ----------
		// descendant.getDrawingRect(mTempRect);
		// offsetDescendantRectToMyCoords(descendant, mTempRect);
	...
	public final void smoothScrollBy(int dx, int dy) {
		...
		{
			{
				boolean var11F6C92CC339B9B3B7C0C85A8DBD1165_676812470 = (!mScroller
						.isFinished());
				{
					mScroller.abortAnimation();
					{
	...
	protected int computeVerticalScrollOffset() {
		int varEB30566907E969E358CA3C9E47523092_1313241431 = (Math.max(0,
	...
	protected void measureChildWithMargins(View child,
		...
		childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(lp.topMargin
	...
	public void computeScroll() {
		{
			boolean varE7DE5EF6873640B86AA94D9EE969CCF1_1920660020 = (mScroller
					.computeScrollOffset());
			{
				int oldX;
				oldX = mScrollX;
				...
				y = mScroller.getCurrY();
				{
					...
					canOverscroll = overscrollMode == OVER_SCROLL_ALWAYS
							|| (overscrollMode == OVER_SCROLL_IF_CONTENT_SCROLLS && range > 0);
					overScrollBy(x - oldX, y - oldY, oldX, oldY, 0, range, 0,
							mOverflingDistance, false);
					onScrollChanged(mScrollX, mScrollY, oldX, oldY);
					{
						{
							mEdgeGlowTop.onAbsorb((int) mScroller
									.getCurrVelocity());
						} // End block
						{
	...
	private void scrollToChild(View child) {
		...
		scrollDelta = computeScrollDeltaToGetChildRectOnScreen(mTempRect);
		{
			...
			// offsetDescendantRectToMyCoords(child, mTempRect);
			// int scrollDelta =
			// computeScrollDeltaToGetChildRectOnScreen(mTempRect);
			// if (scrollDelta != 0) {
			// scrollBy(0, scrollDelta);
		// }
	}
	...
	protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
		...
		{
			boolean var21EF5215D3173B9EEA5879484954AC40_936784872 = (rect.bottom < getChildAt(
					0).getHeight());
			{
		...
		{
			{
				boolean var1852437954D6FC93B41EE304F855C339_241585542 = (rect
						.height() > height);
				{
		...
		{
			{
				boolean var1852437954D6FC93B41EE304F855C339_1306451408 = (rect
						.height() > height);
				{
	...
	protected boolean onRequestFocusInDescendants(int direction,
		...
		View nextFocus;
		nextFocus = FocusFinder.getInstance().findNextFocus(this, null,
				direction);
		...
		boolean varBB06A889CCA25ED822B35181716FFE90_169700569 = (nextFocus
	...
	public boolean requestChildRectangleOnScreen(View child, Rect rectangle,
		...
		rectangle.offset(child.getLeft() - child.getScrollX(), child.getTop()
				- child.getScrollY());
		boolean var9EED5F05118BACEED05952D173A9E219_478502313 = (scrollToChildRect(
				rectangle, immediate));
		return dsTaint.getTaintBoolean();
		// ---------- Original Method ----------
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		{
			boolean varFEFF39315B1161E387E3A3BC8A5B6333_998377988 = (mChildToScrollTo != null && isViewDescendantOf(
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		currentFocused = findFocus();
		{
			boolean varCE6D2EB5D4D2223694B6B3F92A2E212D_1414050488 = (isWithinDeltaOfScreen(
					currentFocused, 0, oldh));
			{
	...
	private boolean isViewDescendantOf(View child, View parent) {
		...
		boolean var948A486C9D980B3FCF5DD6DC234D8E28_618184019 = ((theParent instanceof ViewGroup) && isViewDescendantOf(
		...
		// return (theParent instanceof ViewGroup) && isViewDescendantOf((View)
		// theParent, parent);
	}
			...
			boolean varBF62E6C23FE36C17A3594E034FF46D2E_1880962520 = (getChildCount() > 0);
			{
				...
				movingDown = velocityY > 0;
				{
					mFlingStrictSpan = StrictMode
							.enterCriticalSpan("ScrollView-fling");
				} // End block
				invalidate();
			} // End block
		} // End collapsed parenthetic
	...
	public void scrollTo(int x, int y) {
		...
		dsTaint.addTaint(x);
		{
			boolean varBF62E6C23FE36C17A3594E034FF46D2E_369677421 = (getChildCount() > 0);
			{
				View child;
				child = getChildAt(0);
				x = clamp(x, getWidth() - mPaddingRight - mPaddingLeft,
						child.getWidth());
				y = clamp(y, getHeight() - mPaddingBottom - mPaddingTop,
						child.getHeight());
				{
					super.scrollTo(x, y);
				} // End block
	...
	public void draw(Canvas canvas) {
		...
		super.draw(canvas);
		{
			...
			scrollY = mScrollY;
			{
				boolean varD7662701013542BC2CCE8B2B50437EBA_1279595428 = (!mEdgeGlowTop
						.isFinished());
				{
					...
					{
						boolean varAE9426D05B3D52BFC4B9E7AA44588485_1961450636 = (mEdgeGlowTop
								.draw(canvas));
						{
							invalidate();
						} // End block
			...
			{
				boolean var71AB611E918A4C599E2F06D4154D257E_1643073205 = (!mEdgeGlowBottom
						.isFinished());
				{
					final int restoreCount;
					restoreCount = canvas.save();
					...
					{
						boolean var61CCF9557D478E1494862B3636E22888_2123303654 = (mEdgeGlowBottom
								.draw(canvas));
						{
							invalidate();
						} // End block
