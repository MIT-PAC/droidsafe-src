...
public class CursorWrapper implements Cursor {
    ...
    public Cursor getWrappedCursor() {
        Cursor varB4EAC82CA7396A68D541C85D26508E83_1879271703 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1879271703 = mCursor;
        varB4EAC82CA7396A68D541C85D26508E83_1879271703.addTaint(getTaint()); //Add taint from parent
    ...
    public String getColumnName(int columnIndex) {
        String varB4EAC82CA7396A68D541C85D26508E83_1339747668 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1339747668 = mCursor.getColumnName(columnIndex);
        addTaint(columnIndex);
        varB4EAC82CA7396A68D541C85D26508E83_1339747668.addTaint(getTaint()); //Add taint from parent
    ...
    public String[] getColumnNames() {
        String[] varB4EAC82CA7396A68D541C85D26508E83_1628001303 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1628001303 = mCursor.getColumnNames();
        varB4EAC82CA7396A68D541C85D26508E83_1628001303.addTaint(getTaint()); //Add taint from parent
    ...
    public Bundle getExtras() {
        Bundle varB4EAC82CA7396A68D541C85D26508E83_1862993564 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1862993564 = mCursor.getExtras();
        varB4EAC82CA7396A68D541C85D26508E83_1862993564.addTaint(getTaint()); //Add taint from parent
    ...
    public String getString(int columnIndex) {
        String varB4EAC82CA7396A68D541C85D26508E83_990651189 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_990651189 = mCursor.getString(columnIndex);
        addTaint(columnIndex);
        varB4EAC82CA7396A68D541C85D26508E83_990651189.addTaint(getTaint()); //Add taint from parent
    ...
    public Bundle respond(Bundle extras) {
        Bundle varB4EAC82CA7396A68D541C85D26508E83_1319398182 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1319398182 = mCursor.respond(extras);
        addTaint(extras.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1319398182.addTaint(getTaint()); //Add taint from parent
