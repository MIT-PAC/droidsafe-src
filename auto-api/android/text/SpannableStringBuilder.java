...
public class SpannableStringBuilder implements CharSequence, GetChars, Spannable, Editable, Appendable, GraphicsOperations {
    ...
    public SpannableStringBuilder insert(int where, CharSequence tb, int start, int end) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_1760667176 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1760667176 = replace(where, where, tb, start, end);
        addTaint(where);
        addTaint(tb.getTaint());
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_1760667176.addTaint(getTaint()); 
    ...
    public SpannableStringBuilder insert(int where, CharSequence tb) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_848244916 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_848244916 = replace(where, where, tb, 0, tb.length());
        addTaint(where);
        addTaint(tb.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_848244916.addTaint(getTaint()); 
    ...
    public SpannableStringBuilder delete(int start, int end) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_878866725 = null; 
        ...
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_878866725.addTaint(getTaint()); 
    ...
    public SpannableStringBuilder append(CharSequence text) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_1284771337 = null; 
        int length = length();
        varB4EAC82CA7396A68D541C85D26508E83_1284771337 = replace(length, length, text, 0, text.length());
        addTaint(text.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_1284771337.addTaint(getTaint()); 
    ...
    public SpannableStringBuilder append(CharSequence text, int start, int end) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_1850767627 = null; 
        int length = length();
        varB4EAC82CA7396A68D541C85D26508E83_1850767627 = replace(length, length, text, start, end);
        addTaint(text.getTaint());
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_1850767627.addTaint(getTaint()); 
    ...
    public SpannableStringBuilder append(char text) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_1405766072 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1405766072 = append(String.valueOf(text));
        addTaint(text);
        varB4EAC82CA7396A68D541C85D26508E83_1405766072.addTaint(getTaint()); 
    ...
    public SpannableStringBuilder replace(int start, int end, CharSequence tb) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_183422925 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_183422925 = replace(start, end, tb, 0, tb.length());
        addTaint(start);
        addTaint(end);
        addTaint(tb.getTaint());
        varB4EAC82CA7396A68D541C85D26508E83_183422925.addTaint(getTaint()); 
    ...
    public SpannableStringBuilder replace(final int start, final int end,
                        CharSequence tb, int tbstart, int tbend) {
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_387466459 = null; 
        SpannableStringBuilder varB4EAC82CA7396A68D541C85D26508E83_559070622 = null; 
        ...
        addTaint(tbstart);
        addTaint(tbend);
        SpannableStringBuilder varA7E53CE21691AB073D9660D615818899_579365624; 
        ...
        varA7E53CE21691AB073D9660D615818899_579365624.addTaint(getTaint()); 
    ...
    public <T> T[] getSpans(int queryStart, int queryEnd, Class<T> kind) {
        T[] varB4EAC82CA7396A68D541C85D26508E83_649577911 = null; 
        T[] varB4EAC82CA7396A68D541C85D26508E83_1499889893 = null; 
        T[] varB4EAC82CA7396A68D541C85D26508E83_985376558 = null; 
        T[] varB4EAC82CA7396A68D541C85D26508E83_2018599506 = null; 
        T[] varB4EAC82CA7396A68D541C85D26508E83_51973712 = null; 
        ...
        T[] varA7E53CE21691AB073D9660D615818899_1698488120; 
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: 
        ...
        varA7E53CE21691AB073D9660D615818899_1698488120.addTaint(getTaint()); 
    ...
    public CharSequence subSequence(int start, int end) {
        CharSequence varB4EAC82CA7396A68D541C85D26508E83_1816976493 = null; 
        varB4EAC82CA7396A68D541C85D26508E83_1816976493 = new SpannableStringBuilder(this, start, end);
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_1816976493.addTaint(getTaint()); 
    ...
    public String toString() {
        String varB4EAC82CA7396A68D541C85D26508E83_1356898451 = null; 
        int len = length();
        char[] buf = new char[len];
        getChars(0, len, buf, 0);
        varB4EAC82CA7396A68D541C85D26508E83_1356898451 = new String(buf);
        varB4EAC82CA7396A68D541C85D26508E83_1356898451.addTaint(getTaint()); 
    ...
    public String substring(int start, int end) {
        String varB4EAC82CA7396A68D541C85D26508E83_802030505 = null; 
        char[] buf = new char[end - start];
        getChars(start, end, buf, 0);
        varB4EAC82CA7396A68D541C85D26508E83_802030505 = new String(buf);
        addTaint(start);
        addTaint(end);
        varB4EAC82CA7396A68D541C85D26508E83_802030505.addTaint(getTaint()); 
    ...
    private TextWatcher[] sendTextWillChange(int start, int before, int after) {
        TextWatcher[] varB4EAC82CA7396A68D541C85D26508E83_393336738 = null; 
        ...
        addTaint(before);
        addTaint(after);
        varB4EAC82CA7396A68D541C85D26508E83_393336738.addTaint(getTaint()); 
    ...
    public InputFilter[] getFilters() {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1168719714.addTaint(getTaint()); 
