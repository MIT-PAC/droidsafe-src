...
public class LocationManager {
    ...
    private LocationProvider createProvider(String name, Bundle info) {
        LocationProvider varB4EAC82CA7396A68D541C85D26508E83_1041305507 = null; //Variable for return #1
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1041305507.addTaint(getTaint()); //Add taint from parent
    ...
    public List<String> getAllProviders() {
        List<String> varB4EAC82CA7396A68D541C85D26508E83_1658135258 = null; //Variable for return #1
        List<String> varB4EAC82CA7396A68D541C85D26508E83_1883443363 = null; //Variable for return #2
        {
        ...
        List<String> varA7E53CE21691AB073D9660D615818899_321241727; //Final return value
        ...
        varA7E53CE21691AB073D9660D615818899_321241727.addTaint(getTaint()); //Add taint from parent
    ...
    public List<String> getProviders(boolean enabledOnly) {
        List<String> varB4EAC82CA7396A68D541C85D26508E83_479032703 = null; //Variable for return #1
        List<String> varB4EAC82CA7396A68D541C85D26508E83_333918716 = null; //Variable for return #2
        try 
        {
        ...
        List<String> varA7E53CE21691AB073D9660D615818899_264983932; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_264983932.addTaint(getTaint()); //Add taint from parent
    ...
    public LocationProvider getProvider(String name) {
        LocationProvider varB4EAC82CA7396A68D541C85D26508E83_1425115592 = null; //Variable for return #1
        LocationProvider varB4EAC82CA7396A68D541C85D26508E83_562543230 = null; //Variable for return #2
        LocationProvider varB4EAC82CA7396A68D541C85D26508E83_1743498038 = null; //Variable for return #3
        {
        ...
        addTaint(name.getTaint());
        LocationProvider varA7E53CE21691AB073D9660D615818899_1187125240; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1187125240.addTaint(getTaint()); //Add taint from parent
    ...
    public List<String> getProviders(Criteria criteria, boolean enabledOnly) {
        List<String> varB4EAC82CA7396A68D541C85D26508E83_395413540 = null; //Variable for return #1
        List<String> varB4EAC82CA7396A68D541C85D26508E83_1409679352 = null; //Variable for return #2
        {
        ...
        addTaint(enabledOnly);
        List<String> varA7E53CE21691AB073D9660D615818899_1368037673; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1368037673.addTaint(getTaint()); //Add taint from parent
    ...
    public String getBestProvider(Criteria criteria, boolean enabledOnly) {
        String varB4EAC82CA7396A68D541C85D26508E83_621879854 = null; //Variable for return #1
        String varB4EAC82CA7396A68D541C85D26508E83_1621320830 = null; //Variable for return #2
        {
            if (DroidSafeAndroidRuntime.control) throw new IllegalArgumentException("criteria==null");
        } //End block
        try 
        ...
        addTaint(criteria.getTaint());
        addTaint(enabledOnly);
        String varA7E53CE21691AB073D9660D615818899_357668427; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_357668427.addTaint(getTaint()); //Add taint from parent
    ...
    public Location getLastKnownLocation(String provider) {
        Location varB4EAC82CA7396A68D541C85D26508E83_245039790 = null; //Variable for return #1
        Location varB4EAC82CA7396A68D541C85D26508E83_499452235 = null; //Variable for return #2
        {
            if (DroidSafeAndroidRuntime.control) throw new IllegalArgumentException("provider==null");
        } //End block
        try 
        ...
        addTaint(provider.getTaint());
        Location varA7E53CE21691AB073D9660D615818899_1766093507; //Final return value
        switch (DroidSafeAndroidRuntime.switchControl) {
            case 1: //Assign result for return ordinal #1
        ...
        varA7E53CE21691AB073D9660D615818899_1766093507.addTaint(getTaint()); //Add taint from parent
    ...
    public GpsStatus getGpsStatus(GpsStatus status) {
        GpsStatus varB4EAC82CA7396A68D541C85D26508E83_1104151849 = null; //Variable for return #1
        {
        ...
        varB4EAC82CA7396A68D541C85D26508E83_1104151849.addTaint(getTaint()); //Add taint from parent
