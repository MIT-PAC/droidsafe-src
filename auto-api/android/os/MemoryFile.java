...
public class MemoryFile {
    ...
    public InputStream getInputStream() {
        InputStream varB4EAC82CA7396A68D541C85D26508E83_1978968768 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1978968768 = new MemoryInputStream();
        varB4EAC82CA7396A68D541C85D26508E83_1978968768.addTaint(getTaint()); //Add taint from parent
    ...
    public OutputStream getOutputStream() {
        OutputStream varB4EAC82CA7396A68D541C85D26508E83_2114032971 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_2114032971 = new MemoryOutputStream();
        varB4EAC82CA7396A68D541C85D26508E83_2114032971.addTaint(getTaint()); //Add taint from parent
    ...
    public FileDescriptor getFileDescriptor() throws IOException {
        FileDescriptor varB4EAC82CA7396A68D541C85D26508E83_1817813123 = null; //Variable for return #1
        varB4EAC82CA7396A68D541C85D26508E83_1817813123 = mFD;
        varB4EAC82CA7396A68D541C85D26508E83_1817813123.addTaint(getTaint()); //Add taint from parent
